...
<aside class="telltale warning" role="note"><span aria-hidden="true">⚠️</span><p><strong>Planeje pela autonomia elétrica PBEV, não pela NEDC.</strong> Se o vendedor falar em "100 km no elétrico", pergunte se é PBEV (INMETRO) ou NEDC. Para o dia a dia, use o número do INMETRO como referência e ainda desconte um pouco para estrada e ar-condicionado. A boa notícia: como tem motor a gasolina de reserva, errar essa conta no Song Plus não te deixa a pé, só te faz gastar gasolina antes do previsto.</p></aside>

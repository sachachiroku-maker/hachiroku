...
marca: "Honda"
modelo: "HR-V"
versao: "EX 1.5 aspirado e Touring 1.5 Turbo"
ano: 2023
geracao: "3ª geração"
carroceria: "SUV compacto"
kicker: "FICHA TÉCNICA · DADOS REAIS"
potenciaCv: "126 cv (aspirado) / 177 cv (turbo)"
cilindrada: "1.498 cm³"
combustivel: "Flex (etanol/gasolina)"

motor:
  - { k: "Configuração (aspirado)", v: "1.5 aspirado i-VTEC, 4 cilindros, 16 válvulas" }
  - { k: "Configuração (turbo)", v: "1.5 VTEC Turbo, 4 cilindros, 16 válvulas, injeção direta" }
  - { k: "Cilindrada", v: "1.498 cm³ (ambos os motores)" }
  - { k: "Potência (aspirado)", v: "126 cv" }
  - { k: "Potência (turbo)", v: "177 cv a 6.000 rpm (gasolina); 173 cv com etanol" }
  - { k: "Torque (aspirado)", v: "15,5 kgfm (gasolina) / 15,8 kgfm (etanol)" }
  - { k: "Torque (turbo)", v: "24,5 kgfm a 1.700 rpm" }
  - { k: "Alimentação (aspirado)", v: "Injeção eletrônica multiponto, aspirado (sem turbo)" }
  - { k: "Alimentação (turbo)", v: "Injeção direta de gasolina (GDI) com turbocompressor" }
transmissao:
  - { k: "Câmbio", v: "Automático CVT com 7 marchas simuladas (ambas as versões)" }
  - { k: "Tração", v: "Dianteira" }
desempenho:
  - { k: "Velocidade máxima (turbo)", v: "200 km/h" }
  - { k: "0 a 100 km/h (turbo)", v: "8,9 s" }
  - { k: "0 a 100 km/h (aspirado)", v: "cerca de 11,8 s" }
consumo:
  - { k: "Cidade (turbo, gasolina)", v: "cerca de 7,9 km/l" }
  - { k: "Estrada (turbo, gasolina)", v: "cerca de 8,8 km/l" }
  - { k: "Cidade (aspirado, gasolina)", v: "cerca de 12,5 km/l" }
  - { k: "Estrada (aspirado, gasolina)", v: "cerca de 13,9 km/l" }
dimensoes:
  - { k: "Comprimento", v: "4.330 mm" }
  - { k: "Largura", v: "1.790 mm" }
  - { k: "Altura", v: "1.590 mm" }
  - { k: "Entre-eixos", v: "2.610 mm" }
  - { k: "Peso (turbo)", v: "1.422 kg" }
  - { k: "Porta-malas", v: "354 litros" }

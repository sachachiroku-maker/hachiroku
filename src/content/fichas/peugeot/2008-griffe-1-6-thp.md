...
motor:
  - { k: "Configuração", v: "1.6 THP PureTech, 4 cilindros em linha, 16 válvulas, turbocompressor" }
  - { k: "Cilindrada", v: "1.598 cm³" }
  - { k: "Potência (gasolina)", v: "165 cv a 6.000 rpm" }
  - { k: "Potência (etanol)", v: "173 cv a 6.000 rpm" }
  - { k: "Torque (gasolina)", v: "24,5 kgfm de 1.700 a 3.500 rpm" }
  - { k: "Torque (etanol)", v: "25,5 kgfm de 1.700 a 3.500 rpm" }
...
faq:
  ...
  - pergunta: "Qual a diferença entre o Peugeot 2008 e o Peugeot 208?"
    resposta: "O 2008 é a versão SUV compacto do 208, com carroceria elevada (altura de 1.550 mm vs 1.430 mm), maior entre-eixos (2.600 mm vs 2.538 mm), mais volume de porta-malas (434 L vs 311 L) e motor mais potente na versão topo: o 1.6 THP turbo de 165 cv vs o 1.6 VTi aspirado de 120 cv. Ambos compartilham a plataforma PF1 e o i-Cockpit."
  - pergunta: "O Peugeot 2008 2023 tem tração integral?"
    resposta: "Não. O Peugeot 2008 vendido no Brasil usa tração dianteira em todas as versões. Não existe versão 4x4 do 2008 para o mercado brasileiro. O carro oferece controle de estabilidade e controle de tração como recursos eletrônicos, mas sem tração traseira mecânica."
relacionados:
...
O THP (Turbo High Pressure) de 1.6 litros é o motor mais sofisticado da linha Peugeot no Brasil. Com injeção direta de combustível e turbocompressor, entrega 165 cv e 24,5 kgfm na gasolina, com torque disponível numa faixa ampla de rotações: de 1.700 a 3.500 rpm. Isso dá ao 2008 uma resposta ágil na retomada sem precisar desenvolver muita rotação.
...
O entre-eixos de 2.600 mm do 2008 garante espaço traseiro confortável para adultos de estatura média. O porta-malas de 434 litros é um dos mais generosos da categoria, com assoalho regular e acesso por tampa de abertura elétrica na versão Griffe.

O i-Cockpit com volante menor e painel elevado é uma escolha de design que divide opiniões: proporciona visibilidade diferente da convencional e exige uma adaptação inicial de alguns condutores, especialmente os vindos de carros com instrumentação convencional.

...
checklist:
  - item: "Documentação, débitos e procedência"
    detalhe: "Confira CRLV, IPVA, multas, restrições financeiras e se o número do chassi confere. Uma vistoria cautelar revela sinistro, leilão e adulteração. Item inegociável."
    critico: true
  - item: "Identifique o motor: EA111 ou EA211"
    detalhe: "O cuidado muda conforme o motor, não só o ano. Confirme pela ficha do veículo e pelo número do motor qual família equipa o carro, porque os vícios e o intervalo de manutenção são diferentes."
    critico: true
  - item: "Histórico de óleo e nível"
    detalhe: "Exija notas das trocas no intervalo, com a especificação correta. O EA111 é conhecido por consumir óleo e formar borra quando negligenciado; verifique o nível e a cor na vareta antes mesmo do test drive."
    critico: true
  - item: "Tucho a frio (barulho na partida)"
    detalhe: "Dê a partida com o motor totalmente frio e ouça. Um tec-tec-tec metálico no comando costuma indicar tuchos hidráulicos sofrendo, ligado a óleo vencido ou borra. Pode sumir ao aquecer, mas é sinal de manutenção atrasada."
    critico: false
  - item: "Bobina, velas e cabos (engasgo e falha)"
    detalhe: "No EA111 a bobina com módulo integrado é ponto frágil. Em test drive, sinta engasgos, tranco e perda de força; luz de injeção piscando pede scanner. Falha nos cilindros é relato comum nesse motor."
    critico: false
  - item: "Corpo de borboleta e marcha lenta"
    detalhe: "Com o carro parado e quente, observe se a marcha lenta oscila ou se a resposta ao acelerador é estranha. No EA111 isso costuma ser corpo de borboleta sujo, que muitas vezes se resolve com limpeza, mas é argumento de negociação."
    critico: false
  - item: "Infiltração no porta-malas e assoalho"
    detalhe: "Levante o carpete do porta-malas e o estepe e procure umidade, ferrugem ou mofo. No Gol a água costuma entrar pela vedação ressecada das lanternas traseiras, não pela borracha da tampa. Cheque também o cheiro de mofo na cabine."
    critico: false
  - item: "Suspensão, freios e embreagem"
    detalhe: "Ouça ruídos em buracos e lombadas (buchas, bieletas, amortecedores), cheque pastilhas e fluido de freio e, no manual, sinta o ponto da embreagem e trancos em subida."
    critico: false
  - item: "Test drive frio e quente, mais elétrica"
    detalhe: "Rode com motor frio e quente, em baixa e alta velocidade, teste ar-condicionado, vidros, painel e todas as marchas. Em versões mais antigas, panes de painel e luzes são relatadas; teste tudo."
    critico: false
afiliados:
  - produto: "Scanner OBD2 Bluetooth"
    nota: "Leve na hora de avaliar o Gol usado: lê códigos de falha de ignição, corpo de borboleta e marcha lenta que o vendedor não conta."
    busca: "scanner obd2 bluetooth"
    programa: "amazon"
faq:
  - pergunta: "Qual a melhor geração do Gol usado para comprar?"
    resposta: "Depende do orçamento e de qual motor o carro tem. As versões com motor EA211 (o 1.6 que chegou no G6 e o 1.0 das fases mais recentes) tendem a dar menos dor de cabeça que as equipadas com o EA111 (boa parte do G5 e do G6 1.0). O G6 em diante também resolveu boa parte das panes elétricas que marcaram o G5. Em qualquer caso, um exemplar com histórico de manutenção comprovado vale mais que a etiqueta de geração."
  - pergunta: "O Gol com motor EA111 dá muito problema?"
    resposta: "O EA111 é um motor simples e barato de manter, mas tem manias bem documentadas: tende a consumir óleo e formar borra quando o óleo é negligenciado, costuma queimar bobina, tem o corpo de borboleta sensível e pode apresentar falha de ignição. Nenhum desses itens é caro isoladamente, e a maioria se previne com óleo em dia. O risco real aparece quando o dono anterior deixou a manutenção atrasar."
  - pergunta: "Por que entra água no porta-malas do Gol?"
    resposta: "Na maioria dos casos a água não entra pela borracha da tampa, e sim pela vedação das lanternas traseiras. A junta de espuma das lanternas resseca com o tempo e abre frestas por onde a chuva escorre para dentro. A solução costuma ser revedar ou trocar as guarnições das lanternas. Ao avaliar um Gol usado, sempre levante o carpete do porta-malas e procure umidade e ferrugem."
  - pergunta: "Quantos quilômetros é seguro para um Gol usado?"
    resposta: "Mais importante que a quilometragem é o histórico. O Gol é um carro de mecânica simples e robusta, e um exemplar com óleo sempre em dia e revisões feitas pode passar dos 150 mil km tranquilo. Já um com pouca rodagem, mas óleo duvidoso, pode esconder borra no motor. Priorize procedência e manutenção comprovada."
  - pergunta: "Vale a pena levar um mecânico para avaliar o Gol usado?"
    resposta: "Vale, e costuma ser o melhor dinheiro gasto na compra. Uma avaliação presencial com scanner e elevador revela ruído de tucho, falha de ignição, corpo de borboleta, infiltração no assoalho e folgas de suspensão que não aparecem em um test drive rápido. Como o Gol é simples, essa avaliação tende a ser barata."
relacionados:
  - titulo: "Onix usado vale a pena?"
    url: "/guia-de-compra/usados/onix-usado-vale-a-pena/"
  - titulo: "Scanner OBD2: como usar para avaliar um usado"
...
Mas também significa que há gerações e motores muito diferentes circulando, e <mark>o que você precisa inspecionar muda conforme o que está embaixo do capô</mark>, não só pelo ano do carro.
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Óleo é o coração do EA111.</strong> Um motor que ficou com óleo vencido pode ter borra acumulada que você não vê de fora. Sem comprovação das trocas, trate como risco e leve isso para a negociação. Aqui, um carro bem cuidado com mais km vale mais que um descuidado com menos.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Nem tudo no EA111 é caro.</strong> Bobina, velas, limpeza de corpo de borboleta e até trocas de óleo são serviços baratos e comuns. O perigo não está em cada peça, e sim em vários itens negligenciados ao mesmo tempo somados à borra de óleo. Identifique o estado geral, não só um sintoma.</p></aside>
...
<aside class="telltale warning" role="note"><span aria-hidden="true">⚠️</span><p><strong>Olhe debaixo do carpete, sempre.</strong> Um porta-malas que parece seco por cima pode esconder umidade e ferrugem por baixo do forro e do estepe. Esse é um dos checks mais baratos de fazer e um dos mais reveladores sobre como o carro foi cuidado.</p></aside>

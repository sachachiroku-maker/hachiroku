...
checklist:
  - item: "Documentação, débitos e procedência"
    detalhe: "Confira CRLV, IPVA, multas e restrições financeiras. Cheque se o chassi bate com o documento e solicite a vistoria cautelar. Pergunte se o veículo foi de fazenda, construtora ou pessoa física urbana: isso muda completamente o nível de desgaste."
    critico: true
  - item: "Histórico de manutenção do motor"
    detalhe: "Exija notas fiscais ou registro de trocas de óleo. O intervalo recomendado é a cada 10 mil km, mas em fazenda com poeira o ideal é 7-8 mil km. Sem histórico confiável, considere que o motor nunca foi bem cuidado."
    critico: true
  - item: "Turbocompressor: fumaça e folga"
    detalhe: "Com o motor quente, acelere em ponto morto e observe a fumaça pelo escapamento. Fumaça azul indica óleo queimando, muitas vezes por turbo desgastado. Segure o eixo do turbo com o motor frio e verifique se há folga lateral: qualquer folga perceptível indica desgaste avançado."
    critico: true
  - item: "Diferencial de bloqueio traseiro"
    detalhe: "Em terreno adequado ou com segurança, acione o bloqueio de diferencial traseiro e confirme que ele trava e destrava sem tranco ou alarme de falha. Diferencial bloqueado travado ou que não engaja é reparo caro."
    critico: true
  - item: "Suspensão dianteira (duplo A)"
    detalhe: "Com o veículo levantado, balance cada roda dianteira lateralmente e verticalmente. Verifique bandeja inferior, pivô e barra estabilizadora. Barulhos em manobra e folga perceptível indicam desgaste, comum em exemplares que rodam em terra."
    critico: true
  - item: "Amortecedores: padrão original ou aftermarket rígido"
    detalhe: "Hilux de fazenda frequentemente tem amortecedores trocados por versões mais rígidas. No asfalto, a picape bate demais e o conforto desaparece. Confirme se os amortecedores são originais ou o tipo substituído, e teste a resposta no pavimento."
    critico: false
  - item: "Freios traseiros e desgaste por sobrecarga"
    detalhe: "Dependendo da versão, os freios traseiros são disco sólido ou tambor. Em Hilux de trabalho com carga frequente o desgaste é acelerado. Cheque a espessura das pastilhas e a condição dos discos. Tambores amassados ou com sulco profundo pedem substituição imediata."
    critico: false
  - item: "Sistema de arrefecimento e cabeçote"
    detalhe: "Abra o reservatório com o motor frio e observe a cor do líquido. Contaminação com óleo (líquido marrom, aspecto de café com leite) indica junta de cabeçote comprometida. Em diesel, esse reparo é muito caro."
    critico: true
  - item: "Scanner OBD2: leitura de erros antes de fechar negócio"
    detalhe: "Conecte um scanner OBD2 Bluetooth antes de qualquer negociação. Códigos apagados recentemente, erros de DPF, AdBlue (nos modelos mais novos) e sensores do turbo revelam problemas que o vendedor não vai mencionar."
    critico: false
  - item: "Fluido de transmissão automática (versões A/T)"
    detalhe: "Nas versões com câmbio automático, puxe a vareta da transmissão com o motor quente e observe a cor. Fluido marrom escuro ou com cheiro de queimado indica sobrecarga da caixa automática, reparo de custo elevado."
    critico: false
afiliados:

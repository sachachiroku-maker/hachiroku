...
veredito: "Vale, com ressalvas: inspecione a corrente de distribuição T270 (gasolina) ou o câmbio automático antes de assinar. Veja o checklist completo."
pubDate: 2026-06-21
...
checklist:
  - item: "Corrente de distribuição T270"
    ...
    critico: false
  - item: "Câmbio automático de 9 marchas (9HP48)"
    detalhe: "teste em frio, em quente e em subidas. Reprogramação de software (flash) é gratuita em concessionária, mas retardamento e solavancos persistentes indicam desgaste mecânico."
    critico: false
  - item: "Motor diesel 2.0 MultiJet II"
    detalhe: "verifique histórico de troca de filtro de combustível. Bomba injetora comprometida por diesel adulterado é a principal causa de sinistro total nessa motorização."
    critico: false
  - item: "Suspensão dianteira"
    detalhe: "balançar o carro pelas extremidades do capô. Barulho de 'clic' ou folga indica terminal de direção ou barra estabilizadora gasta, peças de reposição acessíveis mas mão de obra cara."
    critico: false
  - item: "Eletrônica e Central Multimídia (Uconnect)"
    detalhe: "testar todas as funções da tela, Bluetooth, rádio AM/FM e câmera de ré. Falhas na Uconnect de 7 pol. (2017-2018) são comuns e o módulo custa R$ 2.500 a R$ 4.000."
    critico: false
  - item: "Estrutura e lataria"
    detalhe: "inspecionar soleiras, para-lamas traseiros e tampão do porta-malas com lanterna. Bolhas de tinta nesses pontos indicam infiltração ou reparo de colisão mal executado."
    critico: false
  - item: "Vazamento de óleo na Tampa de válvulas"
    detalhe: "com o motor quente, verificar visualmente a região superior do bloco. Vedação original tende a ressecar após 80 mil km no motor 2.0 Flex."
    critico: false
  - item: "Pneus e freios"
    detalhe: "medir sulcos (mínimo 1,6 mm legal; ideal acima de 3 mm) e verificar disco de freio por meio do próprio motorista antes do test-drive. Troca do conjunto no Compass gira em torno de R$ 2.200."
    critico: false
  - item: "Documentação"
    detalhe: "checar RENAVAN, histórico de multas, recall pendente (consultar portal DENATRAN/SENATRAN) e laudo cautelar de um despachante certificado. Compass tem ao menos 4 recalls registrados no Brasil."
    critico: false
  - item: "Histórico de manutenção"
    detalhe: "exigir manual com carimbos ou printout do sistema FCA Mopar. Sem histórico, negociar desconto de pelo menos 8% sobre a tabela FIPE para cobrir inspeção e revisão inicial."
    critico: false
checklist_label: "10 pontos para checar antes de comprar o Jeep Compass usado"
faq:
  - pergunta: "Qual versão do Jeep Compass usado 2017-2021 é mais confiável?"
    resposta: "A versão Limited com motor 2.0 Flex e câmbio automático de 6 marchas (anos 2017-2019, antes do câmbio de 9 marchas virar padrão) tende a apresentar menos problemas de câmbio. O diesel 2.0 é mais robusto mecanicamente, mas exige diesel de qualidade e manutenção rigorosa da bomba injetora."
  - pergunta: "O câmbio de 9 marchas do Compass é realmente problemático?"
    resposta: "É o item mais citado em reclamações. O câmbio ZF 9HP48 sofreu com calibrações inadequadas para o uso urbano brasileiro. A Jeep emitiu atualizações de software (flash) que resolvem parte dos solavancos em baixa velocidade. Veículos com flash atualizado e abaixo de 100 mil km costumam funcionar bem. O risco aumenta em exemplares sem histórico de manutenção ou que sofreram reboque fora de estrada sem proteção de óleo."
  - pergunta: "Quanto custa manter um Jeep Compass 2.0 Flex por ano?"

...
checklist:
  - item: "Histórico de troca do fluido DSG"
    detalhe: "O fluido do câmbio DSG deve ser trocado a cada 40 mil km. Exija a nota fiscal. DSG sem manutenção em dia é o principal causador de solavancos e falhas de engrenagem."
    critico: true
  - item: "Leitura de erros via OBD2"
    detalhe: "Conecte um scanner antes de qualquer test drive. Erros de injetor, sensor de pressão do turbo ou falha de marcha são bandeiras vermelhas imediatas."
    critico: true
  - item: "Condição da bomba d'água (motor EA211)"
    detalhe: "A bomba d'água do EA211 é acionada por correia auxiliar. Pergunte quando foi trocada e verifique se há rastros de vazamento de aditivo atrás do motor."
    critico: true
  - item: "Comportamento do DSG em baixa velocidade"
    detalhe: "Faça manobras lentas em estacionamento. Solavancos, hesitação ao engatar primeira ou ré e tremedeira ao soltar o freio são sintomas clássicos de DSG desgastado ou com fluido vencido."
    critico: true
  - item: "Acúmulo de carbono nas válvulas de admissão"
    detalhe: "Motores de injeção direta não lavam as válvulas com gasolina. Peça leitura do scanner para ver se há falhas de mistura. Motor áspero em marcha lenta também é sinal."
    critico: false
  - item: "Barulho anormal em 3 cilindros (partida fria)"
    detalhe: "O 1.4 TSI desativa dois cilindros em cruzeiro para economizar combustível. É normal. O barulho de preocupação é o batido metálico na partida, que pode indicar desgaste de corrente."
    critico: false
  - item: "Condição dos pneus e freios"
    detalhe: "Verifique desgaste irregular nos pneus (pode indicar problema de alinhamento ou suspensão). Aperte o pedal de freio parado: deve ser firme e sem vibração."
    critico: false
  - item: "Revisão das assistências eletrônicas"
    detalhe: "Luzes de ABS, ESC, hill hold ou assistente de estacionamento no painel ligadas com o carro em movimento indicam falha em sensor ou módulo de controle."
    critico: false
  - item: "Histórico de sinistro ou repintura"
    detalhe: "Passe a mão pelas bordas das portas e capô em busca de irregularidades. Use lanterna em ângulo baixo para revelar amassados reparados com massa. Exija laudo de pintura."
    critico: true
  - item: "Condição do interior e dos plásticos"
    detalhe: "O Taos tem acabamento premium para a categoria. Arranhões profundos em madeiras, tecidos rasgados ou tela central com falha de toque indicam uso intenso ou falta de cuidado."
    critico: false
afiliados:
  - produto: "Scanner OBD2 Bluetooth"
    ...
    programa: "amazon"
faq:
  - pergunta: "O DSG do Volkswagen Taos é confiável no longo prazo?"
    resposta: "O DSG 6 marchas (DQ250) é robusto quando mantido corretamente. A troca do fluido a cada 40 mil km é inegociável. Sem esse cuidado, solavancos e falhas aparecem antes dos 80 mil km. Com manutenção em dia, o câmbio aguenta bem acima dos 150 mil km."
  - pergunta: "Qual a faixa de preço do Volkswagen Taos usado em 2026?"
    resposta: "Exemplares mais antigos de 2021 e 2022 com maior quilometragem ficam entre R$ 130 mil e R$ 145 mil. Versões de 2023 com baixa km chegam a R$ 160 mil a R$ 175 mil. O preço varia conforme versão (Sense, Comfortline, Highline) e estado de conservação."
  - pergunta: "O motor 1.4 TSI do Taos consome muito combustível?"
    resposta: "Em uso urbano, o consumo fica entre 9 e 11 km/l com gasolina. Na estrada, pode chegar a 13 a 15 km/l. Para um SUV compacto de 150 cv, é um consumo competitivo. O sistema de desativação de cilindros ajuda no cruzeiro."
  - pergunta: "Vale mais a pena comprar o Taos ou o Jeep Compass usado pelo mesmo preço?"
...
- P0300 a P0304: falha de ignição em cilindro específico
- P0171: mistura pobre (pode indicar carbono nas válvulas ou sensor com defeito)
- P17BF: falha de pressão no sistema de lubrificação do DSG
- U-codes relacionados à comunicação entre módulos: podem indicar problema elétrico mais sério
...
- Banco do motorista: desgaste excessivo no estofado ou assento afundado indica quilometragem real acima do mostrado no painel
- Volante: couro gasto na posição das 9 e 3 horas é outro indicador de uso intenso
- Pedais: borracha gasta no pedal de freio ou embreagem não condiz com baixa quilometragem declarada
- Multimídia: teste todas as funções da tela, conectividade Bluetooth, Apple CarPlay, câmera de ré e sensores de estacionamento
...
- **2021/2022 com 60 mil a 100 mil km:** entre R$ 125 mil e R$ 145 mil
- **2022/2023 com 30 mil a 60 mil km:** entre R$ 145 mil e R$ 162 mil
- **2023/2024 com menos de 30 mil km:** entre R$ 162 mil e R$ 178 mil
...
- Revisão de 10 mil km (óleo + filtros): entre R$ 600 e R$ 900 em oficina especializada
- Troca de fluido DSG: entre R$ 800 e R$ 1.200 incluindo mão de obra
- Troca de correia auxiliar + bomba d'água (se necessário): entre R$ 1.200 e R$ 2.000
- Limpeza de válvulas (se necessário): entre R$ 1.500 e R$ 2.500

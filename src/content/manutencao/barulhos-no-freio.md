...
dificuldade: "Fácil"
custoEstimado: "R$ 0 — diagnóstico visual e auditivo"
ferramentas:
  - "Lanterna"
  - "Macaco hidráulico (opcional, para inspeção visual das rodas)"
materiais: []
passos:
  - nome: "Passo 1 — Identifique quando o barulho acontece"
    texto: "Preste atenção no momento exato em que o barulho aparece: ao iniciar a frenagem, durante toda a frenagem, ao soltar o pedal ou em movimento sem frear. Esse detalhe muda completamente o diagnóstico."
  - nome: "Passo 2 — Observe a velocidade do veículo"
    texto: "Barulho em baixa velocidade (estacionando, saindo de garagem) tem causas diferentes de barulho em alta velocidade. Anote em qual faixa de velocidade o problema aparece."
  - nome: "Passo 3 — Identifique de qual roda vem o barulho"
    texto: "Abra a janela e tente localizar se o som vem da frente, de trás, do lado do motorista ou do passageiro. Isso reduz o número de peças a inspecionar."
  - nome: "Passo 4 — Inspecione visualmente pelas frestas da roda"
    texto: "Com o carro parado e frio, use uma lanterna para olhar pelas frestas da roda. É possível ver o disco de freio e, em alguns casos, a borda da pastilha. Disco enferrujado ou pastilha muito fina são visíveis a olho nu."
  - nome: "Passo 5 — Verifique o nível do fluido de freio"
    texto: "Com o capô aberto, observe o reservatório do fluido de freio. Nível baixo pode indicar pastilhas gastas ou vazamento. Nunca ignore fluido abaixo do mínimo."
  - nome: "Passo 6 — Avalie a urgência e decida a próxima ação"
    texto: "Com base no tipo de barulho identificado, classifique a urgência: pode dirigir normalmente até a oficina, deve ir à oficina hoje ou deve parar imediatamente. Use o guia deste artigo para essa classificação."
autor:
  nome: "Redação Hachiroku"
pubDate: 2026-06-24
faq:
  - pergunta: "Barulho no freio é perigoso?"
    resposta: "Depende do tipo. Rangido metálico agudo ao frear é sinal de pastilha no limite e exige atenção imediata. Estralo ao soltar o pedal pode ser menos grave, mas sempre merece inspeção. Nunca ignore barulho no freio por mais de alguns dias."
  - pergunta: "Por que o freio faz barulho só de manhã?"
    resposta: "Ferrugem superficial no disco formada durante a noite é a causa mais comum. O barulho some após as primeiras frenagens e não representa perigo. Se persistir ao longo do dia, o problema é outro."
  - pergunta: "Freio fazendo barulho pode ser falta de manutenção?"
    resposta: "Sim. Pastilhas sem troca no intervalo correto, fluido de freio vencido e falta de lubrificação nos pinos da pinça são as causas mais comuns de barulho evitável com manutenção preventiva."
  - pergunta: "Barulho no freio traseiro é diferente do dianteiro?"
    resposta: "O diagnóstico segue a mesma lógica, mas freios traseiros a tambor (comuns em carros populares) produzem barulhos diferentes dos discos traseiros. Arranhado seco em freio a tambor costuma ser sujeira ou lona desgastada."
  - pergunta: "Quanto custa resolver barulho no freio?"
    resposta: "Varia conforme a causa. Troca de pastilhas dianteiras em carros populares fica entre R$ 150 e R$ 350 (peça + mão de obra). Disco empenado pode custar entre R$ 200 e R$ 600 por eixo. Pinça travada pode passar de R$ 400 dependendo do veículo."
afiliados:
...
<strong>Barulho no freio pode ter origens simples, como ferrugem superficial no disco após uma noite parado, ou graves, como pastilha completamente gasta raspando no metal do disco. O tipo de som (rangido agudo, estralo, chiado grave), o momento em que aparece (ao frear, ao soltar o pedal, em movimento) e a velocidade do carro são os três dados que definem o diagnóstico. Este guia traduz cada combinação em uma causa provável e diz se você pode esperar ou precisa parar agora.</strong>

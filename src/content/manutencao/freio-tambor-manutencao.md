...
dificuldade: "Médio"
custoEstimado: "R$ 80 a R$ 350 (peças + mão de obra)"
ferramentas:
...
materiais:
  ...
  - "Spray limpa-freios"
passos:
  - nome: "Passo 1 — Segurança antes de tudo"
    texto: "Acione o freio de mão, coloque calços nas rodas dianteiras e levante o veículo com o macaco. Apóie sempre em cavaletes antes de trabalhar embaixo do carro. Solte as porcas da roda com o carro ainda no chão, depois eleve."
  - nome: "Passo 2 — Remover a roda traseira"
    texto: "Retire as porcas completamente e puxe a roda para fora. Coloque-a deitada no chão para apoiar o macaco em caso de emergência."
  - nome: "Passo 3 — Retirar o tambor"
    texto: "Com a roda removida, puxe o tambor pelo centro com força firme. Se estiver travado por ferrugem, dê batidas leves com a marreta de borracha ao redor da borda. Nunca bata no centro do tambor."
  - nome: "Passo 4 — Inspecionar sapatas e tambor"
    texto: "Observe a espessura do material de atrito das sapatas. Se estiver abaixo de 2 mm, substitua o conjunto. Verifique riscos profundos no interior do tambor com o dedo: ranhuras que a unha 'trava' indicam necessidade de substituição ou retífica."
  - nome: "Passo 5 — Lixar o tambor (se em boas condições)"
    texto: "Use lixa de ferro grão 80 ou 120 para riscar levemente a superfície interna do tambor em movimento circular cruzado. Isso remove a camada de oxidação e cria aderência para as novas sapatas. Limpe com spray limpa-freios."
  - nome: "Passo 6 — Substituir ou remontar as sapatas"
    texto: "Se for trocar as sapatas, remova as molas de retorno com o alicate, anote a posição de cada peça (fotografe antes), instale as sapatas novas e recoloque as molas. Aplique graxa de freio apenas nos pontos de contato metálico, nunca no material de atrito."
  - nome: "Passo 7 — Montar e ajustar"
    texto: "Reinstale o tambor e gire à mão para checar se há atrito excessivo. Monte a roda, aperte as porcas em cruz com torque correto. Abaixe o carro e acione o freio de mão algumas vezes para ajustar o mecanismo automático."
  - nome: "Passo 8 — Teste de rodagem"
    texto: "Faça um teste em área privada a 30 km/h com freadas progressivas antes de andar na rua. O sistema precisa de 200 a 300 km de rodagem leve para assentar completamente as sapatas novas."
autor:
  nome: "Redação Hachiroku"
pubDate: 2026-06-24
faq:
  - pergunta: "Qual a diferença entre freio a disco e freio a tambor?"
    resposta: "O freio a disco usa uma pinça que aperta um disco metálico. O freio a tambor usa sapatas que empurram de dentro para fora contra um cilindro (o tambor). O disco esfria mais rápido e oferece mais potência de frenagem. O tambor é mais barato de fabricar e manter, por isso ainda equipa os eixos traseiros de carros populares."
  - pergunta: "Por que carros populares ainda usam freio a tambor atrás?"
    resposta: "Porque o eixo traseiro de veículos de tração dianteira absorve apenas 30 a 40 por cento da força de frenagem total. Usar tambor nessa posição reduz o custo de fabricação sem comprometer a segurança. O freio de mão também é mais simples de integrar ao tambor."
  - pergunta: "Quando devo trocar as sapatas do freio a tambor?"
    resposta: "A cada 40.000 a 60.000 km em condições normais de uso urbano, ou quando a espessura do material de atrito ficar abaixo de 2 mm. Sinais antecipados incluem rangido ao frear, carro puxando para um lado e pedal mais fundo."
  - pergunta: "Posso lixar o tambor sozinho?"
    resposta: "Sim, desde que o tambor esteja dentro da medida mínima de espessura (gravada na peça, geralmente entre 1 e 2 mm abaixo da medida original). Lixa grão 80 ou 120 em movimento cruzado resolve oxidação superficial. Se houver ranhuras profundas, o correto é retificar ou substituir o tambor."
  - pergunta: "Quanto custa a revisão completa do freio traseiro a tambor?"
    resposta: "Para modelos como Onix, HB20 e Argo, o kit de sapatas custa entre R$ 40 e R$ 90. O par de tambores varia de R$ 80 a R$ 180. A mão de obra gira em torno de R$ 80 a R$ 150 por eixo em oficinas independentes. A revisão completa fica entre R$ 200 e R$ 350."
afiliados:
  - produto: "Kit sapatas de freio traseiro para Onix e HB20"
    nota: "Kit com sapatas e acessórios para os modelos mais vendidos do Brasil"
    busca: "kit sapatas freio traseiro Onix HB20 Argo"
    programa: amazon
    cta: "Ver produto recomendado"
  - produto: "Spray limpa-freios automotivo"
    nota: "Essencial para limpar o tambor antes de remontar, evita chiado e contamina o sistema"
    busca: "spray limpa freios automovel 300ml"
    programa: amazon
    cta: "Ver produto recomendado"
relacionados:
  ...
  - titulo: "Sistema de freios: guia completo"
    url: "/sistema/freios/"
draft: false
---
...
- Rangido ou guincho ao frear levemente (sapatas com material fino)
- Som metálico de arranhado constante (sapata chegou ao metal)
- Batida seca ao soltar o freio de mão (mola de retorno quebrada)
- Chiado ao arrancar, sem frear (tambor oxidado após período parado)

**Avisos no comportamento do carro:**

- Carro puxando para um lado durante a frenagem (sapata gasta de um lado apenas)
- Pedal de freio indo mais fundo que o normal (folga excessiva)
- Vibração no pedal ao frear em velocidades acima de 60 km/h
- Carro demorando mais para parar em situações de emergência

**Avisos visuais (com a roda desmontada):**

- Material de atrito com menos de 2 mm de espessura
- Ranhuras profundas no interior do tambor
- Tambor com formato oval (desgaste irregular)
- Vazamento de fluido no cilindro de roda
...
- A superfície tem oxidação superficial (ferrugem fina, cor avermelhada)
- O carro ficou parado por mais de 15 dias e o freio está grudando levemente
- As sapatas foram trocadas e o tambor está em boas condições
- Há marcas de glazeamento (superfície polida e lisa demais)

**Retificar ou substituir é necessário quando:**

- Ranhuras profundas que a unha "trava" ao passar pelo tambor
- Desgaste que levou o tambor abaixo da medida mínima gravada na peça
- Oval ou deformação detectada por pulsação no pedal
- Trincas visíveis na superfície interna
...
- Troca de sapatas a cada 40.000 km
- Avaliação do tambor a cada 40.000 km

**Uso predominantemente rodovia:**

- Inspeção a cada 30.000 km
- Troca de sapatas a cada 55.000 km
- Avaliação do tambor a cada 55.000 km

**Uso misto:**

- Inspeção a cada 25.000 km
- Troca de sapatas a cada 45.000 km
...
- Trocar as sapatas de um lado só: sempre trocar os dois lados juntos para manter a frenagem equilibrada
- Não limpar o tambor com spray antes de montar: resíduos de graxa e pó de freio antigo contaminam as sapatas novas
- Esquecer de regular o freio de mão após o serviço: o cabo precisa ser ajustado quando as sapatas são trocadas
- Montar as sapatas trocadas (primária no lugar da secundária): as sapatas têm geometrias diferentes e posições definidas
- Não testar antes de rodar: pelo menos dez acionamentos do pedal parado para ajustar o mecanismo automático

...
ferramentas: ["Chave de vela (catraca + soquete)","Torquímetro","Extensão"]
materiais: ["Jogo de velas na especificação do carro"]
passos:
  - { nome: "Garanta o motor frio e desligue a bateria", texto: "Faça o serviço com o motor totalmente frio, nunca quente. Vela quente espana a rosca do cabeçote com facilidade, e cabeçote de alumínio (a maioria dos carros flex) é ainda mais sensível. Por segurança, desligue o polo negativo da bateria antes de mexer no sistema de ignição." }
  - { nome: "Localize e libere o acesso às velas", texto: "Identifique as bobinas ou cabos de vela em cima do cabeçote. Em muitos motores você precisa remover a tampa plástica do motor, conectores elétricos das bobinas ou um duto de admissão para chegar até elas. Trabalhe uma vela por vez para não trocar a ordem dos cabos." }
  - { nome: "Remova bobinas ou cabos sem puxar pelo fio", texto: "Solte a bobina (puxando reto para cima) ou o cabo de vela segurando pelo capuz de borracha, nunca pelo fio. Puxar pelo fio rompe a malha interna do cabo. Guarde cada bobina ou cabo na sequência do cilindro de onde saiu." }
  - { nome: "Limpe ao redor do poço da vela antes de soltar", texto: "Sopre ou limpe a sujeira acumulada na cavidade onde a vela está alojada. Se você soltar a vela com terra e areia em volta, essa sujeira cai direto dentro do cilindro quando a vela sai. Esse cuidado simples evita um dano sério." }
  - { nome: "Solte a vela com o soquete correto", texto: "Encaixe o soquete de vela (com a borracha interna que segura a peça) na catraca com extensão, mantendo tudo bem alinhado ao eixo da vela. Solte girando no sentido anti-horário. Se sentir resistência anormal, pare: forçar uma vela emperrada pode arrancar a rosca do cabeçote." }
  - { nome: "Compare a vela velha com a nova", texto: "Antes de jogar fora, leia a vela usada: queima clara e uniforme é normal; preto fuliginoso indica mistura rica; eletrodo derretido ou esbranquiçado sugere grau térmico errado ou motor batendo pino. Confira também se a vela nova é exatamente a especificada para o carro (mesmo código ou equivalente de fábrica)." }
...
faq:
  - { pergunta: "Posso trocar só uma vela ou tenho que trocar todas?", resposta: "O recomendado é trocar o jogo completo de uma vez. As velas desgastam juntas, no mesmo ritmo, e misturar uma vela nova com três velhas deixa a queima desigual entre os cilindros. Trocar todas garante funcionamento uniforme e evita uma segunda intervenção logo em seguida." }
  - { pergunta: "Vela de irídio dura mais mesmo?", resposta: "Sim, na prática as velas de irídio e platina costumam durar bem mais que as convencionais de cobre/níquel. Convencionais ficam mais na faixa de 20.000 a 40.000 km, e as de irídio/platina podem chegar perto de 100.000 km em vários carros. São apenas faixas de mercado: o intervalo real válido é o do manual do seu veículo." }
  - { pergunta: "Preciso ajustar a folga dos eletrodos da vela nova?", resposta: "Na maioria dos casos, não. As velas modernas, especialmente as de irídio e platina, já saem pré-calibradas na folga especificada pelo fabricante do motor e não devem ser ajustadas. Mexer no eletrodo fino de irídio pode trincar a ponta. Só verifique a folga se o fabricante da vela orientar isso para aquela aplicação." }
  - { pergunta: "O que acontece se eu apertar a vela demais?", resposta: "Apertar demais é um dos erros mais perigosos. O excesso de torque sobrecarrega a carcaça metálica da vela, pode interromper as zonas de dissipação de calor e levar a superaquecimento, e ainda corre o risco de espanar a rosca do cabeçote de alumínio. Por isso o aperto final é sempre com torquímetro, no valor especificado." }
  - { pergunta: "Posso trocar as velas com o motor quente?", resposta: "Não é recomendado. Com o cabeçote quente e dilatado, a chance de espanar a rosca ao soltar ou apertar a vela aumenta muito. Espere o motor esfriar completamente antes de começar o serviço." }
afiliados:
  - { produto: "Jogo de velas de ignição", nota: "Compre sempre na especificação exata do seu carro (código de fábrica ou equivalente do fabricante). Confira a aplicação antes de finalizar.", busca: "jogo velas ignicao", programa: "amazon" }
  - { produto: "Chave de vela com torquímetro", nota: "O torquímetro é o que evita o aperto excessivo que espana o cabeçote. Confira o tamanho do soquete (geralmente 16 ou 21 mm) compatível com a sua vela.", busca: "chave de vela torquimetro", programa: "amazon" }
relacionados:
  - { titulo: "Luz de injeção acesa no Onix: o que pode ser", url: "/problemas/chevrolet/onix/luz-injecao/" }
draft: false
---
...
- **Velas convencionais (cobre/níquel):** costumam pedir troca preventiva entre cerca de 20.000 km e 40.000 km.
- **Velas de irídio ou platina:** duram bastante mais e podem chegar perto de 100.000 km em vários carros.
...
- Uma **vela quente** dissipa calor mais devagar, então a ponta trabalha mais aquecida.
- Uma **vela fria** dissipa calor mais rápido, então a ponta fica mais fria.

...
entidade:
  ...
  modelo: "Tiggo 8 Pro"
  motor: "1.6 TGDI"
defeito: "solavanco e trepidação no câmbio CVT em acelerações moderadas"
kicker: "DEFEITO CRÔNICO"
intencao: "Diagnóstico"
entidadesEssenciais:
  - "câmbio CVT Tiggo 8 Pro"
  - "1.6 TGDI"
  - "calibração TCU"
  - "fluido CVT"
  - "ponto de calibração"
...
imagemAlt: "Câmbio CVT do Caoa Chery Tiggo 8 Pro 1.6 TGDI com solavanco em aceleração moderada"
pontosChave:
  - "Sintoma: solavanco e trepidação perceptíveis na transição de baixa para média aceleração, mais acentuados com o câmbio frio e em tráfego urbano parado-e-vai."
  - "Causa: ponto de calibração da TCU (unidade de controle da transmissão) desatualizado, que aplica pressão hidráulica nas polias do CVT fora do ponto ótimo para o perfil de uso brasileiro."
  - "Ação: solicitar à concessionária Caoa Chery a verificação e atualização do firmware da TCU; se o boletim técnico aplicável ao chassi estiver disponível, a reprogramação corrige o defeito sem substituição de componentes mecânicos."
faq:
  - pergunta: "O solavanco no CVT do Tiggo 8 Pro é defeito de fábrica ou mau uso?"
    resposta: "É um defeito de calibração de software, não de uso incorreto. O câmbio CVT do Tiggo 8 Pro é mecanicamente confiável, mas o ponto de calibração da TCU (Transmission Control Unit) foi definido para padrões de aceleração e temperatura diferentes do uso real no Brasil. O resultado é uma pressão hidráulica aplicada fora do momento certo nas polias do CVT, gerando o solavanco em acelerações moderadas. A causa não é o motorista, é o mapa de calibração instalado na fábrica."
  - pergunta: "O problema piora com o tempo ou se estabiliza?"
    resposta: "Sem intervenção, o solavanco tende a ser constante ou piorar progressivamente. Em câmbios CVT com calibração incorreta, o controle de pressão das polias opera fora da faixa ideal, o que aumenta o desgaste da correia metálica e das polias ao longo do tempo. Quanto mais cedo a calibração for atualizada, menor o risco de desgaste mecânico secundário."
  - pergunta: "A atualização de firmware da TCU resolve definitivamente o solavanco?"
    resposta: "Na maioria dos casos documentados, sim. A Caoa Chery libera atualizações de calibração da TCU para o Tiggo 8 Pro como parte da manutenção corretiva via boletins técnicos (TSB). A reprogramação ajusta os pontos de pressão das polias, o tempo de resposta da correia e o comportamento em aceleração parcial. Veículos com fluido CVT em bom estado respondem melhor à atualização. Se o solavanco persiste após a reprogramação, o passo seguinte é avaliar o fluido e o estado mecânico da correia."
  - pergunta: "Qual fluido é correto para o câmbio CVT do Tiggo 8 Pro 1.6 TGDI?"
    resposta: "O Tiggo 8 Pro 1.6 TGDI usa fluido CVT com especificação própria Chery. O proprietário deve confirmar a especificação exata no manual do veículo ou com a concessionária antes de qualquer troca, pois usar fluido genérico altera as características de fricção da correia metálica e pode agravar o solavanco ou introduzir novos defeitos. O fluido CVT não deve ser substituído por ATF convencional nem por fluido universal de câmbio automático."
  - pergunta: "O solavanco no CVT pode ser confundido com problema no motor 1.6 TGDI?"
    resposta: "Pode. O motor 1.6 TGDI turbo tem curva de torque com entrega concentrada em faixa baixa de rotação, o que torna difícil diferenciar visualmente um solavanco de câmbio de um empuxo irregular do motor. O diagnóstico diferencial exige scanner: se os códigos ativos estiverem no módulo de câmbio (TCM/TCU) e não no módulo do motor (ECM), o câmbio é a origem. Códigos de câmbio sem falha de motor confirmam a calibração como causa."
  - pergunta: "O problema ocorre mais em tráfego urbano ou em estrada?"
    resposta: "O solavanco é mais frequente em tráfego urbano, nas acelerações de baixa velocidade após paradas em sinal e nas acelerações moderadas de 20 a 60 km/h. Em estrada com aceleração constante, o CVT opera em regime estacionário e o solavanco tende a não aparecer. Isso confirma que o defeito está no mapa de calibração para transições de carga baixa e média, que é exatamente o perfil de uso urbano."
  - pergunta: "Quanto custa resolver o solavanco no CVT do Tiggo 8 Pro?"
    resposta: "A atualização de firmware da TCU em concessionária Caoa Chery, quando coberta por boletim técnico aplicável ao chassi, pode ser realizada sem custo adicional se o veículo está dentro da garantia. Fora da garantia, o custo de mão de obra de reprogramação varia entre R$ 300 e R$ 700 dependendo da concessionária e da região (junho de 2026). A troca do fluido CVT, se indicada, adiciona entre R$ 400 e R$ 800 ao procedimento."
passos:
  - nome: "Registrar o padrão do solavanco antes de levar à concessionária"
    texto: "Antes da visita técnica, anote com precisão as condições em que o solavanco ocorre: velocidade aproximada, tipo de aceleração (suave, moderada ou brusca), temperatura do câmbio (frio ou quente) e frequência (sempre ou esporadicamente). Essas informações orientam o técnico na verificação dos boletins técnicos aplicáveis ao chassi e reduzem o tempo de diagnóstico. Um relato detalhado aumenta a chance de o defeito ser reproduzido na bancada."
  - nome: "Solicitar leitura de códigos com scanner compatível"
    texto: "Peça ao técnico que conecte um scanner com protocolo compatível com os módulos Chery e leia os códigos de falha da TCU e do ECM separadamente. Códigos como P0700 (falha de transmissão), P0720 (sensor de velocidade de saída), P0740 (controle de lockup) ou códigos específicos Chery para pressão de polia são os mais frequentes nesse defeito de calibração. Registre todos os códigos antes de apagá-los para comparação após o procedimento."
  - nome: "Verificar se há boletim técnico de calibração aplicável ao chassi"
    texto: "Com o número do chassi (VIN) do veículo, solicite à concessionária a verificação de boletins técnicos (TSB) emitidos pela Caoa Chery para o Tiggo 8 Pro com câmbio CVT e motor 1.6 TGDI. Se houver TSB de reprogramação da TCU aplicável, o procedimento é a atualização do firmware via equipamento de diagnóstico homologado. Esse procedimento exige acesso ao portal técnico da Caoa Chery e não pode ser realizado em oficinas independentes sem o software específico."
  - nome: "Realizar a reprogramação da TCU e avaliar o fluido CVT"
    texto: "A reprogramação da TCU instala o mapa de calibração atualizado, ajustando os pontos de pressão das polias e o comportamento da correia metálica em aceleração parcial. Aproveite a visita para solicitar inspeção visual do fluido CVT: fluido escurecido, opaco ou com odor de queimado deve ser substituído pelo fluido correto da especificação Chery. A combinação de reprogramação e fluido novo apresenta os melhores resultados para eliminação do solavanco."
  - nome: "Fazer test drive de avaliação pós-reprogramação"
    texto: "Após a atualização, realize um ciclo de condução de pelo menos 20 a 30 minutos que inclua acelerações suaves, moderadas e paradas frequentes. O CVT possui rotinas de autoaprendizagem que recalibram os pontos de operação com o uso real após a reprogramação. Nos primeiros 200 km, prefira acelerações progressivas para permitir que o sistema se adapte ao mapa novo. Se o solavanco persistir após esse período de adaptação, retorne para avaliação do estado mecânico da correia e das polias."
fontes:
  - titulo: "Caoa Chery Tiggo 8 Pro: problemas e defeitos relatados por proprietários (Opinautos)"
    url: "https://www.opinautos.com.br/pt/caoa-chery/tiggo-8-pro/defeitos"
  - titulo: "CVT: funcionamento, problemas comuns e manutenção (Oficina Brasil)"
...
afiliados:
  - produto: "Fluido câmbio CVT universal premium"
    ...
    busca: "fluido cambio cvt transmissao variavel continua"
    programa: amazon
    cta: "Ver fluido CVT"
  - produto: "Scanner OBD2 profissional com módulo de câmbio"
    nota: "Necessário para leitura de códigos da TCU"
    busca: "scanner obd2 profissional modulo cambio transmissao"
    programa: amazon
    cta: "Ver scanner"
  - produto: "Kit limpeza e manutenção de câmbio automático"
    nota: "Para uso preventivo no intervalo de troca de fluido"
    busca: "kit limpeza manutencao cambio automatico cvt"
    programa: amazon
    cta: "Ver kit"
draft: false
---
...
<aside class="telltale warning" role="note"><span aria-hidden="true">⚠️</span><p><strong>Solavanco mais intenso nos primeiros minutos de uso é sinal de calibração fora do ponto.</strong> O CVT com calibração correta apresenta comportamento suave mesmo a frio. Se o solavanco diminui com o câmbio quente mas não desaparece, o mapa de calibração e o estado do fluido precisam de avaliação.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">🔴</span><p><strong>Não ignore o solavanco esperando que desapareça sozinho.</strong> A calibração desatualizada aplica pressão fora do ponto de forma contínua, o que acelera o desgaste da correia metálica e das polias. Quanto mais tempo o defeito fica sem correção, maior o risco de transformar um problema de software em um problema mecânico com custo de reparo muito mais alto.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Scanner antes de qualquer intervenção.</strong> A leitura dos códigos da TCU é o passo que diferencia calibração de problema mecânico. Sem o scanner, é impossível definir se o solavanco exige reprogramação ou revisão interna do CVT.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Atualização dentro da garantia, sem custo adicional.</strong> Se o Tiggo 8 Pro está dentro do prazo de garantia da Caoa Chery e o solavanco é reproduzível, a reprogramação da TCU por boletim técnico aplicável não deve gerar custo ao proprietário. Leve o veículo à concessionária com o relato detalhado do defeito e solicite formalmente a verificação de TSB para câmbio CVT.</p></aside>

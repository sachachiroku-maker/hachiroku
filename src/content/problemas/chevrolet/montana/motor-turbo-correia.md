...
imagemAlt: "Motor 1.2 CSS Prime Turbo da Chevrolet Montana com correia dentada banhada a óleo"
pontosChave:
  - "Sintoma: ruído metálico no motor a frio, marcha lenta irregular e, em estágio avançado, luz de avaria acesa."
  - "Causa: óleo fora da especificação Dexos 1 SAE 5W30 degrade o material da correia, que se esfarela e entope o pescador da bomba de óleo."
  - "Ação: usar exclusivamente óleo Dexos 1 SAE 5W30, respeitar a troca a cada 10.000 km e agendar a substituição preventiva da correia aos 100.000 km."
faq:
  - pergunta: "O motor 1.2 Turbo da Montana tem correia ou corrente de distribuição?"
    resposta: "Tem correia dentada banhada a óleo, do tipo belt-in-oil. Ela fica imersa no óleo do motor, dentro de uma câmara vedada, sem contato com o ambiente externo. É a mesma tecnologia usada no Onix turbo e no Tracker turbo de 3 cilindros, todos da família CSS Prime da GM."
  - pergunta: "Qual é o sintoma mais comum de correia comprometida na Montana 1.2 Turbo?"
    resposta: "O sinal mais frequente é um ruído metálico leve, parecido com um chiado ou tique-tique, presente principalmente durante a partida a frio. Marcha lenta irregular com o motor frio é outro indicador. Em estágio avançado, a luz de avaria do motor acende e o pedal de freio pode ficar mais duro, porque a bomba de vácuo compartilha o sistema de lubrificação com a correia."
  - pergunta: "Que óleo devo usar na Montana 1.2 Turbo para não estragar a correia?"
    resposta: "O óleo obrigatório é Dexos 1, grau de viscosidade SAE 5W30, com aprovação GM. A correia banhada a óleo é feita de um material que reage quimicamente aos aditivos do Dexos. Qualquer outro óleo, mesmo sintético de boa marca, pode conter aditivos incompatíveis que ressequem e esfarelem a correia ao longo das quilometragens. Exija a especificação impressa na embalagem e na nota fiscal."
  - pergunta: "A correia banhada a óleo da Montana pode romper sem aviso?"
    resposta: "Sim. Em casos de desgaste avançado por óleo inadequado, a correia não rompe progressivamente: ela se parte de forma abrupta, o motor para imediatamente e não dá mais partida. Não há luz de alerta prévia específica para esse evento. É por isso que o protocolo preventivo, e não a reação a sintomas, é a única proteção real."
  - pergunta: "Qual o intervalo de troca da correia da Montana 1.2 Turbo?"
    resposta: "A Chevrolet indica a troca preventiva da correia aos 100.000 km ou 7 anos, o que ocorrer primeiro. Em novembro de 2024, a GM ampliou a garantia da correia para 240.000 km sem limite de tempo nos modelos Onix, Tracker e Montana, desde que o veículo seja mantido com revisões no intervalo correto e com o óleo Dexos 1 especificado. O intervalo de revisão de óleo recomendado é de 10.000 km."
  - pergunta: "Quanto custa o reparo se a correia da Montana 1.2 Turbo romper?"
    resposta: "O custo do reparo corretivo, quando o motor é danificado pelo rompimento da correia, varia entre R$ 10.000 e R$ 18.000, dependendo da extensão do dano ao cabeçote, às válvulas e aos pistões. A troca preventiva da correia com tensor e retentores custa entre R$ 600 e R$ 1.200 em oficina especializada em GM. Essa diferença torna a manutenção preventiva a decisão financeiramente mais sensata."
  - pergunta: "O que acontece se o óleo errado for usado na Montana 1.2 Turbo?"
    resposta: "O óleo fora da especificação Dexos 1 ataca quimicamente o material da correia banhada a óleo. A correia resseca, trinca e começa a liberar fragmentos no óleo do motor. Esses fragmentos alcançam o pescador da bomba de óleo e o entopem. Sem pressão de óleo, o motor aquece de forma crítica e pode travar. O dano resultante é um motor de interferência destruído, com válvulas e pistões colidindo."
passos:
  - nome: "Confirme o tipo de motor do seu veículo"
    texto: "Verifique se a sua Montana tem o motor 1.2 CSS Prime Turbo de 3 cilindros. Esse é o motor que usa correia dentada banhada a óleo e requer os cuidados descritos aqui. A informação consta no documento do veículo, na etiqueta sob o capô e no manual do proprietário. Montana com motor 1.2 aspirado ou outras variantes têm sistema de distribuição diferente."
  - nome: "Levante o histórico de trocas de óleo"
    texto: "Reúna todas as notas fiscais de trocas de óleo desde a compra do veículo. Confirme se o óleo usado em cada troca foi Dexos 1 SAE 5W30. Se alguma revisão foi feita em estabelecimento que não soube informar a especificação do óleo, ou se há falhas no histórico, trate a correia como item a ser inspecionado com urgência, independentemente da quilometragem."
  - nome: "Observe os sintomas ao ligar o motor a frio"
    texto: "Preste atenção nos primeiros 30 segundos após a partida com o motor frio. Ruído metálico, chiado ou instabilidade de marcha lenta nesse momento são sinais associados ao desgaste da correia banhada a óleo ou a variações no sincronismo de válvulas. Se qualquer um desses sinais estiver presente, leve a Montana a uma oficina com scanner GM antes de continuar usando o veículo normalmente."
  - nome: "Leve a um diagnóstico com scanner GM"
    texto: "Em oficina com scanner Tech 2 ou GDS 2 (equipamentos específicos para veículos GM), peça a leitura de falhas e a verificação da variação de fase do motor. Esse diagnóstico pode detectar instabilidades no sincronismo de válvulas causadas pelo desgaste da correia antes que ocorra uma falha catastrófica. Concessionárias Chevrolet fazem esse serviço com equipamento original."
  - nome: "Agende a troca preventiva antes dos 100.000 km"
    texto: "Se a Montana está se aproximando de 100.000 km e não há registro documentado de troca da correia, agende o serviço com antecedência. A troca inclui a correia, o tensionador, os retentores de óleo e, quando integrada ao circuito, a bomba d'água. Nunca troque apenas a correia sem os componentes adjacentes: um tensionador desgastado pode quebrar a correia nova."
  - nome: "Mantenha o protocolo de óleo rigorosamente após a troca"
    texto: "Com a correia nova instalada, o controle do óleo passa a ser o único fator determinante da sua durabilidade. Use exclusivamente Dexos 1 SAE 5W30, troque a cada 10.000 km com filtro de óleo, nunca estenda o intervalo. Em uso com etanol exclusivo ou em clima quente com ciclos de aceleração intensos, considere reduzir o intervalo para 7.500 km."
afiliados:
  - produto: "Óleo Motul 5W30 Dexos 1 para motor turbo"
    nota: "Óleo na especificação Dexos 1 SAE 5W30, compatível com o motor 1.2 CSS Prime Turbo da Montana. O lubrificante correto é a proteção mais barata da correia."
    busca: "oleo 5w30 dexos 1 chevrolet turbo"
    programa: "amazon"
    cta: "Ver óleo recomendado"
  - produto: "Scanner OBD2 Bluetooth para leitura de falhas GM"
    nota: "Permite monitorar parâmetros do motor em tempo real e flagrar códigos de falha antes que virem problema maior."
    busca: "scanner obd2 bluetooth gm chevrolet"
    programa: "amazon"
    cta: "Ver scanner OBD2"
  - produto: "Kit correia dentada banhada a óleo Chevrolet Montana 1.2 Turbo"
    nota: "Kit completo com correia, tensionador e retentores para a troca preventiva no intervalo de 100.000 km."
    busca: "kit correia dentada montana 1.2 turbo css prime"
...
relacionados:
  ...
  - titulo: "Motor 1.2 CSS Prime Turbo: tudo o que você precisa saber"
    url: "/motor/chevrolet/css-prime-1-2-turbo/"
draft: false
---
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Motor de interferência.</strong> Se a correia rompe, válvulas e pistões colidem imediatamente. O reparo pode superar R$ 15.000. Não há luz de aviso prévia para o rompimento.</p></aside>
...
<aside class="telltale warning" role="note"><span aria-hidden="true">⚠️</span><p><strong>Sem aviso no rompimento.</strong> Em falha catastrófica, a correia parte de forma silenciosa e instantânea. O motor para sem nenhum ruído prévio e não dá partida. A ausência de sintomas antes do rompimento é o que torna o protocolo preventivo indispensável.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>O óleo correto.</strong> Dexos 1, grau SAE 5W30, com aprovação GM impressa na embalagem. Não basta ser sintético. Não basta ser de marca premium. A certificação Dexos 1 é o que protege o material da correia.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Guarde todas as notas de revisão.</strong> Óleo correto mais nota fiscal com o tipo e a marca do produto anotados formam a prova de garantia. Sem documentação, a GM não tem como confirmar que o protocolo foi seguido.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>O custo que evita o maior.</strong> O óleo correto a cada 10.000 km é o menor custo de manutenção da Montana. É também o que separa uma correia que dura 100.000 km de um motor que não dura até lá.</p></aside>

...
defeito: "queda de pressão de boost na turbina VGT"
...
imagemAlt: "Turbina de geometria variável VGT do motor Duramax 2.8 CTDI da Chevrolet S10"
faq:
  - pergunta: "O que é a turbina VGT e por que ela perde boost?"
    resposta: "VGT (Variable Geometry Turbocharger) é uma turbina com palhetas de ângulo variável no caracol de escape. O atuador eletrônico ou pneumático ajusta o ângulo das palhetas de acordo com a rotação do motor, otimizando o fluxo de gases e a pressão de boost em toda a faixa de rotação. Com o uso, o carbono e a fuligem gerados na combustão se depositam nas articulações das palhetas, enrijecendo ou travando o mecanismo. O resultado é boost reduzido e queda de potência."
  - pergunta: "Como identifico que a turbina da S10 está com problema de boost?"
    resposta: "Os principais sintomas são: queda perceptível de potência e aceleração em relação ao comportamento normal, especialmente acima de 2.000 rpm; fumaça azul ou preta no escapamento durante aceleração (sinal de combustão com excesso de combustível sem boost suficiente); Check Engine aceso com código de boost insuficiente ou de turbina; e som de turbina diferente do habitual, como assobio irregular ou chiado intermitente."
  - pergunta: "Dá para limpar a turbina VGT sem trocar?"
    resposta: "Sim, em muitos casos. Se as palhetas variáveis ainda se movem mas com dificuldade por acúmulo de carbono, a limpeza química com produto específico para turbinas diesel (como BG Turbo Charger Cleaner ou equivalente) pode restaurar o movimento completo das palhetas sem remoção da turbina. Para casos mais graves, a limpeza com a turbina removida e mergulhada em solução de carbono é necessária. A troca da turbina só é indicada quando há dano físico nas palhetas ou no eixo do rotor."
  - pergunta: "Quanto tempo dura uma turbina VGT da S10 2.8 com manutenção correta?"
    resposta: "Com trocas de óleo no intervalo correto (Dexos 1, a cada 10.000 km), uso de diesel S10 de qualidade e pelo menos 2 minutos de marcha lenta antes de desligar o motor após uso severo (subida, reboque), a turbina VGT do Duramax tende a durar 200.000 a 300.000 km sem necessidade de rebuild. Os casos de falha prematura estão associados a desligamento imediato após uso a carga alta e uso de óleo fora de especificação que forma depósitos no eixo da turbina."
  - pergunta: "Qual o custo de trocar a turbina da S10 2.8 Duramax?"
    resposta: "A limpeza química preventiva da turbina VGT custa entre R$ 300 e R$ 600 em oficina especializada. O rebuild da turbina (desmontagem, limpeza, substituição de rolamentos e vedações) custa entre R$ 1.500 e R$ 3.500 dependendo da oficina e da condição dos componentes internos. A troca por turbina nova original custa entre R$ 5.000 e R$ 9.000 em peça, mais mão de obra. Turbinas remontadas ou recondicionadas de boa procedência custam entre R$ 2.000 e R$ 4.000."
passos:
  - nome: "Identifique os sintomas com precisão"
    texto: "Registre quando a queda de potência acontece: só na aceleração em subida? Em toda faixa de aceleração? Só com o motor frio? Há fumaça no escapamento? O Check Engine está aceso? Esses detalhes determinam se o problema é no atuador das palhetas (falha em rotação específica) ou em componentes mais abrangentes como o próprio rotor da turbina ou o sistema de alimentação de combustível."
  - nome: "Leia os códigos de falha com scanner GM"
    texto: "Leve a S10 a uma concessionária Chevrolet ou oficina com scanner GDS 2 para leitura de DTC. Códigos relacionados a VGT incluem erros de posição do atuador, sobreboost ou underboost (pressão acima ou abaixo do esperado). O scanner também permite verificar a pressão de boost em tempo real durante um teste dinâmico, comparando com os valores esperados para aquela rotação e carga."
  - nome: "Tente a limpeza química como primeiro passo"
    texto: "Para casos onde as palhetas ainda se movem mas com dificuldade, a limpeza química com o motor em funcionamento pode ser suficiente. O produto é injetado no circuito de admissão com o motor em marcha rápida, e a fumaça resultante leva o carbono dissolvido pelo escapamento. O procedimento deve ser feito por mecânico treinado. Após a limpeza, verificar novamente a pressão de boost com o scanner."
  - nome: "Remoção e limpeza da turbina fora do veículo"
    texto: "Se a limpeza química não resolveu, a turbina precisa ser removida do veículo. O procedimento inclui drenagem do óleo do motor, remoção dos tubos de alimentação e retorno de óleo da turbina, desmontagem do conjunto do escapamento e coletor. Com a turbina removida, o especialista move manualmente as palhetas para verificar amplitude de movimento e identifica onde o carbono está depositado. A limpeza com solvente específico e pincel restaura o movimento sem danificar os componentes."
  - nome: "Rebuild ou troca em casos de dano interno"
    texto: "Se durante a inspeção com a turbina removida forem encontrados: folga excessiva no eixo do rotor (mais de 0,05 mm), palhetas com dano físico por superaquecimento, rolamentos desgastados, ou vazamento de óleo pelo eixo — a limpeza não resolve. O especialista vai indicar rebuild (troca de rolamentos, vedações e palhetas danificadas) ou troca por turbina nova/recondicionada de procedência."
pontosChave:
  - "A turbina VGT do Duramax 2.8 perde boost com acúmulo de carbono nas palhetas variáveis, especialmente em motores com trocas de óleo atrasadas ou óleo fora de especificação."
  - "Sintomas principais: queda de potência acima de 2.000 rpm, fumaça no escapamento, Check Engine com código de boost, assobio diferente do habitual da turbina."
  - "Limpeza química pode resolver casos leves sem remover a turbina. Casos graves exigem remoção e limpeza especializada ou rebuild."
  - "Desligar o motor imediatamente após subidas ou reboque pesado é um dos maiores vilões da vida útil da turbina. Aguarde ao menos 2 minutos em marcha lenta."
  - "Custo de limpeza química: R$ 300 a R$ 600. Rebuild: R$ 1.500 a R$ 3.500. Turbina nova: R$ 5.000 a R$ 9.000."
fontes:
  - { titulo: "Chevrolet S10 2.8 diesel perdendo força: 3 problemas comuns (Mecânica Offroad)", url: "https://mecanicaoffroad.com.br/chevrolet-s10-diesel-perdendo-forca/" }
  - { titulo: "Identificar falhas em turbinas (Turbo Brasil)", url: "https://blog.turbobrasil.com.br/cmo-identificar-falhas-em-turbinas/" }
  - { titulo: "Chevrolet S10 2.8 turbo não funciona: onde está o defeito? (Oficina Conectada)", url: "https://www.oficinaconectada.com.br/blog/chevrolet-s10-2-8-turbo-nao-funcion/" }

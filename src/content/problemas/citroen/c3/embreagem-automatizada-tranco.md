...
defeito: "tranco no câmbio automatizado EGS6"
kicker: "DEFEITO CRÔNICO"
intencao: "Diagnóstico"
entidadesEssenciais:
  - "câmbio EGS6"
  - "embreagem robotizada"
...
imagemAlt: "Câmbio automatizado EGS6 do Citroën C3 com trancos"
faq:
  - pergunta: "O tranco do câmbio do Citroën C3 é defeito ou é normal?"
    resposta: "Parcialmente os dois. O câmbio EGS6 é um câmbio de embreagem robotizada (AMT): tecnicamente é um câmbio manual acionado por atuador eletro-hidráulico. Em tráfego urbano de parada e arrancada frequente, o EGS6 produz trancos perceptíveis ao sair do ponto, ao engatar a 1ª marcha e ao fazer trocas em velocidades muito baixas. Esse comportamento é inerente ao tipo de câmbio e não é falha mecânica. O que configura defeito real são trancos que pioram progressivamente com o uso, associados a dificuldade de saída, patinação de embreagem ou luz de avaria no painel."
  - pergunta: "Como o câmbio EGS6 funciona tecnicamente?"
    resposta: "O EGS6 usa o mesmo mecanismo de um câmbio manual de 6 marchas, mas com atuadores eletro-hidráulicos controlando a embreagem e o câmbio. Quando o motorista acelera do ponto, o sistema calcula o ponto de engate ideal da embreagem e aciona o atuador. Se o cálculo do ponto de engate não está calibrado corretamente para as condições (temperatura, desgaste da embreagem, estilo do condutor), o engate é brusco e gera tranco. Em câmbios automáticos convencionais de conversor de torque (como o AT6 do Peugeot 208), o acoplamento é hidráulico e progressivo, sem esse ponto crítico de engate."
  - pergunta: "Trocar o óleo do câmbio EGS6 do C3 resolve o tranco?"
    resposta: "O câmbio EGS6 não tem banho de óleo como os automáticos convencionais. O atuador eletro-hidráulico usa fluido específico do sistema de atuação, que não é o mesmo que o óleo de câmbio de um AT6. A manutenção do EGS6 envolve verificação do atuador, calibração do ponto de engate via scanner Diagbox e inspeção do disco de embreagem. Não existe 'troca de óleo do câmbio EGS6' no mesmo sentido de um automático convencional."
  - pergunta: "Com quantos km o EGS6 do C3 começa a piorar o tranco?"
    resposta: "A embreagem do EGS6 é dimensionada para durar entre 80.000 e 120.000 km, dependendo do perfil de uso. Em uso predominantemente urbano com muitas saídas do ponto, esse intervalo pode ser menor. O tranco que surge e piora progressivamente a partir de 60.000 a 80.000 km quase sempre indica disco de embreagem no limite. A calibração do ponto de engate via Diagbox é o diagnóstico inicial antes de qualquer decisão sobre troca do disco."
  - pergunta: "Quanto custa trocar o disco de embreagem do Citroën C3 EGS6?"
    resposta: "O conjunto de embreagem do C3 EGS6 (disco, platô e rolamento de embreagem) custa entre R$ 600 e R$ 1.200 em peças. A mão de obra envolve desmontagem da transmissão, que exige 4 a 6 horas de trabalho. Serviço completo em oficina especializada: R$ 1.500 a R$ 2.800. Após a troca do disco, é obrigatória a calibração do ponto de engate via scanner Diagbox para que o atuador aprenda o novo ponto de contato do disco."
passos:
  - nome: "Confirme se o tranco é comportamento normal do EGS6 ou novo sintoma"
    texto: "Se o C3 sempre teve leve tranco ao sair do ponto desde quando novo, é comportamento normal do EGS6. Se o tranco surgiu ou piorou claramente em relação aos primeiros meses de uso, é sinal de que o sistema precisa de calibração ou de que o disco de embreagem está perdendo espessura. Anote em que situações exatas o tranco ocorre: saída do ponto, troca de marcha, desaceleração ou ré."
  - nome: "Verifique o modo de condução 'Snow' ou 'Auto'"
    texto: "O C3 EGS6 tem o modo 'Snow' (neve), que atrasa o ponto de troca de marchas e suaviza o engate da embreagem. Em congestionamentos com paradas frequentes, usar o modo Snow pode reduzir os trancos perceptíveis. Não resolve um problema mecânico real, mas ajuda a conviver com o comportamento do EGS6 no dia a dia enquanto aguarda a visita à oficina."
  - nome: "Leve para calibração do ponto de engate via Diagbox"
    texto: "Agende diagnóstico em concessionária Citroën ou oficina com acesso ao scanner Diagbox. O software permite ler o desgaste estimado do disco de embreagem, a posição do atuador e realizar a calibração do ponto de engate. Essa calibração, também chamada de 'aprendizado de embreagem', ajusta o ponto em que o atuador começa a pressionar o disco para o valor atual de espessura. Custo: R$ 150 a R$ 300 em oficina independente com Diagbox."
  - nome: "Inspecione o disco de embreagem"
    texto: "Se a calibração não resolver o tranco, ou se o scanner Diagbox indicar desgaste avançado do disco, o próximo passo é substituição do conjunto de embreagem. Antes de aprovar o serviço, peça ao mecânico que confirme a espessura do disco: um disco novo tem cerca de 8 a 9 mm de material de atrito, e o limite de desgaste é em torno de 2 mm. Com menos de 3 mm, a substituição é recomendável."
  - nome: "Após a troca, realize a calibração obrigatória"
    texto: "Depois de instalar um conjunto de embreagem novo no EGS6 do C3, o scanner Diagbox deve calibrar o novo ponto de engate. Sem essa etapa, o atuador vai usar os parâmetros do disco antigo (que estava desgastado), e o tranco persistirá mesmo com embreagem nova. Exija a confirmação da calibração ao retirar o carro da oficina."
pontosChave:
  - "O câmbio EGS6 do Citroën C3 é um câmbio de embreagem robotizada (AMT), não um automático convencional: trancos leves em saídas do ponto são comportamento inerente ao sistema."
  - "Tranco que piora progressivamente, novo ou acompanhado de luz de avaria, indica necessidade de calibração ou de troca do disco de embreagem."
  - "A calibração do ponto de engate via scanner Diagbox é o primeiro passo antes de decidir pela troca do disco."
  - "O conjunto de embreagem do EGS6 tem vida útil entre 80.000 e 120.000 km em uso urbano moderado."
  - "Após qualquer troca de disco de embreagem no EGS6, a calibração via Diagbox é obrigatória para o funcionamento correto."
fontes:
  - { titulo: "Citroën C3 câmbio EGS6 problemas (Reclame Aqui)", url: "https://www.reclameaqui.com.br/empresa/citroen/" }
  - { titulo: "C3 automático avaliação câmbio (Quatro Rodas)", url: "https://quatrorodas.abril.com.br/" }
  - { titulo: "Câmbio EGS6 do C3 — guia técnico (Motor Show)", url: "https://motorshow.com.br/" }
  - { titulo: "Fórum Citroënistas Brasil — C3 câmbio", url: "https://www.citroenistas.com.br/" }
draft: false
---

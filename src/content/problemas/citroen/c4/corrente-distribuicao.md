...
entidade:
  marca: "Citroën"
  modelo: "C4"
  motor: "1.6 THP Prince EP6 turbo"
  geracao: "BR (2021 em diante)"
defeito: "estiramento precoce da corrente de distribuição com barulho metálico a frio"
kicker: "DEFEITO CRÔNICO · ALTA ATENÇÃO"
intencao: "Diagnóstico e alerta preventivo"
entidadesEssenciais:
  - "corrente de distribuição THP"
  - "tensionador hidráulico EP6"
  - "sincronismo do motor Prince"
...
imagemAlt: "Corrente de distribuição do motor 1.6 THP Prince EP6 do Citroën C4 com estiramento precoce"
faq:
  - pergunta: "O Citroën C4 1.6 THP usa correia ou corrente de distribuição?"
    resposta: "O motor 1.6 THP Prince EP6, que equipa o Citroën C4 vendido no Brasil, usa corrente de distribuição, não correia dentada. A corrente fica no lado esquerdo do motor, banhada a óleo, e por projeto não tem intervalo de substituição programado. O problema documentado é o estiramento precoce da corrente e o desgaste do tensionador hidráulico, que depende da pressão de óleo para funcionar."
  - pergunta: "Qual o barulho que a corrente estirada do THP faz?"
    resposta: "O sinal mais característico é um ruído metálico, parecido com traquejo ou batida ritmada, que aparece nos primeiros segundos após a partida a frio. Conforme o motor aquece e a pressão de óleo sobe, o tensionador toma posição e o ruído some. Com o estiramento avançado, o barulho pode persistir além dos 30 segundos iniciais ou reaparecer ao desacelerar bruscamente de alta rotação."
  - pergunta: "Com quantos quilômetros a corrente do EP6 costuma apresentar problema?"
    resposta: "Os relatos de mecânicos especializados em PSA apontam para o surgimento dos primeiros sinais entre 60.000 e 90.000 km, especialmente quando o óleo não é trocado no intervalo correto ou quando se usou óleo fora da especificação PSA B71 2290. Em carros com manutenção em dia, a corrente pode ultrapassar 120.000 km sem intervenção. O intervalo de óleo é o principal fator."
  - pergunta: "A luz de injeção acende quando a corrente está estirada?"
    resposta: "Pode acender, sim. Com o tensionador no limite de curso e a corrente com folga, o sincronismo entre o virabrequim e o comando de válvulas pode se deslocar. O sistema de gestão do motor detecta esse desvio e registra códigos relacionados à fase das cames, como P0016, P0017, P0341 ou P0346. Esses códigos no scanner de um C4 THP com barulho a frio são fortes indicadores de corrente ou tensionador comprometidos."
  - pergunta: "Tem como o motor bater válvula com a corrente estirada?"
    resposta: "Sim, e é o risco mais grave. Se a corrente estirada pular um ou mais dentes da roda dentada, o motor perde o sincronismo e as válvulas podem colidir com os pistões no ponto morto superior. O resultado é quebra de válvulas, dano ao cabeçote e possível dano ao pistão. O reparo de um motor EP6 que bateu válvula envolve revisão completa do cabeçote e pode ultrapassar R$ 10.000 entre peças e mão de obra."
  - pergunta: "Quanto custa trocar a corrente de distribuição do C4 1.6 THP?"
    resposta: "O kit de corrente envolve a corrente, as guias plásticas, o tensionador hidráulico e as rodas dentadas, quando apresentam desgaste. A mão de obra de desmontagem, travamento do ponto e reajuste do sincronismo é a parte mais cara do serviço. Valores de referência no mercado brasileiro em 2026 ficam entre R$ 2.500 e R$ 4.500 pelo conjunto completo, dependendo da região e do tipo de oficina. Se o motor já bateu válvula, o custo sobe consideravelmente."
  - pergunta: "O uso de óleo errado acelera o estiramento da corrente do THP?"
    resposta: "Diretamente. O tensionador hidráulico que mantém a corrente esticada trabalha com a pressão do óleo do motor. Óleo fora da especificação PSA B71 2290 pode ter viscosidade e propriedades de pressão diferentes, comprometendo o trabalho do tensionador. Além disso, óleo degradado (troca atrasada) perde a capacidade de lubrificar a corrente e os pinos do tensor, acelerando o desgaste mecânico."
passos:
  - nome: "Ouça o motor na partida a frio"
    texto: "Com o motor completamente frio (parado por pelo menos 4 horas), ligue o veículo e fique parado por 30 a 60 segundos com atenção ao barulho. Um ruído metálico ritmado nos primeiros segundos, que some conforme o motor aquece, é o sintoma clássico do tensionador sem pressão de óleo suficiente para segurar a corrente. Grave um vídeo com o celular perto do motor: o áudio ajuda na comunicação com o mecânico."
  - nome: "Leia os códigos de erro no scanner OBD2"
    texto: "Conecte um scanner OBD2 à porta de diagnóstico do C4 e verifique se há códigos de falha relacionados à fase das cames ou ao sincronismo: P0016, P0017, P0341 e P0346 são os mais comuns nesses casos no EP6. Anote todos os códigos presentes, mesmo os já deletados (histórico de falhas), e leve essa informação ao mecânico. Um scanner de entrada como o ELM327 via Bluetooth já é suficiente para essa leitura inicial."
  - nome: "Verifique o nível e o estado do óleo"
    texto: "Com o motor frio, retire a vareta e observe: o nível deve estar entre as marcas MIN e MAX. Observe a cor e a consistência do óleo. Óleo muito escuro (preto denso), com borra visível ou com cheiro de queimado forte indica óleo degradado e troca atrasada. Confirme na tampa do motor ou no manual qual óleo o C4 requer: é obrigatoriamente 5W-30 sintético com aprovação PSA B71 2290 ou ACEA C2."
  - nome: "Leve a um mecânico especializado em PSA para inspeção da corrente"
    texto: "Com o diagnóstico OBD2 e o registro do barulho em mãos, leve o C4 a uma oficina com experiência em motores PSA. O mecânico deve realizar a inspeção do folgo da corrente com o motor no ponto morto superior, avaliar o estado das guias plásticas e medir o curso do tensionador hidráulico. Em muitos casos, a inspeção visual da corrente exige remoção da tampa lateral do motor, o que é um procedimento de diagnóstico, não de manutenção preventiva regular."
  - nome: "Decida entre troca preventiva ou monitoramento"
    texto: "Com o laudo do mecânico, você terá uma das seguintes situações: corrente ainda dentro da tolerância (monitorar e ajustar o intervalo de óleo), corrente no limite mas sem desvio de sincronismo (troca programada em curto prazo) ou corrente com desvio já registrado no scanner (troca imediata, antes que pule dentes). Não adie a troca quando o mecânico indicar que o tensionador está no limite do curso. O custo da troca preventiva é uma fração do custo do reparo de motor com válvulas batidas."
afiliados:
  - produto: "Óleo 5W-30 sintético aprovação PSA B71 2290"
    nota: "A especificação correta de óleo é o principal fator de proteção da corrente e do tensionador hidráulico do EP6. Marcas como Castrol Edge, Mobil 1 ESP e Total Quartz Ineo têm versões aprovadas. Sempre confirme a aprovação PSA B71 2290 no rótulo."
    busca: "oleo 5w30 sintetico psa b71 2290"
    programa: "amazon"
    cta: "Ver produto"
  - produto: "Scanner OBD2 Bluetooth"
    nota: "Permite ler os códigos de falha de sincronismo P0016 e P0017 antes de ir ao mecânico, ajudando a comunicar o problema com precisão e evitar diagnósticos pagos desnecessários."
    busca: "scanner obd2 bluetooth elm327"
    programa: "amazon"
    cta: "Ver scanner"
  - produto: "Kit corrente de distribuição EP6 THP"
    nota: "Kits com corrente, guias e tensionador hidráulico para o motor Prince EP6 1.6 THP. Prefira kits de marcas como Febi, Iwis ou equivalentes de qualidade OEM para garantir tolerâncias corretas."
    busca: "kit corrente distribuicao ep6 thp peugeot citroen"
    programa: "mercadoLivre"
    cta: "Ver kit"
relacionados:
  - titulo: "Motor 1.6 THP do C4 consome óleo: causas e diagnóstico"
    url: "/problemas/citroen/c4/motor-thp-consumo-oleo/"
  - titulo: "Todos os problemas conhecidos do Citroën C4"
    url: "/problemas/citroen/c4/"
pontosChave:
  - "Sintoma: ruído metálico ritmado nos primeiros segundos após a partida a frio, que desaparece conforme o motor aquece, às vezes acompanhado de luz de injeção e códigos P0016 ou P0017 no scanner."
  - "Causa: estiramento precoce da corrente de distribuição do motor Prince EP6 combinado com desgaste do tensionador hidráulico, agravado por óleo fora de especificação PSA B71 2290 ou troca atrasada."
  - "Ação: gravar o barulho a frio, ler o OBD2 em busca de P0016 e P0017, levar a mecânico PSA para medir o folgo da corrente e o curso do tensionador, e trocar preventivamente quando indicado antes que a corrente pule dentes."
fontes:
  - { titulo: "Citroën C4 THP: histórico de problemas na corrente de distribuição EP6 (Motor Show)", url: "https://motorshow.com.br/" }
  - { titulo: "Motor Prince EP6 THP: relatos de corrente com estiramento precoce (Reclame Aqui)", url: "https://www.reclameaqui.com.br/empresa/citroen/" }
draft: false
---
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Corrente folgada não é só barulho.</strong> Uma corrente com estiramento além do limite pode pular dentes da roda dentada do virabrequim ou do comando de válvulas. Quando isso acontece, o motor perde o sincronismo, válvulas e pistões colidem no ponto morto superior e o resultado é quebra de válvulas e dano ao cabeçote. O reparo de um EP6 que bateu válvula começa em R$ 8.000 e pode ultrapassar R$ 12.000.</p></aside>
...
<aside class="telltale warning" role="note"><span aria-hidden="true">⚠️</span><p><strong>O barulho a frio é o sinal mais precoce.</strong> O ruído metálico nos primeiros segundos após a partida acontece porque o tensionador hidráulico ainda não recebeu pressão de óleo suficiente para acionar. Nesse intervalo, a corrente estirada bate nas guias. Conforme a pressão sobe, o tensor empurra e o barulho some. Quando o barulho persistir além de 20 segundos ou reaparecer durante a condução, o tensionador está no limite.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Os códigos que apontam para corrente no EP6.</strong> P0016 e P0017 indicam desvio entre a posição do virabrequim e a do comando de válvulas. P0341 e P0346 indicam sinal irregular do sensor de fase do comando. Qualquer um desses códigos num C4 THP com barulho a frio deve ser investigado como corrente ou tensionador comprometidos, não apenas como falha de sensor.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Exija o diagnóstico antes do orçamento.</strong> A troca preventiva da corrente, quando feita no estágio inicial ou intermediário, é um serviço planejado com custo previsível. Orçamentos fechados sem diagnóstico da extensão real do problema frequentemente resultam em surpresas na fatura ou em peças trocadas desnecessariamente.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Quando parar de dirigir.</strong> Se o ruído metálico no C4 THP persistir por mais de 30 segundos após a partida, ou se a luz de injeção acender junto com qualquer perda de desempenho, pare de usar o veículo até o diagnóstico. Continuar rodando com a corrente no limite é o que transforma um reparo de distribuição em reconstrução de motor.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Verifique o nível mensalmente.</strong> O EP6 tem histórico de consumo de óleo em parte dos exemplares. Rodar com nível abaixo do MIN compromete a pressão que alimenta o tensionador. Uma verificação mensal da vareta, com o motor frio, é o hábito mais simples e mais barato de proteção que o dono de um C4 THP pode adotar.</p></aside>
...
<aside class="telltale warning" role="note"><span aria-hidden="true">⚠️</span><p><strong>Exija garantia sobre o serviço.</strong> Oficinas especializadas em PSA que fazem a troca da corrente do EP6 com travamento correto e verificação de sincronismo oferecem garantia de pelo menos 6 meses ou 10.000 km sobre o serviço. Serviço sem garantia documentada, nesse tipo de intervenção, é sinal de alerta.</p></aside>

...
seoTitle: "Citroën C4 1.6 THP: consumo excessivo de óleo no"
...
defeito: "consumo de óleo no motor Prince EP6 1.6 THP"
kicker: "DEFEITO CRÔNICO"
intencao: "Diagnóstico"
entidadesEssenciais:
  - "Motor Prince EP6"
  - "Selos de haste de válvula"
  - "Válvula de purga blow-by"
  - "Turbocompressor THP"
  - "PSA B71 2290"
autor:
...
imagemAlt: "Diagnóstico de consumo de óleo no motor 1.6 THP Prince EP6 do Citroën C4"
faq:
  - pergunta: "Quanto de consumo de óleo o Citroën C4 1.6 THP considera normal?"
    resposta: "A Citroën considera aceitável o consumo de até 0,7 litro a cada 1.000 km. Acima desse valor, o defeito pode ser coberto pela garantia de fábrica, desde que o veículo ainda esteja dentro do prazo."
  - pergunta: "Quais são os primeiros sintomas de consumo excessivo de óleo no EP6?"
    resposta: "Os sinais mais comuns são: nível de óleo caindo entre as trocas regulares, fumaça azulada saindo pelo escapamento ao desacelerar ou no arranque a frio, e cheiro de queimado dentro ou fora do carro."
  - pergunta: "Os selos de haste de válvula do EP6 desgastam com quantos quilômetros?"
    resposta: "Em média, os selos de haste começam a falhar entre 40.000 e 60.000 km, especialmente quando o carro circula muito em trânsito urbano ou usa óleo fora da especificação PSA B71 2290."
  - pergunta: "O que é o cano de blow-by e por que ele causa consumo de óleo?"
    resposta: "O cano de blow-by conduz os gases de ventilação do cárter de volta ao coletor de admissão. Quando ele entope, a pressão interna do motor sobe e força o óleo para fora pelos selos e retentores, aumentando o consumo."
  - pergunta: "Qual óleo usar no Citroën C4 1.6 THP para reduzir o consumo?"
    resposta: "Use obrigatoriamente óleo com aprovação PSA B71 2290, na viscosidade 5W-30 totalmente sintético. Óleos fora dessa especificação aceleram o desgaste dos selos de haste e pioram o consumo."
passos:
  - nome: "Verificar o nível de óleo em intervalos curtos"
    texto: "Com o motor frio e o carro em superfície plana, retire a vareta e verifique o nível. Marque a data e a quilometragem. Repita a cada 1.000 km para calcular o consumo real antes de levar ao mecânico."
  - nome: "Inspecionar o escapamento em busca de fumaça azul"
    texto: "Peça a um ajudante para observar o escapamento enquanto você arranca o motor a frio e depois desacelera bruscamente. Fumaça azulada persistente confirma que o óleo está sendo queimado na câmara de combustão."
  - nome: "Checar o cano de blow-by e a válvula PCV"
    texto: "Com o motor frio, localize o cano de ventilação do cárter e a válvula de purga (PCV). Verifique se há resíduos oleosos espessos ou entupimento. Um cano obstruído eleva a pressão do cárter e força o óleo pelos selos."
  - nome: "Inspecionar o turbocompressor"
    texto: "Com o motor em temperatura de trabalho e desligado há pelo menos 10 minutos, retire o duto de ar que entra no turbo. Se houver óleo acumulado nas pás do compressor, os retentores do turbo estão comprometidos."
  - nome: "Levar a uma oficina especializada em PSA para diagnóstico definitivo"
    texto: "Apenas um teste de compressão e análise de pressão do cárter confirmam com precisão qual componente falhou. Com esses dados em mãos, o orçamento de reparo fica mais preciso e você evita trocar peças desnecessárias."
afiliados:
  - produto: "Óleo 5W-30 sintético aprovação PSA B71 2290"
    nota: "Use exclusivamente óleos com esta aprovação PSA. Marcas como Castrol Edge, Mobil 1 ESP e Total Quartz oferecem versões compatíveis."
    busca: "oleo 5w30 psa b71 2290 sintetico"
    programa: "amazon"
    cta: "Ver produto"
  - produto: "Kit selos de haste válvula EP6 THP"
    nota: "Kits com selos originais ou equivalentes de qualidade (Elring, Victor Reinz) para o motor Prince EP6 1.6 THP."
    busca: "kit selos haste valvula ep6 thp peugeot citroen"
    programa: "mercadoLivre"
relacionados:
  - titulo: "Todos os problemas conhecidos do Citroën C4"
    url: "/problemas/citroen/c4/"
  - titulo: "Ficha técnica completa do Citroën C4 Shine 1.6 THP"
    url: "/ficha-tecnica/citroen/c4-shine-1-6/"
pontosChave:
  - "Sintoma: nível de óleo cai entre trocas, fumaça azul no escapamento e cheiro de queimado"
  - "Causa: selos de haste desgastados (40-60 mil km), válvula blow-by com defeito ou retentores do turbo gastos"
  - "Acao: medir consumo real a cada 1.000 km; acima de 0,7L acionar garantia ou orçar troca de selos"
  - "Atencao: usar sempre oleo 5W-30 com aprovacao PSA B71 2290; troca a cada 10.000 km e nao atrasar"
fontes:
  - { titulo: "PSA Group - Motor Prince EP6 Technical Documentation", url: "https://www.media.stellantis.com" }
  - { titulo: "PROCON-SP - Registro de reclamações Citroën C4 consumo de óleo", url: "https://www.procon.sp.gov.br" }
draft: false
---
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Não ignore o nível baixo.</strong> Rodar com o nível de óleo abaixo do mínimo por mais de 500 km pode causar danos irreversíveis ao cabeçote e ao turbocompressor do EP6. O custo de um cabeçote novo supera R$ 8.000 em mão de obra e peças.</p></aside>
...
<aside class="telltale" role="note"><span aria-hidden="true">⚠️</span><p><strong>Quanto é "normal" para a Citroën?</strong> A montadora considera aceitável o consumo de até 0,7 litro de óleo a cada 1.000 km. Qualquer valor acima disso dentro do período de garantia deve ser registrado em uma concessionária autorizada, com a medição documentada por escrito.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Troque todos de uma vez.</strong> Ao abrir o cabeçote para trocar os selos de haste, substitua todos os 16 selos (oito de admissão e oito de escapamento), mesmo que apenas alguns estejam com defeito visível. O custo da peça adicional é baixo comparado ao custo de abrir o motor novamente em poucos meses.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Verificação fácil em casa.</strong> Com o motor frio, desconecte o cano de blow-by do coletor de admissão. Se houver acúmulo espesso de borra oleosa na extremidade do cano, ele provavelmente está parcialmente obstruído. Leve ao mecânico para limpeza ou substituição antes que a pressão do cárter cause danos maiores.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Turbo com óleo na admissão: não adie.</strong> Um turbocompressor com retentor comprometido pode evoluir para falha mecânica total. Fragmentos metálicos do turbo danificado entram nos cilindros e podem destruir o motor. Se detectar óleo no duto de admissão, reduza o uso do carro e agende a revisão com urgência.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Protocolo para acionar a garantia.</strong> Se o seu C4 ainda está na garantia de fábrica (geralmente 3 anos ou 100.000 km), leve o veículo à concessionária com o consumo medido e documentado. Exija que o atendimento seja registrado em ordem de serviço e solicite a solução por escrito, com prazo definido.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Troca preventiva no intervalo certo.</strong> Proprietários de EP6 que mantêm troca de óleo a cada 10.000 km com produto aprovado PSA B71 2290 relatam menor velocidade de progressão do consumo. Não é uma cura, mas é a forma mais eficaz de adiar o reparo dos selos.</p></aside>
...
<aside class="telltale" role="note"><span aria-hidden="true">⚠️</span><p><strong>Exija garantia no reparo.</strong> Oficinas sérias que trocam selos de haste no EP6 oferecem garantia de pelo menos 6 meses ou 10.000 km sobre o serviço. Serviços sem garantia documentada são um sinal de alerta sobre a qualidade da execução.</p></aside>
...
| Sintoma principal | Causa mais provável |
|---|---|
| Fumaça azul ao desacelerar | Selos de haste desgastados |
| Fumaça azul apenas no arranque a frio | Selos de haste (óleo acumulado na noite) |
| Óleo no duto de admissão (pré-turbo) | Retentores do turbo comprometidos |
| Consumo alto sem fumaça visível | Válvula PCV aberta / cano blow-by entupido |
| Fumaça azul contínua em qualquer rotação | Selos + turbo comprometidos simultaneamente |

...
defeito: "rangido e barulho nos freios"
...
disclaimer: "Freios sao sistema de seguranca ativa. Este conteudo e informativo e orienta o diagnostico, mas a avaliacao e a troca das pecas devem ser feitas por profissional qualificado. Nunca adie a inspecao se o barulho persistir apos os primeiros metros de rodagem ou se vier acompanhado de vibracao no pedal."
imagem: "/logos/hachiroku-badge-86.png"
imagemAlt: "Pastilha de freio dianteira do Fiat Argo com indicador de desgaste visivel na lateral"
faq:
  - pergunta: "Por que o Fiat Argo faz rangido ao frear devagar?"
    resposta: "Rangido que aparece nas primeiras frenagens do dia, em baixa velocidade, e some depois e oxidacao superficial no disco, formada pela umidade da noite. E normal e nao indica defeito. O rangido que persiste depois das primeiras frenagens, ou que aparece em todas as situacoes de frenagem suave, indica pastilha chegando ao limite de desgaste ou pastilha com material de baixa qualidade. O sensor de desgaste embutido na pastilha original emite um guincho agudo justamente para avisar que a troca se aproxima."
  - pergunta: "O po cinza no aro do Argo e sinal de problema?"
    resposta: "Po cinza no aro e normal: todo carro com freio a disco produz residuos ao frear. O que indica problema e a quantidade excessiva, acima do normal, ou concentrada em apenas uma roda. Excesso de po aponta para pastilha de ma qualidade, com composto abrasivo que desgasta mais rapido e risca o disco antes do prazo. Concentracao em uma roda aponta para pinca emperrada, que mantem a pastilha encostada no disco mesmo sem o pedal acionado."
  - pergunta: "Com quantos km devo trocar a pastilha do Argo?"
    resposta: "Nao ha um numero fixo. O manual do Argo recomenda inspecao a cada 10.000 km ou a cada revisao. A vida util real varia entre 25.000 e 50.000 km dependendo do estilo de conducao, da qualidade da pastilha e do perfil de uso urbano ou rodoviario. Direcao urbana intensa, com muitas frenagens, gasta a pastilha mais rapido. O indicador confiavel e a espessura visual da pastilha: menos de 3 mm e hora de trocar."
  - pergunta: "Pastilha de ma qualidade risca o disco do Argo?"
    resposta: "Sim. Pastilhas com composicao abrasiva desgastam o disco mais rapido que pastilhas de qualidade. O sinal e o po cinza em excesso no aro e sulcos visiveis na superficie do disco. Uma pastilha barata economiza talvez R$ 50 na compra e normalmente resulta em um disco riscado que custa R$ 300 ou mais para trocar. Marcas como Fras-le, TRW e Bosch tem linha certificada para o Argo."
  - pergunta: "Rangido mais arranhao metal e normal?"
    resposta: "Nao. Arranhao metalico constante ao frear significa que a pastilha zerou e o suporte metalico esta em contato direto com o disco. Nesse estagio, cada frenagem risca o rotor. O barulho piora progressivamente e o disco fica com sulcos fundos, que forcam a troca do conjunto. Nao dirija mais do que o necessario para chegar a uma oficina com esse sintoma."
passos:
  - nome: "Identifique o tipo de barulho"
    texto: "Freie suavemente em velocidade baixa em rua plana. Se o rangido ocorre so nas primeiras frenagens e some depois, e oxidacao superficial (normal). Se persiste em todas as frenagens suaves ou aparece como guincho agudo ao qualquer aplicacao do freio, e sinal de pastilha no limite. Se e um arranhao metalico intenso, constante e cada vez mais alto, a pastilha zerou."
  - nome: "Verifique po no aro"
    texto: "Olhe a parte interna dos aros. Po cinza-escuro em quantidade moderada e normal. Po em excesso, especialmente na forma de pasta ou crosta, indica pastilha de qualidade ruim ou desgaste acelerado. Se o po e muito mais concentrado em uma roda que nas outras, suspeite de pinca emperrada naquela roda."
  - nome: "Inspecione visualmente a pastilha pela pinca"
    texto: "Com o carro parado, ilumine a lateral da pinca com uma lanterna e observe a espessura do material de atrito na pastilha. Esse material e a camada cinza ou bege entre o suporte metalico e o disco. Menos de 3 mm de material visivel indica troca. Se o material ja esta rente ao suporte metalico, a troca e urgente."
  - nome: "Observe a superficie do disco"
    texto: "Olhe a face do disco pela abertura do aro. Sulcos concentricos visiveis ao toque do dedo indicam disco riscado por pastilha zerada. Superficie brilhante e uniforme e normal. Riscos finos sao aceitaveis. Sulco profundo que passa a ponta do dedo significa disco comprometido que precisara de retifica ou troca."
  - nome: "Peca inspecao completa com o carro elevado"
    texto: "Com a roda removida, o mecanico mede a espessura do disco com micrometro e compara com o minimo gravado no rotor. Verifica tambem o jogo da pinca, a condicao dos pinos guia e o nivel e aspecto do fluido de freio. Essa inspecao completa define se a solucao e so a pastilha ou se o disco tambem precisa de intervencao."
pontosChave:
  - "Rangido persistente apos as primeiras frenagens do dia indica pastilha proxima do fim; o sensor de desgaste embutido na pastilha original emite um guincho agudo especificamente para avisar."
  - "Po cinza excessivo no aro aponta para pastilha de ma qualidade ou pinca emperrada; comparar a quantidade em todas as rodas e o modo mais rapido de identificar."
  - "Arranhao metalico constante significa pastilha zerada e disco sendo riscado a cada frenagem; o disco comprometido multiplica o custo do reparo."
  - "O manual recomenda inspecao a cada 10.000 km, mas a espessura visual da pastilha abaixo de 3 mm e o indicador mais confiavel para antecipar a troca."
fontes:
  - { titulo: "Quando Trocar Pastilha de Freio: 6 Sinais Definitivos (Central do Carro)", url: "https://centraldocarro.com/quando-trocar-pastilha-de-freio/" }
  - { titulo: "Freio fazendo barulho: causas e solucoes (Localiza Seminovos)", url: "https://seminovos.localiza.com/blog/posts/freio-fazendo-barulho" }
  - { titulo: "Quanto custa trocar pastilha de freio em 2025 (Blog KarHub)", url: "https://blog.karhub.com.br/quanto-custa-trocar-pastilhas-de-freio/" }
draft: false
---
...
1. **Espessura do disco** com micrômetro, comparada ao mínimo gravado no rotor.
2. **Condição da superfície** do disco: sulcos, variação de espessura, empenamento.
3. **Jogo da pinça** e condição dos pinos guia. Pino enferrujado trava o movimento da pastilha.
4. **Fluido de freio**: nível, cor e data da última troca. Fluido escuro ou com mais de 2 anos pede substituição.
5. **Mangueiras de freio**: inspeção visual por rachaduras e inchaço.

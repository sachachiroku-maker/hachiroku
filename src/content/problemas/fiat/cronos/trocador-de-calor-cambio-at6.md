...
entidade:
  marca: "Fiat"
  modelo: "Cronos"
  motor: "1.8 E.torQ com câmbio automático AT6"
  geracao: "1ª geração (versões Precision e HGT)"
defeito: "falha do trocador de calor do câmbio automático AT6"
kicker: "DEFEITO CRÔNICO"
intencao: "Diagnóstico e alerta preventivo"
entidadesEssenciais:
  - "câmbio automático AT6 (Aisin TF-72SC)"
  - "trocador de calor"
  - "fluido de transmissão (ATF)"
  - "líquido de arrefecimento"
  - "fluido leitoso (contaminação)"
  - "motor 1.8 E.torQ"
...
imagemAlt: "Câmbio automático AT6 Aisin TF-72SC do Fiat Cronos 1.8 E.torQ e seu trocador de calor"
faq:
  - pergunta: "Qual câmbio automático tem o Fiat Cronos 1.8?"
    resposta: "O Cronos 1.8 E.torQ das versões topo de linha mais antigas usa o câmbio automático AT6 de seis marchas, fabricado pela Aisin com o código TF-72SC. É o mesmo conjunto de transmissão que equipa outros modelos da Stellantis e da Jeep, como Toro, Argo 1.8, Renegade e Compass mais antigos. O ponto de atenção crônico desse câmbio é o trocador de calor."
  - pergunta: "O que é o trocador de calor do câmbio e por que ele falha?"
    resposta: "O trocador de calor é a peça que controla a temperatura do fluido do câmbio, trocando calor entre o fluido da transmissão (ATF) e o líquido de arrefecimento do motor. No AT6, esse componente é de alumínio e, com o tempo, pode sofrer corrosão ou fadiga do material e se romper internamente. Quando isso acontece, os dois fluidos, que deveriam ficar separados, se misturam."
  - pergunta: "Quais os sintomas do trocador de calor com problema no Cronos?"
    resposta: "O sinal mais característico é o fluido da transmissão mudar de aparência: o ATF, que normalmente é avermelhado e translúcido, fica com aspecto leitoso, amarronzado ou de café com leite, indicando presença de água ou líquido de arrefecimento. Junto, podem surgir trancos, patinação, dificuldade de engate e oscilação no nível do reservatório de arrefecimento. O problema costuma ser silencioso e só dar a cara quando o estrago já avançou."
  - pergunta: "Com quantos quilômetros aparece a falha do trocador de calor?"
    resposta: "Não há um número fixo. Há relatos de unidades que apresentaram o problema com quilometragens tão baixas quanto cerca de 20 mil km, mas a recomendação de oficinas especializadas é tratar o serviço preventivo a partir dos 60 mil km, porque é por volta dessa marca que os casos passam a se concentrar. Por ser um defeito silencioso, a inspeção antecipada do fluido é o que protege."
  - pergunta: "Quanto custa consertar o trocador de calor do câmbio do Cronos?"
    resposta: "Depende de quando o problema é detectado. Se a contaminação é flagrada cedo, antes de comprometer a transmissão, o reparo se resume à troca do trocador de calor e à limpeza com troca completa do fluido. Se a mistura circula por tempo demais e danifica o interior do câmbio, o conserto pode passar de R$ 20 mil, porque envolve a retífica ou a substituição da transmissão. É a diferença entre uma peça e um câmbio inteiro."
  - pergunta: "Como prevenir o problema do trocador de calor no AT6?"
    resposta: "A prevenção combina três cuidados: trocar o fluido do câmbio no intervalo recomendado (em torno de 60 mil km, com o fluido na especificação correta), manter o sistema de arrefecimento em dia com o aditivo certo e na diluição certa, e inspecionar periodicamente o aspecto do fluido da transmissão. Em oficinas especializadas, há quem opte por substituir o trocador de calor de forma preventiva por volta dos 60 mil km."
  - pergunta: "Vale a pena comprar um Cronos 1.8 automático usado?"
    resposta: "Vale, desde que a inspeção do câmbio AT6 seja feita antes de fechar negócio. Peça a um especialista em transmissões para verificar o aspecto e o nível do fluido da transmissão e do líquido de arrefecimento, procurando sinais de mistura (fluido leitoso, nível oscilando). Um Cronos 1.8 automático barato com histórico duvidoso de manutenção do câmbio pode esconder uma fatura que passa de R$ 20 mil logo na sequência."
passos:
  - nome: "Confirme se o seu Cronos tem o câmbio AT6"
    texto: "O ponto de atenção é específico das versões com o câmbio automático AT6 (Aisin TF-72SC), associado ao motor 1.8 E.torQ nas versões topo de linha mais antigas. As versões com motor Firefly 1.0 e 1.3, manuais ou com CVT, não usam esse câmbio e não entram neste alerta do trocador de calor. Identifique o motor e a transmissão do seu carro antes de tudo."
  - nome: "Inspecione o aspecto do fluido da transmissão"
    texto: "Peça a verificação do fluido do câmbio. O ATF saudável é avermelhado e translúcido (ou escuro no fim da vida). Se estiver leitoso, amarronzado ou com aspecto de café com leite, há contaminação por líquido de arrefecimento, e o trocador de calor é o suspeito imediato."
  - nome: "Cheque o nível do reservatório de arrefecimento"
    texto: "A mistura pode ir nos dois sentidos. Observe se o nível do líquido de arrefecimento oscila sem explicação. A troca de fluidos entre os circuitos do câmbio e do motor é a assinatura da falha do trocador de calor."
  - nome: "Aja no primeiro sinal de contaminação"
    texto: "Se houver mistura, não rode com o câmbio nessas condições. O fluido contaminado degrada os componentes internos da transmissão rapidamente. Quanto antes o trocador for substituído e o sistema limpo, menor o risco de o reparo virar troca de câmbio."
  - nome: "Faça a manutenção preventiva por volta dos 60 mil km"
    texto: "Troque o fluido do câmbio no intervalo recomendado, com o produto na especificação exata, e mantenha o arrefecimento em dia com o aditivo certo. Em oficinas especializadas, a substituição preventiva do trocador de calor por volta dos 60 mil km é uma estratégia comum para quem quer dormir tranquilo."
afiliados:
  - produto: "Fluido de transmissão automática (ATF) na especificação do AT6"
    nota: "O fluido certo, trocado no intervalo, é parte central da saúde do câmbio AT6. Usar o produto fora de especificação acelera o desgaste interno."
    busca: "fluido cambio automatico atf aisin"
    programa: "amazon"
    cta: "Ver fluido recomendado"
  - produto: "Aditivo de radiador na especificação correta"
    nota: "Arrefecimento em dia, com o aditivo e a diluição certos, reduz a corrosão que ataca o trocador de calor de alumínio."
    busca: "aditivo radiador concentrado organico"
    programa: "mercadoLivre"
  - produto: "Scanner OBD2 Bluetooth"
    nota: "Acompanha temperatura e parâmetros do câmbio e do motor, ajudando a flagrar comportamento anormal antes do estrago."
    busca: "scanner obd2 bluetooth"
    programa: "amazon"
relacionados:
  - titulo: "Ficha técnica do Fiat Cronos"
    url: "/ficha-tecnica/fiat/cronos/"
  - titulo: "Vazamento de óleo no Fiat Cronos: a válvula anti-chama e o respiro que sujam o motor"
    url: "/problemas/fiat/cronos/vazamento-de-oleo-respiro/"
pontosChave:
  - "O ponto de atenção é o trocador de calor do câmbio automático AT6 (Aisin TF-72SC), usado no Cronos 1.8 E.torQ: a peça é de alumínio e pode romper internamente por corrosão ou fadiga, misturando os fluidos que deveriam ficar separados."
  - "A assinatura da falha é a contaminação: o líquido de arrefecimento se mistura ao fluido da transmissão (ATF), que perde a cor avermelhada e fica leitoso ou amarronzado, sinal claro de água no óleo do câmbio."
  - "É um defeito silencioso, que pode aparecer com quilometragem baixa (há relatos por volta dos 20 mil km) e, se ignorado, leva a um reparo que pode passar de R$ 20 mil por troca ou retífica da transmissão."
  - "A ação recomendada é trocar o fluido do câmbio por volta dos 60 mil km com o produto correto, manter o arrefecimento em dia e inspecionar o aspecto do fluido; a substituição preventiva do trocador de calor é uma opção em oficinas especializadas."
fontes:
  - { titulo: "Câmbio Aisin TF-72SC (AT6): evite a falha no trocador de calor! (Blog Doutor-IE)", url: "https://blog.doutorie.com.br/cambio-aisin-tf-72sc-at6-evite-a-falha-no-trocador-de-calor/" }
  - { titulo: "Fiat Cronos: defeito no trocador de calor do câmbio (Jurídico Certo)", url: "https://juridicocerto.com/p/davidviniciusadv/artigos/fiat-cronos-defeito-no-trocado-de-calor-do-cambio-6769" }
  - { titulo: "Fiat Cronos: os 6 problemas que mais tiram o sono dos proprietários (Vrum)", url: "https://www.vrum.com.br/aceleradas/2026/03/7379606-fiat-cronos-os-6-problemas-que-mais-tiram-o-sono-dos-proprietarios.html" }
...
| Versão do Cronos | Motor | Câmbio | Entra neste alerta? |
| --- | --- | --- | --- |
| Drive 1.0 | 1.0 Firefly (3 cil.) | Manual | Não |
| Drive / Precision 1.3 | 1.3 Firefly (4 cil.) | Manual ou CVT | Não |
| Precision / HGT 1.8 | 1.8 E.torQ (4 cil.) | Automático AT6 (Aisin TF-72SC) | Sim |

<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Identifique antes de se preocupar.</strong> Se o seu Cronos é 1.0 ou 1.3, manual ou com CVT, ele não usa o câmbio AT6 e não corre o risco descrito aqui. O alerta do trocador de calor é específico das versões 1.8 E.torQ com o automático Aisin de seis marchas.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>O erro que acelera a falha.</strong> Negligenciar o sistema de arrefecimento, usar aditivo fora de especificação ou nunca trocar o fluido do câmbio. Esses atalhos atacam o trocador de calor de alumínio por dentro e antecipam o rompimento que mistura os fluidos.</p></aside>
...
<aside class="telltale" role="note"><span aria-hidden="true">⚠️</span><p><strong>Defeito silencioso, ação imediata.</strong> O trocador de calor costuma não dar aviso claro até a contaminação avançar. Por isso a inspeção do aspecto do fluido é tão importante: o fluido leitoso é a prova antes que os trancos apareçam. Diante de qualquer sinal, não siga rodando com o câmbio nessas condições.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>A conta que importa.</strong> A inspeção do fluido e a troca preventiva no intervalo certo custam uma fração do reparo de um câmbio danificado. Olhar a cor do ATF de tempos em tempos é o gesto mais barato que existe para evitar a fatura de R$ 20 mil.</p></aside>

...
seoTitle: "Fiat Doblo 1.8 E.torQ"
...
defeito: "superaquecimento por falha no sistema de arrefecimento do motor E.torQ 1.8"
...
imagemAlt: "Fiat Doblo 1.8 E.torQ com indicador de temperatura no painel acima do normal"
faq:
  - pergunta: "Por que o Fiat Doblo 1.8 esquenta tanto em subidas com carga?"
    resposta: "Com 7 passageiros e bagagem, o Doblo opera próximo de 2 toneladas de peso total. O motor E.torQ 1.8 de 129 cv trabalha no limite em aclives, gerando mais calor do que o sistema de arrefecimento consegue dissipar quando há alguma falha, mesmo pequena."
  - pergunta: "Qual a causa mais comum de superaquecimento no Doblo 1.8?"
    resposta: "O termostato travado na posição fechada é a causa mais frequente. Ele impede a circulação do refrigerante pelo radiador, fazendo a temperatura subir rapidamente. O custo de troca é baixo, entre R$ 80 e R$ 150, e o serviço é relativamente simples."
  - pergunta: "Como saber se a bomba d'água do Doblo 1.8 está com problema?"
    resposta: "O principal sinal é aquecimento irregular: o carro esquenta mesmo com o termostato novo e o nível de refrigerante correto. A bomba d'água do E.torQ 1.8 usa impelidor plástico que pode soltar do eixo, fazendo o componente girar sem mover o líquido. A confirmação exige desmontagem."
  - pergunta: "O Doblo pode danificar a junta do cabeçote por superaquecimento?"
    resposta: "Sim. Episódios repetidos de superaquecimento dilatam o cabeçote de alumínio e comprometem a vedação da junta. Os sinais incluem fumaça branca no escapamento, perda de refrigerante sem vazamento visível e óleo com aspecto leitoso. O reparo custa entre R$ 2.500 e R$ 4.500."
  - pergunta: "Com que frequência devo verificar o refrigerante do Doblo 1.8?"
    resposta: "O recomendado é verificar o nível no reservatório mensalmente, especialmente em veículos usados com frequência em viagens ou com ocupação máxima. Trocar o fluido conforme o manual (geralmente a cada 2 anos ou 40 mil km) e substituir termostato e tampa do radiador preventivamente a cada 60 mil km."
passos:
  - nome: "Verificar o nível e o estado do refrigerante"
    texto: "Com o motor frio, abra o reservatório e confira se o nível está entre o mínimo e o máximo. Refrigerante marrom, turvo ou com cheiro de queimado indica contaminação ou degradação. Verifique também se há vestígios de óleo na superfície do líquido, sinal de junta comprometida."
  - nome: "Testar o termostato"
    texto: "Aqueça o motor até a temperatura de operação e observe o mangueira superior do radiador. Se ela continuar fria por mais de 10 minutos após o motor atingir a temperatura normal, o termostato está travado fechado. Substitua o componente antes de qualquer outra intervenção."
  - nome: "Avaliar a bomba d'água"
    texto: "Com o motor aquecido e o termostato confirmado como funcional, observe se há circulação pelo radiador ao abrir brevemente a tampinha do reservatório (com cuidado, motor não pode estar sob pressão). Sem fluxo visível, a bomba é a suspeita. A confirmação definitiva exige remoção e inspeção do impelidor."
  - nome: "Checar a tampa do radiador"
    texto: "A tampa do radiador do Doblo 1.8 deve manter pressão de 1,0 a 1,1 kgf/cm². Uma tampa fraca permite que o sistema perca pressão, o que reduz o ponto de ebulição do refrigerante e causa falsos superaquecimentos. Teste com manômetro de pressão ou substitua preventivamente por menos de R$ 60."
  - nome: "Inspecionar o radiador e a junta do cabeçote"
    texto: "Famílias que usam o ar-condicionado com frequência aceleram o entupimento do radiador. Verifique as aletas e considere limpeza química a cada 60 mil km. Se todos os componentes anteriores estiverem em ordem e o carro ainda superaquecer, leve para diagnóstico do cabeçote com teste de compressão e análise de gás no sistema de arrefecimento."
afiliados:
  - produto: "Termostato para Fiat Doblo 1.8 E.torQ"
    nota: "Prefira peças de fabricantes como Wahler ou Motorad, compatíveis com o E.torQ 1.8. Evite genéricos sem procedência."
    busca: "termostato Fiat Doblo 1.8 E.torQ"
    programa: "amazon"
    cta: "Ver produto"
  - produto: "Bomba d'água metálica para Fiat Doblo 1.8"
    nota: "Versão com impelidor metálico evita o problema crônico do impelidor plástico original. Vale o investimento adicional na troca."
    busca: "bomba d'água Fiat Doblo 1.8 E.torQ impelidor metal"
...
pontosChave:
  - "Sintoma: temperatura sobe acima do normal em subidas ou com carga máxima"
  - "Causa: termostato travado fechado é o culpado mais comum e mais barato de resolver"
  - "Ação: substituir termostato e tampa do radiador preventivamente a cada 60 mil km"
  - "Atenção: superaquecimento repetido pode destruir a junta do cabeçote — custo de até R$ 4.500"
fontes:
  - { titulo: "Manual do proprietário Fiat Doblo 2010", url: "https://www.fiat.com.br/content/dam/fiat/br/pdf/manuais/doblo-2010.pdf" }
  - { titulo: "Fiat E.torQ Engine Technical Overview — Fiat Chrysler Automobiles", url: "https://www.fcagroup.com/en-US/group/motorization/Pages/etorq.aspx" }
draft: false
---
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Temperatura normal.</strong> O Doblo 1.8 opera entre 85 °C e 95 °C em condições normais. O ponteiro deve estabilizar no centro do marcador. Se subir além disso, desligue o ar-condicionado imediatamente e observe. Se continuar subindo, pare o veículo com segurança.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Comece aqui.</strong> Antes de qualquer outro diagnóstico, cheque o termostato. É o componente mais comum a falhar no E.torQ 1.8 e o mais barato de trocar. Muitos proprietários gastam fortunas em radiadores novos sem antes testar o termostato.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Não repita o erro.</strong> Se trocar a bomba d'água, não instale a versão com impelidor plástico novamente. Pague a diferença e coloque a versão metálica. O custo adicional de R$ 150 a R$ 200 evita que você volte a oficina em dois ou três anos pelo mesmo motivo.</p></aside>
...
<aside class="telltale" role="note"><span aria-hidden="true">⚠️</span><p><strong>Troca preventiva.</strong> A cada 60 mil km ou dois anos, troque a tampa do radiador sem hesitar. O custo é irrisório comparado ao diagnóstico que ela pode causar se falhar em viagem com família.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Troca de refrigerante.</strong> O fluido de arrefecimento degrada com o tempo e deposita resíduos no radiador. Troque conforme o manual, geralmente a cada 40 mil km ou dois anos. Use sempre o fluido recomendado pela Fiat para o E.torQ (vermelho/rosa, à base de OAT).</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Não ignore o superaquecimento.</strong> Um episódio único de temperatura alta não destrói a junta. Mas repetidos episódios, mesmo que o carro não chegue a parar, comprometem a vedação progressivamente. Cada vez que o ponteiro sobe além do normal e você ignora, está acumulando dano no cabeçote.</p></aside>
...
<aside class="telltale" role="note"><span aria-hidden="true">⚠️</span><p><strong>Viagem com família.</strong> Antes de qualquer viagem de estrada com o Doblo carregado, verifique o nível de refrigerante, a condição da tampa do radiador e a temperatura do motor nos primeiros 20 minutos de subida. Problemas emergem exatamente quando o carro está mais carregado e mais longe de uma oficina.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Protocolo de viagem.</strong> Antes de viagens de estrada com o Doblo carregado: nível de refrigerante verificado, tampa do radiador testada, mangueiras inspecionadas. Esses três passos eliminam os riscos mais prováveis de superaquecimento em estrada.</p></aside>

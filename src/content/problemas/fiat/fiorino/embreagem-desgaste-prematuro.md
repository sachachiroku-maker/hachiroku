...
entidade:
  ...
  modelo: "Fiorino"
  motor: "1.4 Fire 8V"
  geracao: "todas as gerações com câmbio manual"
defeito: "desgaste prematuro de embreagem"
...
imagemAlt: "Kit de embreagem da Fiat Fiorino desgastado por uso comercial urbano intenso"
faq:
  - pergunta: "Quando trocar a embreagem da Fiat Fiorino Endurance?"
    resposta: "Não existe um intervalo fixo de quilometragem para trocar a embreagem, porque a durabilidade depende diretamente do estilo de uso. Em uso particular com percursos mistos, a embreagem pode durar 120 mil a 150 mil km. Em uso comercial urbano intenso, com dezenas de paradas por dia, cargas pesadas e trânsito lento, pode desgastar antes dos 80 mil km. Os sinais de desgaste são o termômetro real do momento de troca."
  - pergunta: "Qual o custo do kit de embreagem para a Fiorino 1.4?"
    resposta: "O kit de embreagem completo (disco + platô + rolamento de embreagem) para a Fiorino 1.4 Fire custa de R$ 400 a R$ 900, dependendo da marca (LUK, Valeo, Sachs). A mão de obra para a troca fica entre R$ 400 e R$ 700, exigindo a retirada da caixa de câmbio. O custo total do serviço fica entre R$ 800 e R$ 1.500 em oficinas independentes. Na concessionária, pode ser 30% a 50% mais caro."
  - pergunta: "Como saber se a embreagem da Fiorino está desgastada?"
    resposta: "Os principais sintomas são: pedal de embreagem mais alto (o ponto de engajamento sobe à medida que o disco se desgasta), cheiro de embreagem queimada após uso intenso, dificuldade para engrenar marchas, patinação do motor (rotação sobe mas a velocidade não acompanha, especialmente em subidas com carga) e vibração ao soltar o pedal. Qualquer um desses sinais é indicação para inspeção."
  - pergunta: "É necessário trocar o flywheel junto com a embreagem na Fiorino?"
    resposta: "Não obrigatoriamente. O flywheel (volante de inércia) do motor Fire 1.4 é um componente robusto que, em muitos casos, pode ser retificado em vez de substituído. Quando a embreagem patina por muito tempo antes da troca, as pastilhas desgastadas podem riscar o flywheel. Nesse caso, a retífica do flywheel (R$ 200 a R$ 400) é indicada junto com a troca do kit. Substituir o flywheel novo (R$ 600 a R$ 1.200) só é necessário em casos de dano grave."
  - pergunta: "A embreagem da Fiorino em uso de entregas dura menos do que em uso particular?"
    resposta: "Sim, significativamente menos. Em entregas urbanas com paradas frequentes, a embreagem é acionada dezenas de vezes por hora. Cada parada no trânsito com o veículo em movimento parcial (embreagem meio solta enquanto o carro avança devagar) desgasta a forração do disco de forma acelerada. Em contraste, em uso em rodovia ou percursos longos sem trânsito, a embreagem quase não sofre. O uso comercial urbano pode reduzir a vida da embreagem para menos da metade do uso particular."
passos:
  - nome: "Identifique os sintomas de desgaste"
    texto: "Observe o ponto de engajamento da embreagem. Em embreagem nova, o engajamento ocorre com o pedal ainda próximo ao piso. À medida que o disco se desgasta, o ponto de engajamento sobe, até que o pedal precise ser solto quase completamente para a embreagem conectar. Faça o teste em uma rampa: se o carro deslizar para trás com a primeira marcha engajada e o pedal solto, a embreagem está patinando."
  - nome: "Faça o teste de patinagem em subida"
    texto: "Em uma subida moderada, tente partir com carga (com o furgão carregado). Se a rotação do motor subir mas a velocidade não aumentar na mesma proporção, ou se o carro não vencer a subida, a embreagem está patinando. Esse é o sinal mais definitivo de que o disco está no limite do desgaste."
  - nome: "Verifique o estado do fluido hidráulico da embreagem"
    texto: "A Fiorino usa sistema hidráulico de acionamento da embreagem. O reservatório de fluido (geralmente compartilhado com o freio) deve ter o fluido no nível correto e com aparência clara a âmbar. Fluido escuro ou com nível baixo pode causar acionamento impreciso da embreagem, mascarando o diagnóstico de desgaste mecânico. Troque o fluido a cada 2 anos ou conforme o manual."
  - nome: "Leve para inspeção com a caixa desmontada"
    texto: "O diagnóstico definitivo exige a retirada da caixa de câmbio para acessar o disco, o platô e o rolamento de embreagem. O mecânico mede a espessura do disco com paquímetro: espessura mínima em torno de 6 mm é o limite de troca (verifique o valor exato no manual). Além do disco, o platô é inspecionado por trincas, deformação e desgaste das molas, e o rolamento pelo ruído e folga."
  - nome: "Defina o escopo: kit completo ou componente a componente"
    texto: "A prática recomendada é sempre trocar o kit completo (disco + platô + rolamento) de uma vez, pois o custo de mão de obra para abrir a caixa novamente em poucos meses supera a economia de trocar só o disco agora. Se o flywheel estiver riscado, inclua a retífica no mesmo serviço. Se o garfo de embreagem apresentar desgaste, troque também: é uma peça de R$ 50 a R$ 150 que elimina o risco de retorno à oficina cedo."
pontosChave:
  - "A embreagem da Fiorino Endurance pode durar de 80 mil a 150 mil km, dependendo diretamente do estilo de uso: entrega urbana intensa reduz a vida para menos da metade do uso particular."
  - "Patinagem em subida com carga, ponto de engajamento alto e cheiro de embreagem queimada são os principais sinais de desgaste avançado."
  - "O kit completo (disco + platô + rolamento) custa de R$ 400 a R$ 900; com mão de obra, o serviço total fica entre R$ 800 e R$ 1.500."
  - "Sempre trocar o kit completo de uma vez: a mão de obra de retirar a caixa novamente supera a economia de trocar peças separadas."
  - "Evitar o 'meio-pé' na embreagem em trânsito lento é o hábito de direção que mais prolonga a vida da embreagem em uso urbano."
fontes:
  ...
  - { titulo: "Problemas e falhas Fiat Fiorino (Opinautos)", url: "https://www.opinautos.com.br/fiat/fiorino/defeitos" }
draft: false
---
...
**Peças (disco + platô + rolamento):**
Kit LUK: R$ 600 a R$ 900
Kit Valeo: R$ 500 a R$ 800
Kit Sachs: R$ 400 a R$ 700
Kit paralelo nacional: R$ 250 a R$ 450 (menor durabilidade esperada)

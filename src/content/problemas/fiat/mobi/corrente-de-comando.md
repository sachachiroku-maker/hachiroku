...
entidade:
  ...
  geracao: "2016 em diante"
defeito: "desgaste da corrente de comando e do tensionador"
kicker: "DEFEITO CRÔNICO"
intencao: "Diagnóstico e alerta preventivo"
entidadesEssenciais:
  - "corrente de comando banhada a óleo"
  - "motor Firefly 1.0 de 3 cilindros"
...
imagemAlt: "Corrente de comando do motor Firefly 1.0 do Fiat Mobi"
faq:
  - pergunta: "O Fiat Mobi tem corrente ou correia de comando?"
    resposta: "O Fiat Mobi com motor Firefly 1.0 de 3 cilindros, fabricado de 2016 em diante, usa corrente de comando banhada a óleo, e não correia dentada. A corrente é projetada pela Fiat para durar a vida útil do motor, sem troca programada preventiva, apenas inspeção nas revisões. As gerações mais antigas do motor Fire da família anterior também usavam corrente, mas o foco deste alerta é o Firefly de 3 cilindros, que é o motor da maioria dos Mobi em circulação."
  - pergunta: "A corrente de comando do Mobi precisa ser trocada periodicamente?"
    resposta: "Pela recomendação de fábrica, não há intervalo de troca programada para a corrente de comando do Firefly: ela é tratada como peça de vida longa, só inspecionada nas revisões. Na prática, porém, casos de desgaste precoce existem e costumam estar ligados a óleo fora de especificação ou revisão atrasada. Por isso, mesmo sem prazo oficial, vale pedir uma inspeção do conjunto se aparecer ruído a frio."
  - pergunta: "Qual o barulho da corrente de comando desgastada no Mobi?"
    resposta: "O sinal mais citado é um ruído metálico, tipo chocalho ou tique-tique, que aparece principalmente na partida a frio e tende a sumir depois que o motor esquenta e o tensionador ganha pressão de óleo. Conforme o desgaste avança, o barulho pode ficar mais constante. Esse ruído pede inspeção, porque pode ser corrente, tensionador ou guia."
  - pergunta: "O que acontece se a corrente de comando do Mobi pular dente?"
    resposta: "Se a corrente folga demais e pula um dente na engrenagem, o motor perde o sincronismo entre comando e virabrequim. No pior cenário, válvula e pistão podem se encontrar, o que dobra válvula e pode causar dano grave ao motor. É o desfecho que transforma um reparo de corrente em um conserto de cabeçote ou de motor."
  - pergunta: "Quanto custa trocar a corrente de comando do Fiat Mobi?"
    resposta: "Não há um preço oficial de fábrica para esse serviço. Relatos de oficina e de fóruns de donos colocam o reparo preventivo do conjunto de corrente em torno de alguns milhares de reais, com mão de obra que exige abrir parte do motor. Se houver dano de válvula por pular dente, o valor sobe bastante, porque entra cabeçote. Trate esses números como referência de mercado, não como tabela oficial, e peça orçamento na sua região."
  - pergunta: "O óleo errado pode estragar a corrente de comando do Firefly?"
    resposta: "Sim. Como a corrente do Firefly trabalha banhada no óleo do motor e depende dele para a pressão do tensionador, um óleo fora da especificação ou trocado fora do intervalo prejudica a lubrificação do conjunto e acelera o desgaste. Por isso, usar o óleo indicado no manual do seu ano, no intervalo certo, é a prevenção mais barata e direta para a corrente."
  - pergunta: "Vale a pena vender o Mobi por causa da corrente de comando?"
    resposta: "Não necessariamente. O desgaste precoce da corrente é tratado como caso pontual, mais ligado a manutenção descuidada do que a um defeito de projeto generalizado. Um Mobi com histórico de óleo correto e revisões em dia tende a chegar longe sem esse problema. O cuidado é manter a rotina de manutenção e investigar qualquer ruído a frio cedo, em vez de ignorar."
  - pergunta: "Como saber se o problema é a corrente ou o tensionador?"
    resposta: "Os dois andam juntos e o diagnóstico é de oficina. O tensionador é quem mantém a corrente esticada usando a pressão do óleo; a guia é a peça plástica sobre a qual a corrente desliza. Um tensionador fraco ou uma guia gasta deixam a corrente bater, mesmo que a corrente em si ainda esteja boa. Por isso o conserto costuma considerar o conjunto, e não só a corrente isolada."
passos:
  - nome: "Identifique o motor do seu Mobi"
    texto: "Confirme que o seu Mobi usa o motor Firefly 1.0 de 3 cilindros (presente na maioria dos modelos de 2016 em diante). É esse o motor de corrente de comando banhada a óleo a que este alerta se refere. A informação consta no manual e na documentação do veículo."
  - nome: "Fique atento ao barulho na partida a frio"
    texto: "Ligue o carro frio, de manhã, e ouça o motor nos primeiros segundos. Um chocalho ou tique-tique metálico que some quando o motor esquenta é o sinal clássico que pede inspeção da corrente, do tensionador e da guia."
  - nome: "Verifique o histórico de óleo do carro"
    texto: "Levante todas as trocas de óleo. Se em algum momento foi usado óleo fora da especificação do manual, ou se o intervalo de troca foi estourado, o conjunto da corrente pode ter sofrido desgaste mesmo com baixa quilometragem."
  - nome: "Leve para inspeção ao primeiro sinal"
    texto: "Diante de ruído a frio persistente, luz de injeção ou perda de rendimento, leve a um profissional para checar a folga da corrente e o estado do tensionador. Agir cedo é o que evita o pior cenário, que é a corrente pular dente."
  - nome: "Mantenha óleo e revisão na régua"
    texto: "Use sempre o óleo na especificação exata do manual do seu ano, no intervalo recomendado, e faça as revisões. É a forma mais simples e barata de preservar a corrente de comando, que depende do óleo para se manter esticada e lubrificada."
afiliados:
  - produto: "Óleo na especificação para o motor Firefly do Mobi"
    nota: "O óleo certo é o que mais protege a corrente banhada a óleo. É o item mais barato que evita o reparo mais caro."
    busca: "oleo motor 0w20 firefly fiat"
    programa: "amazon"
    cta: "Ver óleo recomendado"
  - produto: "Scanner OBD2 Bluetooth"
    nota: "Acompanha parâmetros do motor e ajuda a flagrar luz de injeção e códigos antes do estrago."
    busca: "scanner obd2 bluetooth"
    programa: "amazon"
  - produto: "Kit de troca de óleo e filtro para Fiat Mobi Firefly"
    nota: "Troca no intervalo correto, com filtro certo, é o que mantém o tensionador com pressão e a corrente esticada."
    busca: "kit troca oleo filtro fiat mobi firefly"
    programa: "mercadoLivre"
relacionados:
  - titulo: "Ficha técnica do Fiat Mobi"
    url: "/ficha-tecnica/fiat/mobi/"
  - titulo: "Todos os diagnósticos por modelo"
    url: "/problemas/"
pontosChave:
  - "Chocalho ou tique-tique metálico na partida a frio que some quando o motor esquenta indica folga na corrente, no tensionador ou na guia, e pede inspeção"
  - "A corrente é banhada a óleo e o tensionador depende da pressão do óleo, então óleo fora de especificação ou revisão atrasada acelera o desgaste"
  - "Corrente folgada pode pular dente, perder o sincronismo e fazer válvula encontrar pistão, transformando um reparo de corrente em conserto de cabeçote"
  - "A prevenção mais barata é usar o óleo na especificação exata do manual, no intervalo certo, com nível em dia, e agir no primeiro ruído"
fontes:
  - { titulo: "Carros que não têm correia dentada, veja 10 motores que usam corrente", url: "https://autopapo.com.br/noticia/carros-sem-correia-dentada/" }
  - { titulo: "Motores Firefly da Fiat, conheça seus diferenciais", url: "https://blog.deltafiat.com.br/motores-firefly/" }
  - { titulo: "Problemas dos motores 1.0 Firefly e 1.6 EC5 (Fiat, Peugeot e Citroën)", url: "https://forumcarros.com.br/mecanica/problemas-dos-motores-1-0-firefly-e-1-6-ec5/" }
draft: false
---
...
O problema crônico aparece quando essa promessa esbarra na realidade da manutenção: com **óleo fora de especificação** ou **revisão atrasada**, a corrente e o tensionador desgastam antes da hora, e o motor começa a dar um <mark>barulho metálico a frio</mark> que, ignorado, pode terminar em válvula dobrada. É assim que um conjunto pensado para a vida toda vira uma fatura de cabeçote.
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Por que isso importa.</strong> Como não existe um prazo oficial de troca, muita gente esquece que a corrente <mark>depende do óleo</mark> para funcionar. Não há um aviso no painel dizendo "troque a corrente". O único aviso costuma ser o barulho a frio, e é nesse momento que vale agir, não relaxar.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>O conjunto, não só a corrente.</strong> Quando dá ruído, nem sempre a culpada é a corrente. Um tensionador fraco ou uma guia gasta deixam a corrente bater mesmo com a corrente em bom estado. Por isso o diagnóstico e o reparo costumam tratar o conjunto inteiro, e não a peça isolada.</p></aside>
...
<aside class="telltale" role="note"><span aria-hidden="true">⚠️</span><p><strong>Não normalize o chocalho a frio.</strong> É comum o dono se acostumar com o barulho da partida e tratar como "manha do carro". Esse é o erro. Um ruído metálico a frio persistente no Firefly pede inspeção da corrente, do tensionador e da guia antes de virar problema maior.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>O dominó da falha.</strong> Óleo errado ou atrasado enfraquece o tensionador. O tensionador fraco deixa a corrente folgar. A corrente folgada pula dente. O dente pulado tira o sincronismo. Sem sincronismo, a válvula encontra o pistão. A peça que "duraria a vida toda" leva junto a parte mais cara do motor.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>A conta que importa.</strong> A diferença entre o reparo barato e o caro é o tempo de reação. Quem investiga o ruído a frio cedo costuma resolver no conjunto da corrente. Quem ignora até pular dente paga o cabeçote. E mais barato que os dois é simplesmente o óleo certo, no intervalo certo.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>O atalho que sai caro.</strong> Trocar o óleo com um produto fora da especificação para economizar alguns reais, ou empurrar a troca "mais um pouco". Nesse motor, isso ataca diretamente o tensionador e a corrente. É o caminho mais comum para transformar um conjunto de vida longa em um reparo de motor aberto.</p></aside>
...
<aside class="telltale" role="note"><span aria-hidden="true">⚠️</span><p><strong>Não é motivo para vender o carro.</strong> Um Mobi Firefly com histórico de óleo correto e revisões em dia tende a não ter esse problema. O recado não é "fuja do Mobi", e sim "respeite o óleo deste motor". O cuidado certo coloca a corrente do lado seguro da conta.</p></aside>
...
Veja a referência completa do modelo na [ficha técnica do Fiat Mobi](/ficha-tecnica/fiat/mobi/) e os demais alertas em [todos os diagnósticos por modelo](/problemas/).

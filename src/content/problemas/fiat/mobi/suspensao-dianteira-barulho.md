...
entidade:
  marca: "Fiat"
  modelo: "Mobi"
  motor: "Firefly 1.0 de 3 cilindros (75 cv)"
...
imagemAlt: "Suspensão dianteira McPherson do Fiat Mobi com bieleta e coxim destacados"
faq:
  - pergunta: "Qual o barulho mais comum na suspensão dianteira do Fiat Mobi?"
    resposta: "O barulho mais frequente é o 'traque-traque' ou 'cloc-cloc' em curvas e manobras causado pela bieleta da barra estabilizadora desgastada. É a peça que falha primeiro na maioria dos Mobis com uso urbano intenso."
  - pergunta: "Quanto custa trocar a bieleta do Fiat Mobi?"
    resposta: "A bieleta nacional (Cofap, Monroe) custa entre R$ 50 e R$ 80 a unidade em 2025-2026. A troca do par completo com mão de obra em oficina independente fica entre R$ 180 e R$ 280."
  - pergunta: "O barulho na suspensão do Mobi é perigoso?"
    resposta: "Depende da peça. Bieleta desgastada reduz estabilidade em curvas e é risco real. Coxim furado piora o controle em lombadas. Pivô com folga compromete a geometria da direção. Nenhum barulho de suspensão deve ser ignorado por mais de algumas semanas."
  - pergunta: "Como testar a suspensão do Fiat Mobi em casa sem equipamento?"
    resposta: "Com o carro parado em piso plano: pedalar o para-choque dianteiro (empurrar e soltar com força) revela batente e coxim soltos. Girar o volante de batente a batente com o motor ligado e carro parado revela bieleta ruim. Ouvir onde vem o barulho já aponta a região."
  - pergunta: "O coxim do amortecedor do Mobi precisa ser trocado junto com o amortecedor?"
    resposta: "Não necessariamente, mas é recomendado. Se o amortecedor ainda está bom e apenas o coxim está desgastado, trocar só o coxim resolve. Porém, se o amortecedor já tem mais de 60.000 km, aproveitar a desmontagem para trocar ambos sai mais barato no total."
passos:
  - nome: "Identifique o tipo de barulho"
    texto: "Anote quando o barulho acontece: em curvas e manobras (bieleta), em lombadas com batida seca (coxim/batente), em irregularidades pontuais com 'toc' metálico (pivô), ou ruído grave em manobras lentas (bucha). Cada padrão aponta para uma peça diferente."
  - nome: "Teste estático no para-choque"
    texto: "Com o carro parado, empurre o para-choque dianteiro com força duas ou três vezes e solte. O carro deve subir e parar sem ruídos. Se ouvir 'ploft', 'toc' ou qualquer batida, o batente ou coxim do amortecedor está cedendo."
  - nome: "Teste com o volante parado"
    texto: "Motor ligado, carro parado, gire o volante devagar de um batente ao outro. Barulho de 'cloc' ou 'traque' nessa situação confirma bieleta da barra estabilizadora desgastada no lado de onde vem o som."
  - nome: "Leve para inspeção visual na rampa"
    texto: "Com o carro elevado em rampa ou cavalete, peça ao mecânico que balance as rodas dianteiras lateralmente e para frente/trás. Folga lateral aponta pivô; folga longitudinal aponta bucha de bandeja. A bieleta pode ser testada manualmente puxando a garra."
  - nome: "Troque em par e revise a geometria"
    texto: "Sempre troque bieletas, pivôs e buchas em par (esquerdo e direito). Após qualquer intervenção na suspensão dianteira, faça alinhamento e balanceamento. Geometria fora do ponto consome pneus e mascara problemas resolvidos."
afiliados:
  - produto: "Bieleta da barra estabilizadora Fiat Mobi - par Cofap"
    nota: "Par de bieletas nacionais compatíveis com Mobi 2016 em diante. Verificar compatibilidade antes de comprar."
    busca: "bieleta barra estabilizadora Fiat Mobi Cofap"
    programa: "amazon"
    cta: "Ver produto"
  - produto: "Kit coxim batente amortecedor dianteiro Fiat Mobi"
    nota: "Kit completo com coxim e batente para um lado. Comprar dois kits para revisão completa."
    busca: "kit coxim batente amortecedor dianteiro Fiat Mobi"
    programa: "mercadoLivre"
relacionados:
  - titulo: "Todos os problemas do Fiat Mobi"
    url: "/problemas/fiat/mobi/"
  - titulo: "Ficha técnica do Fiat Uno Way 1.0"
    url: "/ficha-tecnica/fiat/uno-way-1-0/"
pontosChave:
  - "Sintoma: traque ou cloc em curvas indica bieleta desgastada, o problema mais comum no Mobi"
  - "Sintoma: ploft seco em lombadas aponta para coxim ou batente do amortecedor cedendo"
  - "Sintoma: toc metálico em irregularidades pode ser pivô da bandeja com folga"
  - "Causa: uso urbano intenso em piso precário acelera o desgaste de todas as peças elásticas"
  - "Ação: teste em casa puxando o para-choque e girando o volante antes de ir à oficina"
  - "Ação: troque sempre em par e refaça a geometria após qualquer reparo na suspensão"
  - "Atenção: suspensão com folga compromete frenagem, estabilidade e consumo de pneus"
fontes:
  - { titulo: "Manual do Proprietário Fiat Mobi 2022", url: "https://www.fiat.com.br/content/dam/fiat/br/manuais/mobi.pdf" }
  - { titulo: "Tabela de preços Cofap - linha suspensão 2025", url: "https://www.cofap.com.br/produtos/suspensao" }
draft: false
---
...
<aside class="telltale" role="note"><span aria-hidden="true">⚠️</span><p><strong>Diagnóstico rápido da bieleta.</strong> Com o motor ligado e o carro parado, gire o volante devagar de batente a batente. Se ouvir cloc ou traque de um lado, a bieleta daquele lado está desgastada. O som sai exatamente do ponto onde a peça está.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Troque sempre em par.</strong> Mesmo que o barulho venha de um lado só, troque as duas bieletas. A do outro lado está no mesmo estágio de desgaste e vai falhar em poucos meses. Uma segunda visita à oficina sai mais caro que trocar tudo de uma vez.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Coxim ruim afeta a direção.</strong> O coxim do amortecedor McPherson também funciona como rolamento de esterçamento. Um coxim travado pode fazer a direção do Mobi ficar pesada ou irregular. Se sentir resistência diferente ao volante junto com o barulho, inspecione com urgência.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Amortecedor + coxim ao mesmo tempo.</strong> Se o amortecedor do seu Mobi tem mais de 60.000 km ou já apresenta vazamento de óleo, aproveite a desmontagem para trocar os dois. O amortecedor dianteiro nacional (Cofap/Monroe) para o Mobi custa entre R$ 200 e R$ 350 por unidade. Trocar junto economiza a mão de obra de uma segunda desmontagem.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Pivô frouxo é risco de segurança real.</strong> Em estágio avançado, um pivô sem manutenção pode se desencaixar com o carro em movimento. Isso resulta em perda total do controle direcional daquele lado. Se o toc estiver presente há mais de 2 semanas, não adie a inspeção.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Bucha ou pivô?</strong> A diferença prática: bucha ruim faz ruído em manobras lentas e no movimento longitudinal da bandeja. Pivô ruim faz barulho pontual em irregularidades e no movimento lateral. Nas duas situações, a roda sobe e desce normalmente, o que confunde o diagnóstico. O mecânico na rampa consegue diferenciar com facilidade.</p></aside>
...
<aside class="telltale" role="note"><span aria-hidden="true">⚠️</span><p><strong>Cavalete antes de colocar as mãos.</strong> Nunca inspecione a suspensão com o carro apoiado apenas no macaco. O macaco pode ceder. Use cavaletes de apoio em todos os quatro pontos antes de qualquer inspeção embaixo do carro.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Revisão preventiva recomendada.</strong> A cada 30.000 km ou 2 anos (o que vier primeiro), peça ao mecânico uma inspeção completa da suspensão dianteira com o carro na rampa. O custo da inspeção é zero na maioria das oficinas que farão o serviço. Pegar a peça no começo do desgaste é sempre mais barato que esperar ela quebrar.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Suspensão não é estética.</strong> Barulho de suspensão não é apenas incômodo. É a carroceria dizendo que peças de segurança estão com folga. Deixar para depois só aumenta o custo (peças vizinhas se desgastam mais rápido) e o risco.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Oficina independente com experiência em Fiat.</strong> Para suspensão do Mobi, oficinas independentes especializadas em Fiat entregam exatamente o mesmo resultado que a concessionária. Peça indicação, verifique se têm rampa de alinhamento própria e confirme o uso de peças de qualidade (Cofap, Monroe, Nakata).</p></aside>

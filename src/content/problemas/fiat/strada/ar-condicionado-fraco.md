...
entidade:
  ...
  modelo: "Strada"
  motor: "Firefly 1.3"
  geracao: "Nova Strada (2021 em diante)"
defeito: "ar-condicionado fraco com queda de rendimento"
...
faq:
  ...
  - pergunta: "Recarregar o gás sem achar o vazamento resolve o problema?"
    resposta: "Apenas temporariamente. Se há microvazamento, o gás volta a cair em meses e o AC enfraquece de novo. A oficina correta faz vacuometria antes de recarregar: mantém o sistema em vácuo por alguns minutos para confirmar que está vedado. Se a pressão cai no vácuo, há vazamento e ele precisa ser corrigido antes da recarga. Recarregar sem essa etapa é jogar dinheiro fora."
  - pergunta: "O motor Firefly 1.3 da Strada perde desempenho com o AC ligado?"
    resposta: "Sim, e isso é normal. O compressor de AC representa uma carga real no motor. Com o AC ativado, a potência disponível para tração cai alguns cavalos, o que é perceptível em arrancadas e subidas. Isso não é defeito. O que não é normal é o motor esquentar com o AC ligado: se a temperatura sobe ao acionar o AC no trânsito parado, o problema está no ventilador do condensador ou no sistema de arrefecimento, não no AC em si."
  - pergunta: "Posso continuar usando a Strada com o AC fraco por um tempo?"
    resposta: "Depende da causa. Se o compressor está com vedação danificada, continuar usando pode agravar o dano interno e contaminar o circuito com fragmentos, tornando o reparo muito mais caro. Se for só gás baixo, o risco imediato é menor, mas o sistema opera fora das condições ideais. O sinal de alerta para parar de usar o AC e ir direto à oficina é qualquer barulho ao ligar o compressor: batimento, rangido ou chiado metálico indica dano mecânico em curso."
  - pergunta: "Qual é o custo para resolver o AC fraco na Fiat Strada?"
    resposta: "O custo depende da causa. Filtro de cabine: R$ 30 a R$ 80. Recarga de gás R-134a com vacuometria: R$ 180 a R$ 350. Troca do filtro secador: R$ 150 a R$ 280. Reparo ou troca de compressor: R$ 800 a R$ 1.800, dependendo se é reparo da vedação, compressor remanufaturado ou original. A sequência lógica é verificar do mais barato ao mais caro antes de concluir que o compressor precisa ser substituído."
passos:
  - nome: "Troque o filtro de cabine antes de qualquer outra coisa"
    texto: "O filtro de cabine da Strada fica geralmente atrás do porta-luvas do passageiro, acessível sem ferramentas especiais. Retire o filtro e observe o estado: filtro escuro, compactado e com detritos visíveis está entupido e deve ser trocado. Um filtro novo custa entre R$ 30 e R$ 80 e a troca leva menos de 15 minutos. Se não há registro de troca nos últimos 15.000 km ou 1 ano, comece por aqui antes de gastar com diagnóstico de gás ou compressor."
  - nome: "Verifique se o compressor está acionando"
    texto: "Com o motor ligado e o AC no máximo, observe a polia do compressor. A parte central (prato da embreagem) deve girar junto com a polia externa quando o AC está ativo. Se só a externa gira, o compressor não está sendo acionado: verifique o fusível do AC, o relé do compressor e o sensor de pressão do circuito. Se o compressor aciona mas o ar permanece fraco, o problema está no gás ou na eficiência de compressão."
  - nome: "Limpe o condensador"
    texto: "O condensador da Strada fica logo atrás da grade frontal. Com uma lanterna, verifique se há sujeira, insetos e poeira compactada nas aletas. Um condensador parcialmente entupido faz o AC funcionar bem em estrada mas fraquear no trânsito parado. A limpeza é feita com água em baixa pressão, aplicada da parte de dentro para fora. Não use jato forte nas aletas, que são finas e dobram com facilidade."
  - nome: "Peça diagnóstico com manômetros em oficina de AC"
    texto: "Com o filtro trocado e o condensador limpo, se o AC ainda está fraco, leve para uma oficina especializada. O mecânico conecta manômetros nas válvulas de serviço de alta e baixa pressão e lê as pressões com o sistema estabilizado. Pressão baixa abaixo de 1,5 bar indica gás insuficiente. Pressão de alta e baixa próximas indicam compressor sem eficiência de compressão (vedação). Esse diagnóstico define o próximo passo com precisão."
  - nome: "Avalie reparo ou troca do compressor com base no diagnóstico"
    texto: "Se a leitura de pressão confirmar problema no compressor, peça ao mecânico a avaliação do estado interno antes de decidir entre reparo da vedação e troca. Um compressor com dano de vedação recente, sem fragmentos metálicos no circuito, pode ser reparado por custo menor. Se já há contaminação do circuito, a troca do compressor deve vir acompanhada de limpeza do circuito, troca do filtro secador e verificação das mangueiras, para evitar que o novo compressor seja danificado pelos resíduos do antigo."
pontosChave:
  - "Sintoma: ar-condicionado que esfria pouco ou perdeu rendimento progressivamente, com piora ao longo de semanas ou meses, especialmente no trânsito parado."
  - "Causa: microvazamento de gás R-134a (pressão abaixo do ideal) ou compressor com problema de vedação interna (perda de eficiência de compressão), separados pela leitura com manômetros."
  - "Ação: trocar o filtro de cabine primeiro (mais barato), limpar o condensador, e só então fazer o diagnóstico com manômetros em oficina especializada antes de decidir sobre recarga de gás ou reparo do compressor."
fontes:
  - { titulo: "Fiat Strada 2021+ ficha técnica e motor Firefly 1.3 (Fiat Brasil)", url: "https://www.fiat.com.br/carros/strada.html" }
  - { titulo: "Sistema de ar-condicionado automotivo: diagnóstico com manômetros (O Mecânico)", url: "https://omecanico.com.br/diagnostico-ar-condicionado-manometros/" }
afiliados:
  - produto: "Filtro de cabine para Fiat Strada Firefly 1.3"
    nota: "O filtro de cabine entupido é a causa mais simples e mais ignorada de AC fraco. Troca a cada 15.000 km ou 1 ano é o intervalo do manual."
    busca: "filtro cabine fiat strada 2021 2022 2023"
    programa: "mercadoLivre"
  - produto: "Compressor de AC para Fiat Strada Firefly 1.3"
    nota: "Se o diagnóstico confirmar problema de vedação ou dano interno, o compressor remanufaturado é opção de custo menor que o original, desde que o circuito esteja limpo."
    busca: "compressor ar condicionado fiat strada firefly 1.3"
    programa: "mercadoLivre"
  - produto: "Kit filtro secador de AC para Fiat Strada"
    nota: "Troca obrigatória sempre que o circuito é aberto. O filtro secador retém umidade e contaminantes que danificam o compressor novo."
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Teste rápido.</strong> Coloque a mão na saída central do painel com o AC no máximo por 5 minutos. Ar claramente mais frio que o ambiente é AC fraco, sistema ainda funcionando abaixo do ideal. Ar na temperatura do ambiente é AC que parou. Esse teste orienta o diagnóstico na oficina.</p></aside>
...
<aside class="telltale warning" role="note"><span aria-hidden="true">⚠️</span><p><strong>Recarga sem vacuometria não resolve.</strong> Recarregar o gás sem localizar e selar o vazamento é solução temporária: em meses, o gás volta a cair. A oficina correta faz vacuometria antes da recarga para confirmar que o sistema está vedado. Se a pressão cai no vácuo, o vazamento precisa ser corrigido antes de colocar gás novo.</p></aside>
...
| Leitura | Gás baixo | Compressor com vedação |
| --- | --- | --- |
| Pressão de baixa (lado de sucção) | Abaixo de 1,5 bar | Próxima da pressão de alta |
| Pressão de alta (lado de descarga) | Abaixo de 12 bar | Próxima da pressão de baixa |
| Diferença de pressão | Existe, mas ambas abaixo do normal | Muito pequena (compressor não comprime) |
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Barulho ao ligar o AC: pare imediatamente.</strong> Batimento, rangido ou chiado metálico ao acionar o compressor indica dano mecânico interno em curso. Continuar usando fragmenta peças internas e contamina todo o circuito com metal. Nesse caso, desligue o AC e leve o carro à oficina sem adiamento, porque o custo do reparo cresce com cada quilômetro rodado com o AC ligado.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Ordem de custo crescente.</strong> Filtro de cabine (R$ 30 a R$ 80), limpeza de condensador (R$ 80 a R$ 150), recarga de gás com vacuometria (R$ 180 a R$ 350), troca do filtro secador (R$ 150 a R$ 280), reparo ou troca do compressor (R$ 800 a R$ 1.800). Seguir essa sequência evita pular para o item mais caro quando o problema era o mais simples.</p></aside>

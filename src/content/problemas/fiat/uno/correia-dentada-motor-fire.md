---
title: "Fiat Uno 1.0 Fire Flex: correia dentada, quando trocar e o risco de quebrar"
...
entidade:
  marca: "Fiat"
  modelo: "Uno"
  motor: "1.0 Fire Flex / 1.4 Fire Flex"
  geracao: "2004-2013"
defeito: "Correia dentada — desgaste e risco de ruptura"
kicker: "DEFEITO CRÔNICO"
intencao: "Diagnóstico"
entidadesEssenciais: ["correia dentada", "motor Fire Flex", "Fiat Uno"]
autor:
  nome: "Equipe Técnica Hachiroku"
  credencial: ""
pubDate: 2026-06-20
updatedDate: 2026-06-20
disclaimer: "As informações deste artigo têm caráter educativo. Sempre consulte um mecânico habilitado antes de realizar qualquer intervenção no veículo."
imagem: "/logos/hachiroku-badge-86.png"
imagemAlt: "Correia dentada do motor Fire Flex do Fiat Uno — guia de troca e diagnóstico"
faq:
  - pergunta: "De quantos em quantos quilômetros troco a correia dentada do Uno Fire?"
    resposta: "A Fiat recomenda a troca a cada 60.000 km ou 5 anos, o que ocorrer primeiro. Em uso urbano intenso ou clima quente, muitos mecânicos antecipam para 50.000 km."
  - pergunta: "O que acontece se a correia dentada do Fire quebrar?"
    resposta: "O motor para imediatamente. No Fire, as válvulas podem colidir com os pistões, causando dobramento de válvulas, dano ao cabeçote e, nos casos mais graves, destruição do bloco."
  - pergunta: "Quais peças devem ser trocadas junto com a correia dentada?"
    resposta: "Tensor, tensor hidráulico (quando houver), rolamento tensor de direção hidráulica e, idealmente, a bomba d'água — já que ela é acionada pela própria correia no Fire."
  - pergunta: "Quanto custa trocar a correia dentada do Fiat Uno Fire?"
    resposta: "O kit de correia (correia + tensor + rolamento) custa entre R$ 200 e R$ 350 em peças de marcas como Gates ou SKF. A mão de obra varia de R$ 150 a R$ 300 dependendo da região."
  - pergunta: "Como saber se a correia dentada do Uno está perto do limite?"
    resposta: "Verifique a quilometragem e a data da última troca. Visualmente, procure fissuras, ressecamento, dentes desgastados ou óleo sobre a correia. Qualquer um desses sinais exige troca imediata."
passos:
  - nome: "Verifique quilometragem e data"
    texto: "Consulte o manual ou a revisão anterior. Se não souber quando a correia foi trocada, trate como vencida e leve ao mecânico para inspeção."
  - nome: "Inspecione visualmente com o motor frio"
    texto: "Remova a tampa protetora da correia e observe a superfície. Fissuras transversais, dentes lascados, ressecamento ou presença de óleo indicam substituição imediata."
  - nome: "Verifique a tensão"
    texto: "Com o motor desligado, pressione levemente a correia com o dedo. Folga excessiva ou correia muito rígida indicam tensor com defeito — troque o conjunto completo."
  - nome: "Monte o kit completo"
    texto: "Substitua correia, tensor, rolamento tensor e bomba d'água ao mesmo tempo. O custo adicional de peças não justifica deixar componentes velhos que forçarão nova desmontagem."
  - nome: "Marque a data e a quilometragem"
    texto: "Cole uma etiqueta no capô ou registre no aplicativo de manutenção. Programar a próxima troca com antecedência é a única forma de evitar a ruptura em movimento."
afiliados:
  - produto: "Kit correia dentada Gates para Fiat Uno Fire"
    nota: "Gates é a fornecedora original Fiat. Kit inclui correia e tensor."
    busca: "kit correia dentada Gates Fiat Uno Fire"
    programa: "amazon"
    cta: "Ver produto"
  - produto: "Kit correia dentada SKF Fiat Uno Fire Flex"
    nota: "SKF é referência em rolamentos e tensores. Boa opção de custo-benefício."
...
pontosChave:
  ...
  - "Acao: trocar correia + tensor + rolamento + bomba d'água como kit completo"
  - "Atencao: o motor Fire pode ter válvulas dobradas mesmo com ruptura em baixa rotação"
fontes:
  - { titulo: "Manual do Proprietário Fiat Uno (2004-2013)", url: "https://www.fiat.com.br/content/dam/fiat/br/download-center/manuais/uno/manual-uno-fire.pdf" }
  - { titulo: "Gates Timing Belt Application Guide — Fire 1.0 / 1.4", url: "https://www.gates.com/br/pt/products/automotive/timing-belts.html" }
  - { titulo: "SKF — Kits de distribuição para motores Fire", url: "https://www.skf.com/br/products/maintenance-and-lubrication/mounting-and-dismounting-tools" }
draft: false
---
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Válvulas dobradas.</strong> Uma correia rompida no Fire pode dobrar todas as válvulas do cabeçote. O conserto envolve desmontagem do cabeçote, substituição de válvulas, retifica e remontagem. O custo médio fica entre R$ 2.500 e R$ 5.000 dependendo do estado das peças internas.</p></aside>
...
<aside class="telltale" role="note"><span aria-hidden="true">⚠️</span><p><strong>Prazo por tempo, não só por km.</strong> Muitos donos de Uno rodam pouco, mas esquecem o critério dos 5 anos. Uma correia com 30.000 km mas 7 anos de uso já está fora do prazo. A borracha envelhece mesmo parada.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Óleo na correia.</strong> Se encontrar óleo sobre a correia dentada, não dirija o carro. O óleo pode fazer a correia escorregar da polia em qualquer momento, causando a ruptura instantânea do sincronismo.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Motor que não pega após parada brusca.</strong> Se o Uno parou de funcionar abruptamente em movimento e agora não dá partida, não force o motor. Chame um guincho e leve ao mecânico para avaliação com a tampa da correia aberta antes de qualquer tentativa de partida.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Custo real de uma correia ignorada.</strong> A troca preventiva custa entre R$ 350 e R$ 650 (peças e mão de obra). A reforma de cabeçote após ruptura custa entre R$ 2.500 e R$ 5.000. Em carros com valor de mercado baixo, o custo da reforma pode superar o valor do veículo.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Bomba d'água junto.</strong> Trocar a bomba d'água no mesmo serviço custa cerca de R$ 80 a R$ 150 a mais em peças. Não trocar e ter que refazer o serviço mais cedo custa R$ 200 a R$ 300 em mão de obra adicional. A conta é simples.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Exija nota fiscal das peças.</strong> Peça ao mecânico que guarde ou mostre as embalagens das peças usadas. Isso confirma a procedência e facilita qualquer reclamação de garantia dentro dos primeiros 1.000 km após a troca.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Etiqueta no capô.</strong> É o método mais simples e mais eficiente. Qualquer mecânico que abrir o capô nos anos seguintes verá a data e a quilometragem da última troca — e isso evita que o próximo proprietário, em caso de venda, ignore o prazo.</p></aside>

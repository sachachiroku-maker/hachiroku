...
entidade:
  ...
  modelo: "Haval H6"
  motor: "1.5 turbo HEV"
defeito: "solavancos e trancos na troca de 1ª para 2ª marcha em velocidade baixa"
kicker: "PROBLEMA COMUM · CÂMBIO"
intencao: "Diagnóstico"
entidadesEssenciais:
  - "câmbio DCT 7 marchas"
...
imagemAlt: "Câmbio DCT de 7 marchas do GWM Haval H6 1.5 turbo HEV com análise de solavanco na troca 1-2"
faq:
  - pergunta: "O solavanco na troca de 1ª para 2ª no Haval H6 é defeito ou comportamento normal do DCT?"
    resposta: "Um tranco leve e pontual na saída do semáforo pode ser uma característica do câmbio DCT de embreagem seca. Solavancos repetidos, intensos ou que pioram com o tempo não são normais e indicam necessidade de diagnóstico. O DCT de 7 marchas do Haval H6 é sensível à condição do software do módulo TCU e ao estado das embreagens, e esses fatores são as causas mais frequentes do problema relatado."
  - pergunta: "Por que o solavanco aparece principalmente na troca de 1ª para 2ª e não em outras marchas?"
    resposta: "A transição de 1ª para 2ª é a mais exigente de um câmbio DCT porque ocorre com velocidade muito baixa, torque do motor ainda alto e embreagem em deslizamento controlado. Qualquer desajuste na calibração do ponto de contato da embreagem ou no timing da troca torna esse momento mais abrupto. Nas marchas seguintes, a velocidade já é maior e a transição é mais suave por natureza."
  - pergunta: "O solavanco do Haval H6 piora no trânsito urbano parado?"
    resposta: "Sim. O câmbio DCT de embreagem seca tem mais dificuldade em situações de arranque frequente, como cruzamentos e filas lentas. Nesses cenários, a embreagem entra e sai do ponto de contato repetidamente, o que acelera o desgaste dos mapas de adaptação e pode aquecer as embreagens acima do ideal, intensificando os solavancos. Veículos usados principalmente em cidades grandes tendem a desenvolver o sintoma mais cedo."
  - pergunta: "A atualização de software resolve o solavanco do câmbio do Haval H6?"
    resposta: "Em boa parte dos casos sim. A GWM emite atualizações de software para o módulo TCU que recalibram os parâmetros de engate e o timing das trocas. Essas atualizações são aplicadas na concessionária e não têm custo se o veículo estiver dentro da garantia. A recomendação é verificar atualizações pendentes antes de qualquer intervenção mecânica."
  - pergunta: "O procedimento de reaprendizado de embreagem resolve o problema sem abrir o câmbio?"
    resposta: "Frequentemente sim. O módulo TCU armazena os parâmetros de adaptação das embreagens e pode perdê-los ou desviá-los com o uso. O procedimento de reaprendizado, feito com scanner compatível com a plataforma GWM, reseta esses valores e reinicia o processo de calibração. Não exige abertura do câmbio e é uma das intervenções de menor custo disponíveis."
  - pergunta: "Quanto custa resolver o solavanco no câmbio DCT do Haval H6?"
    resposta: "Atualização de software do TCU: gratuita dentro da garantia GWM de 5 anos. Procedimento de reaprendizado de embreagem via scanner: entre R$ 200 e R$ 400 de mão de obra fora da garantia. Troca do fluido DCT: entre R$ 500 e R$ 900 com fluido correto e mão de obra. Substituição de embreagem desgastada: entre R$ 2.500 e R$ 5.000 dependendo do componente e da mão de obra."
passos:
  - nome: "Confirme que o solavanco ocorre especificamente na troca 1-2"
    texto: "Antes de levar o carro ao diagnóstico, registre com precisão em que situação o solavanco aparece: somente na saída parada, entre 5 e 20 km/h, com câmbio frio ou quente, com o ar-condicionado ligado ou desligado. O Haval H6 HEV usa o motor elétrico como suporte em arranques, então verifique se o solavanco ocorre também quando o motor a combustão está ativo isoladamente. Essas informações economizam tempo no diagnóstico."
  - nome: "Verifique atualizações de software do TCU na concessionária GWM"
    texto: "A GWM disponibiliza atualizações de software para o módulo TCU que corrigem o timing de troca e os mapas de engate de embreagem. Leve o Haval H6 a uma concessionária autorizada GWM e solicite a verificação de TSBs e atualizações pendentes para o câmbio DCT do seu ano-modelo. Dentro da garantia de 5 anos ou 150.000 km, o serviço não tem custo de peças nem de mão de obra."
  - nome: "Solicite o reaprendizado de embreagem com scanner GWM"
    texto: "Se não houver atualização de software disponível ou se o problema persistir após a atualização, solicite o procedimento de reaprendizado das embreagens do DCT. Esse procedimento reseta os valores de adaptação armazenados no TCU e recalibra o ponto de contato de cada embreagem para o estado atual. Deve ser feito com o câmbio em temperatura de operação e por técnico habilitado com scanner compatível com a plataforma GWM."
  - nome: "Verifique a condição do fluido ATF do câmbio DCT"
    texto: "O câmbio DCT de 7 marchas do Haval H6 usa fluido ATF específico para transmissões de dupla embreagem. Fluido degradado ou com nível incorreto altera o comportamento das embreagens e pode intensificar os solavancos. Solicite a verificação do nível e da condição do fluido como parte do diagnóstico. Se o veículo tiver mais de 50.000 km sem troca documentada de fluido, a troca preventiva é recomendada antes de outras intervenções."
  - nome: "Avalie as embreagens se as etapas anteriores não resolverem"
    texto: "Solavancos que persistem após atualização de software, reaprendizado de embreagem e troca de fluido indicam desgaste físico das embreagens do DCT. O diagnóstico de desgaste exige desmontagem parcial da transmissão e avaliação das superfícies de fricção. Nesse cenário, a troca das embreagens é o reparo definitivo. Certifique-se de usar componentes compatíveis com a especificação GWM para o motor 1.5 turbo HEV."
pontosChave:
  - "Sintoma: solavancos e trancos repetidos na troca de 1ª para 2ª marcha em velocidade baixa, especialmente nas primeiras arrancadas do dia ou no trânsito lento."
  - "Causa: calibração desatualizada do módulo TCU ou desgaste dos mapas de adaptação das embreagens secas do DCT de 7 marchas, agravado pelo uso intenso em trânsito urbano."
  - "Ação: levar à concessionária GWM para verificação de atualizações de software do TCU e, se necessário, realizar o procedimento de reaprendizado de embreagem com scanner autorizado."
afiliados:
  - produto: "Fluido ATF para câmbio DCT"
    nota: "Fluido de transmissão DCT compatível com câmbios de dupla embreagem seca"
    busca: "fluido atf para câmbio dct"
    programa: amazon
    cta: "Ver peça recomendada"
  - produto: "Scanner OBD2 com protocolo GWM"
    nota: "Scanner de diagnóstico com suporte a módulos GWM e Haval para leitura do TCU"
    busca: "scanner obd2 com protocolo gwm"
    programa: amazon
    cta: "Ver peça recomendada"
  - produto: "Kit de limpeza e proteção de câmbio automático"
    nota: "Aditivo de proteção para câmbios automáticos e DCT em uso urbano intenso"
    busca: "kit de limpeza e proteção de câmbio automático"
    programa: amazon
    cta: "Ver peça recomendada"
fontes:
  - { titulo: "GWM Haval H6: problemas relatados por proprietários (Reclame Aqui)", url: "https://www.reclameaqui.com.br/gwm/haval-h6/" }
  - { titulo: "GWM Haval H6 HEV: avaliação completa (AutoMais TV)", url: "https://www.automaistv.com.br/avaliacao/haval-h6-hev/" }
relacionados:
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>DCT seco vs. molhado.</strong> O câmbio de dupla embreagem seca, como o DCT do Haval H6, não tem banho de óleo nas embreagens. Isso o torna mais eficiente em consumo de combustível, mas mais sensível ao desgaste em trânsito urbano intenso do que câmbios de embreagem molhada.</p></aside>
...
<aside class="telltale warning" role="note"><span aria-hidden="true">⚠️</span><p><strong>Câmbio frio agrava os solavancos.</strong> Em temperaturas abaixo de 20 graus ou nas primeiras arrancadas do dia, o solavanco na troca 1-2 do DCT do Haval H6 tende a ser mais intenso. Se o sintoma desaparece após 10 a 15 minutos de uso, a calibração do TCU para operação a frio pode ser o problema central.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Garantia de 5 anos GWM.</strong> O Haval H6 comercializado no Brasil tem garantia de 5 anos ou 150.000 km sobre trem de força, que inclui a transmissão DCT. Solavancos causados por defeito de calibração ou de componente dentro desse prazo devem ser cobertos sem custo ao proprietário.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">🔴</span><p><strong>Não ignore o solavanco progressivo.</strong> Solavancos que pioram com o tempo, especialmente se acompanhados de solavanco em outras marchas ou de dificuldade para engatar a ré, podem indicar desgaste acelerado das embreagens. Continuar usando o veículo sem diagnóstico pode agravar o dano e aumentar o custo do reparo.</p></aside>

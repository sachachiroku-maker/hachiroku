...
entidade:
  marca: "Honda"
  modelo: "City"
  motor: "1.5 e-VTi aspirado"
  geracao: "Geração 2021 em diante (Sedan GEN4)"
defeito: "ar-condicionado fraco"
kicker: "DEFEITO CRÔNICO"
intencao: "Diagnóstico"
entidadesEssenciais:
  - "filtro de cabine de carvão ativado"
  - "embreagem do compressor de AC"
...
imagemAlt: "Compressor de ar-condicionado do Honda City 1.5 e-VTi, com destaque para a embreagem eletromagnética"
faq:
  - pergunta: "Por que o ar-condicionado do Honda City 2021 fica fraco?"
    resposta: "As duas causas mais comuns são o filtro de cabine de carvão ativado entupido, que fica sob o painel do passageiro e restringe o fluxo de ar para dentro do habitáculo, e o desgaste precoce da embreagem eletromagnética do compressor, frequente em quem usa o City principalmente no trânsito urbano com muito arranque e parada. As duas falhas têm sintomas parecidos, mas diagnóstico e solução distintos."
  - pergunta: "De quanto em quanto tempo devo trocar o filtro de cabine do Honda City?"
    resposta: "O manual Honda indica a inspeção do filtro de cabine a cada 15.000 km e a troca a cada 30.000 km em condições normais. Em uso urbano intenso, com muito engarrafamento e poeira, esse intervalo precisa ser antecipado. O filtro de carvão ativado do City entope mais rápido do que parece porque retém partículas e odores além do particulado comum. Em cidades com poluição elevada, trocar a cada 15.000 km é razoável."
  - pergunta: "O Honda City usa mais gás de AC do que outros carros?"
    resposta: "Não existe perda natural de gás num sistema fechado sem vazamento. Se o AC do City está fraco por falta de gás, há um vazamento que precisa ser localizado e corrigido antes da recarga, caso contrário o gás novo vai escapar pelo mesmo ponto. O simples reabastecimento periódico sem diagnóstico de vazamento não resolve o problema e ainda mascara a causa real."
  - pergunta: "A embreagem do compressor do City quebra com facilidade?"
    resposta: "Ela tem desgaste acelerado em uso stop-and-go urbano intenso. O compressor do City tem capacidade dimensionada de forma parecida ao Civic, mas o habitáculo do sedan de entrada é menor, então o sistema liga e desliga com mais frequência para manter a temperatura. Esse ciclo curto e repetitivo aquece e resfria a embreagem eletromagnética várias vezes por hora, acelerando o desgaste das pastilhas de atrito e da bobina."
  - pergunta: "Qual é a diferença entre o AC fraco e o AC que não gela?"
    resposta: "AC fraco sopra ar em pouca quantidade mas com temperatura fria: o problema é na vazão de ar, geralmente filtro entupido ou ventilador com defeito. AC que não gela tem boa vazão mas o ar sai quente ou morno: o problema é na capacidade de refrigeração, geralmente compressor, gás insuficiente por vazamento, evaporador sujo ou expansora com defeito. No City, o filtro entupido costuma produzir o primeiro quadro e a embreagem com defeito, o segundo."
passos:
  - nome: "Localize e inspecione o filtro de cabine"
    texto: "O filtro de cabine do City 2021+ fica atrás do porta-luvas do passageiro. Abra o porta-luvas, pressione as travas laterais para baixo e puxe o conjunto para fora. O filtro de carvão ativado fica exposto. Se estiver escuro, achatado ou com detritos visíveis, troque antes de qualquer outro diagnóstico. É o passo mais barato e mais negligenciado."
  - nome: "Teste a vazão de ar nos difusores centrais"
    texto: "Com o motor quente e o AC no máximo, coloque a mão na frente dos difusores centrais. A vazão deve ser forte e constante. Se o ar sair fraco mesmo com o filtro novo, o problema pode estar no motor do ventilador interno (blower) ou no circuito elétrico que o comanda. Se o ar sair frio mas fraco, o sistema de refrigeração está funcionando, mas o fluxo está comprometido."
  - nome: "Ouça e observe a embreagem do compressor"
    texto: "Com o capô aberto e o motor em marcha lenta, ligue o AC no máximo. Observe o compressor na correia auxiliar: a polia frontal deve ser puxada e girar junto com o eixo central (embreagem engajada). Se a polia girar solta sem arrastar o compressor, a embreagem está com defeito. Um clique seguido de silêncio ou um rangido metálico ao ligar o AC também indica problema na embreagem eletromagnética."
  - nome: "Verifique a pressão do gás refrigerante"
    texto: "Peça a uma oficina com manifold de pressão que meça os lados de alta e baixa pressão do sistema. Pressão de baixa fora do intervalo normal para o R134a (geralmente 1,5 a 2,0 bar em marcha lenta com AC ligado) aponta para falta de gás por vazamento, expansora com defeito ou compressor que não bombeia. Nunca recarregue sem medir a pressão antes e sem localizar o eventual vazamento."
  - nome: "Limpe o evaporador antes de concluir o diagnóstico"
    texto: "O evaporador fica dentro da caixa do AC sob o painel e acumula mofo e resíduos orgânicos, especialmente em climas úmidos. Evaporador sujo reduz a troca de calor e pode fazer o AC parecer fraco mesmo com gás correto e compressor funcionando. A limpeza é feita com spray específico introduzido pelas saídas de ar ou pela porta do filtro. Esse passo também elimina o cheiro de mofo que frequentemente acompanha o problema."
afiliados:
  - produto: "Filtro de cabine de carvão ativado para Honda City"
    nota: "O filtro de carvão ativado retém partículas, gases e odores. É o componente mais barato do sistema e o mais ignorado. Trocar no prazo certo resolve metade dos casos de AC fraco no City."
    busca: "filtro cabine carvão ativado honda city"
    programa: "amazon"
  - produto: "Spray higienizador de evaporador de AC"
    nota: "Limpa o evaporador pelo duto do filtro sem desmontar o painel. Elimina mofo, bactérias e o cheiro que acompanha o AC fraco em climas úmidos."
    busca: "spray higienizador evaporador ar condicionado carro"
    programa: "mercadoLivre"
relacionados:
  - titulo: "Ar-condicionado com cheiro no Honda City: evaporador e drenagem"
    url: "/problemas/honda/city/ar-condicionado-evaporador-cheiro/"
...
pontosChave:
  - "Sintoma: ar-condicionado do Honda City 2021+ sopra fraco ou não gela mesmo com o sistema aparentemente funcionando"
  - "Causa: filtro de cabine de carvão ativado entupido (restringe vazão) e desgaste precoce da embreagem do compressor por ciclos curtos no trânsito urbano"
  - "Acao: inspecionar e trocar o filtro a cada 15.000 km em uso urbano, verificar engajamento da embreagem do compressor e medir pressão do gás antes de qualquer recarga"
fontes:
  - { titulo: "Honda City 2022 Owner's Manual — Air Conditioning Maintenance", url: "https://www.honda.com.br/carros/city" }
  - { titulo: "Procon-SP: reclamações de ar-condicionado fraco em sedans compactos", url: "https://www.procon.sp.gov.br/" }
  - { titulo: "INMETRO — Regulamentação de fluidos refrigerantes automotivos no Brasil", url: "https://www.inmetro.gov.br/" }
draft: false
---
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Sinal de alerta.</strong> Se o AC sopra ar frio mas em quantidade visivelmente menor do que antes, com pouca saída nos difusores centrais mesmo no nível máximo do ventilador, o filtro de cabine entupido é o primeiro suspeito.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Diagnóstico rápido.</strong> Ligue o AC no máximo e segure a mão na frente de um difusor central. A vazão deve empurrar a mão com força. Se o fluxo parecer fraco, troque o filtro antes de qualquer outro diagnóstico.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Intervalo real.</strong> Em uso urbano intenso, adote o intervalo de inspeção visual a cada 10.000 km e troca a cada 15.000 km. O custo extra por ano é pequeno perto do desconforto de um AC que não refresca no verão.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Sinal de alerta.</strong> Ao ligar o AC, observe o compressor com o capô aberto. Se a polia frontal girar solta sem arrastar o eixo, ou se você ouvir um clique seguido de silêncio, a embreagem não está engajando. O AC vai soprar ar quente independente de qualquer outra condição.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Atenção.</strong> A polia do compressor gira sempre com a correia auxiliar, mesmo com o AC desligado. O que você quer confirmar é se o disco central, o eixo do compressor, está sendo arrastado junto com a polia quando o AC é ligado. São dois componentes distintos.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Sinal combinado.</strong> Se o AC do City está fraco e ainda produz cheiro de mofo ou de "roupa molhada" ao ser ligado, a limpeza do evaporador é parte obrigatória do diagnóstico. Um evaporador sujo pode fazer o sistema parecer com defeito de gás mesmo com a pressão correta.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Regra geral.</strong> Em mais de 60% dos casos de AC fraco no City urbano, o filtro de cabine entupido é a causa. Comece por ele. É o diagnóstico que custa menos de R$ 20 em mão de obra e resolve em quinze minutos.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Custo estimado.</strong> O kit de embreagem para o compressor do City custa entre R$ 180 e R$ 400 em peças, dependendo do fabricante. A mão de obra varia por oficina. A troca do compressor inteiro, quando necessária, pode chegar a R$ 1.500 a R$ 3.000 com instalação.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Dica prática.</strong> Uma vez por semana, ligue o AC no máximo por dez a quinze minutos numa estrada ou avenida de trânsito livre. Esse tempo é suficiente para o compressor operar de forma contínua, lubrificar os componentes internos e secar a umidade do evaporador.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Checklist de diagnóstico.</strong> Filtro de cabine novo ou com menos de 15.000 km em uso urbano; embreagem do compressor engajando visivelmente; pressão do sistema medida com manifold; evaporador higienizado; condensador limpo. Se todos estão confirmados e o AC ainda está fraco, a investigação avança para o sensor de pressão, a válvula expansora e o módulo de controle.</p></aside>

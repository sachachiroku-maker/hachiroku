...
entidade:
  marca: "Hyundai"
  modelo: "Creta"
  motor: "1.0 T-GDI / 2.0 MPFi"
  geracao: "2ª geração (2022+)"
defeito: "Ar-condicionado fraco ou sem refrigeração adequada"
...
imagemAlt: "Diagnóstico de ar-condicionado fraco no Hyundai Creta 2ª geração — Hachiroku"
faq:
  - pergunta: "Por que o ar-condicionado do Creta 1.0 T-GDI refresca menos do que o do 2.0?"
    resposta: "O Creta 1.0 T-GDI usa um compressor de menor cilindrada, dimensionado para o motor de três cilindros. Em dias de calor extremo ou com o carro lotado, esse compressor trabalha no limite da capacidade, o que reduz a eficiência de refrigeração na comparação com o motor 2.0, que usa um compressor maior."
  - pergunta: "Com que frequência devo trocar o filtro de cabine do Creta 2ª geração?"
    resposta: "A Hyundai recomenda a troca a cada 15.000 km ou 12 meses, o que ocorrer primeiro. Em cidades com alto índice de poluição ou em regiões com muita terra/poeira, o intervalo ideal cai para 10.000 km. O filtro saturado é uma das causas mais comuns de ar fraco relatada pelos proprietários."
  - pergunta: "O condensador do Creta pode entupir e causar ar fraco?"
    resposta: "Sim. O condensador fica posicionado à frente do radiador e acumula insetos, sementes, pêlos e resíduos do trânsito. Quando as aletas ficam obstruídas, a troca de calor fica prejudicada e a pressão do sistema sobe além do normal, forçando o compressor a ciclar mais curto e reduzindo o poder de resfriamento."
  - pergunta: "O sensor NTC de temperatura da cabine influencia o ar-condicionado fraco?"
    resposta: "Sim. O NTC (sensor de temperatura interior) envia a leitura da temperatura da cabine para o módulo de climatização automática. Se o sensor estiver com leitura errada — por sujeira no aspirador ou defeito no termistor — o sistema pode entender que a cabine já está fria e reduzir a rotação do compressor prematuramente."
  - pergunta: "Falta de gás refrigerante é sempre a causa do ar fraco no Creta?"
    resposta: "Não necessariamente. A falta de gás é uma das causas, mas filtro entupido, condensador sujo, correia de acionamento com folga, sensor NTC defeituoso e válvula de expansão com problema produzem sintomas idênticos. Verificar o gás primeiro sem examinar as outras possibilidades pode mascarar o defeito real."
passos:
  - nome: "Verificar o filtro de cabine"
    texto: "Localize o filtro de cabine atrás do porta-luvas do lado do passageiro. Remova o painel, puxe o filtro e inspecione visualmente. Um filtro cinza-escuro, com crostas de poeira ou odor de mofo indica saturação. Troque por um filtro de carvão ativado compatível com o Creta 2ª geração antes de continuar o diagnóstico."
  - nome: "Inspecionar o condensador visualmente"
    texto: "Com o carro frio e desligado, olhe pelas grades dianteiras (ou retire o para-choque, se necessário) e observe as aletas do condensador. Use uma lanterna para identificar acúmulo de insetos, terra ou detritos. Se houver obstrução visível, limpe com lavagem a baixa pressão de fora para dentro — nunca com jato direto de alta pressão."
  - nome: "Medir as pressões do sistema de A/C"
    texto: "Com manômetro de A/C (manifold gauge), conecte ao lado de baixa pressão (azul) e ao lado de alta pressão (vermelho). Com o motor em marcha lenta e A/C no máximo, verifique os valores: o lado baixo deve ficar entre 1,5 e 2,0 bar e o lado alto entre 12 e 18 bar. Pressões fora dessa faixa indicam falta de gás, sobrecarga ou válvula de expansão com defeito."
  - nome: "Testar o sensor NTC de temperatura da cabine"
    texto: "O sensor NTC fica no painel central, geralmente próximo ao visor do climatizador, em um pequeno aspirador ventilado. Use multímetro no modo ohmímetro: a resistência típica é de cerca de 10 kOhm a 25°C e diminui conforme a temperatura sobe. Leitura fora da curva padrão indica termistor com deriva — troque o sensor antes de ajustar o sistema."
  - nome: "Avaliar a correia e embreagem do compressor"
    texto: "Com o motor ligado e o A/C acionado, observe a embreagem do compressor: o disco dianteiro deve girar solidário à polia quando o A/C está ativo. Se patinar, vibrar ou se a correia mostrar desgaste nas bordas, o acionamento mecânico está comprometido. Verifique também a tensão da correia com o tensionador — correia frouxa faz o compressor escorregar sob carga."
afiliados:
  - produto: "Filtro de cabine carvão ativado Hyundai Creta 2ª geração"
    nota: "Filtro de carvão ativado compatível com o Creta 2022+. Troca a cada 15.000 km ou 12 meses."
    busca: "filtro cabine carvão ativado Hyundai Creta 2022"
    programa: "amazon"
    cta: "Ver produto"
  - produto: "Manômetro manifold para ar-condicionado automotivo"
    nota: "Ferramenta essencial para medir as pressões do sistema de A/C e confirmar se há falta de gás ou sobrecarga."
    busca: "manometro manifold ar condicionado automotivo"
...
pontosChave:
  ...
  - "Acao: inspecionar filtro e condensador antes de abrir o circuito de gás; medir pressões com manifold gauge antes de recarregar."
  - "Atencao: o compressor do 1.0 T-GDI trabalha no limite em dias de calor acima de 35°C com o veículo carregado — não confundir com defeito; o sistema funciona dentro do projeto."
fontes:
  - { titulo: "Hyundai Creta 2ª Geração — Manual do Proprietário (2022)", url: "https://www.hyundai.com.br/owners/manual" }
  - { titulo: "INMETRO — Eficiência de Sistemas de Climatização Veicular", url: "https://www.inmetro.gov.br" }
  - { titulo: "SAE International — Automotive Air Conditioning Systems Overview", url: "https://www.sae.org/publications/technical-papers" }
draft: false
---
...
<aside class="telltale" role="note"><span aria-hidden="true">⚠️</span><p><strong>Atenção.</strong> O compressor do Creta 1.0 T-GDI é menor do que o do 2.0 MPFi. Isso é projeto, não defeito. Em dias de calor extremo, o motor de três cilindros aciona um compressor de menor cilindrada, e a capacidade de refrigeração fica aquém do motor 2.0 nas mesmas condições. Se o seu Creta é o 1.0 e o ar "não refresca como deveria" em pleno agosto com 42°C, considere que o sistema pode estar funcionando dentro do esperado pelo projeto.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Atenção crítica.</strong> Não substitua o filtro de carvão ativado por um filtro de papel simples para reduzir custo. O sistema de climatização do Creta foi calibrado considerando a resistência específica do filtro de carvão ativado. Um filtro inadequado pode até melhorar o fluxo de ar imediatamente, mas remove a filtragem de gases e pode enganar o sensor de qualidade do ar do sistema automático.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Como checar.</strong> Com o carro frio e desligado, use uma lanterna e olhe pelas frestas da grade dianteira. Se você ver uma camada escura nas aletas do condensador, já é motivo de limpeza. Em oficinas, isso é feito com lavagem a baixa pressão ou com soprador de ar comprimido, sempre de dentro para fora para não dobrar as aletas.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Teste simples.</strong> Com o climatizador automático ligado e a temperatura alvo programada, observe o display: se o sistema estabilizar rápido demais (em menos de 5 minutos com o carro ainda quente) e o compressor desligar enquanto o habitáculo ainda está claramente morno, o sensor NTC é um suspeito forte.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Nunca recalibrar o sistema sem localizar o vazamento primeiro.</strong> Se o Creta ficou sem gás com menos de três anos de uso, o vazamento precisa ser localizado com gás UV ou detector eletrônico antes da recarga. Recarregar sem corrigir desperdiça gás, cria custo recorrente e pode indicar um problema maior no evaporador.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Verificação rápida.</strong> Com o motor ligado e o A/C ativado, olhe para a polia do compressor. Quando o A/C está em operação, o disco frontal deve girar junto com a polia. Se você ver o disco parado enquanto a polia gira, ou vice-versa, a embreagem está com problema.</p></aside>
...
<aside class="telltale" role="note"><span aria-hidden="true">⚠️</span><p><strong>Comparação entre versões.</strong> Proprietários que trocaram de um Creta 2.0 para o 1.0 T-GDI relatam o A/C "fraco" como uma das primeiras percepções. Na prática, o 1.0 tem uma capacidade de refrigeração ligeiramente menor em condições extremas. Antes de diagnosticar como defeito, compare o comportamento do seu carro com outro Creta 1.0 T-GDI nas mesmas condições.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Dica de operação.</strong> Antes de acionar o A/C em um carro que ficou parado ao sol, abra as janelas por um a dois minutos para eliminar o ar quente represado. Isso reduz o tempo de resposta do sistema e alivia o estresse no compressor no momento do acionamento, especialmente no 1.0 T-GDI.</p></aside>

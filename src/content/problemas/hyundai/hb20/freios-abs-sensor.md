...
entidade:
  ...
  modelo: "HB20"
  motor: "1.0 / 1.6"
  geracao: "1ª e 2ª geração (2012 em diante)"
defeito: "falha no sensor de ABS"
...
faq:
  ...
  - pergunta: "Quanto custa trocar o sensor de ABS do HB20?"
...
passos:
  - nome: "Confirme se a luz permanece acesa ou apaga nos primeiros segundos"
    texto: "Ligue o carro e observe o painel. A luz de ABS (dois triângulos ou a sigla ABS) acende sempre com a ignição como parte do autoteste e deve apagar em 2 a 3 segundos. Se permanecer acesa depois disso, há uma falha registrada no módulo. Se acende enquanto dirige e não havia antes, o módulo detectou falha durante a marcha."
  - nome: "Observe se o ABS dispara em frenagem normal"
    texto: "Em frenagem suave em rua seca, o ABS não deve atuar. Sentir o pedal pulsando ou vibrar em situações onde normalmente não pulsaria indica que o módulo está recebendo leitura incorreta de velocidade de uma roda e ativando o sistema por engano. Isso quase sempre aponta para sensor com sujeira ou anel fônico danificado."
  - nome: "Conecte um scanner com acesso ao modulo ABS"
    texto: "Um scanner básico de OBD2 pode não mostrar nada, porque os códigos de ABS ficam no módulo de chassis (protocolo C). Use um scanner com suporte a ABS, limpe os códigos e anote os que voltam com o carro em movimento por 2 a 3 km. O código indica qual sensor (dianteiro esquerdo, direito, traseiro) está gerando a falha."
  - nome: "Inspecione o sensor e o anel fonico com o carro elevado"
    texto: "Com a roda removida, localize o sensor na manga de eixo, próximo ao disco. Verifique visualmente se há lama compactada, ferrugem ou impacto na ponta. Gire o cubo da roda manualmente e observe o anel fônico (a roda dentada perto do sensor): dentes partidos, corroídos ou irregulares causam leitura falsa mesmo com o sensor bom."
  - nome: "Substitua o sensor ou o anel fonico conforme o diagnostico"
    texto: "Se o sensor estiver sujo, limpe com pano seco e ar comprimido, reinstale e refaça o teste. Se a leitura continuar incorreta no scanner ou se o sensor estiver fisicamente danificado, troque. Se o anel fônico tiver dentes quebrados, substitua o cubo de roda ou o semieixo conforme a configuração do modelo."
pontosChave:
  - "A luz de ABS que permanece acesa depois dos primeiros segundos indica falha registrada no modulo; o ABS fica desativado e a frenagem de emergencia perde assistencia antibloquei."
  - "A causa mais comum no HB20 e sensor sujo com lama ou po de freio, que interfere na leitura do anel fonico; a segunda causa e anel fonico com dente corroido ou quebrado."
  - "O diagnostico correto exige scanner com acesso ao modulo de chassis (protocolo C); scanners basicos de OBD2 nao mostram os codigos do ABS."
  - "Sensor limpo ou trocado resolve a maioria dos casos; anel fonico danificado exige substituicao do cubo ou semieixo."
fontes:
  - { titulo: "Quando acende a luz do ABS no HB20 (MAX Turbos)", url: "https://maxturbos.com.br/quando-acende-a-luz-do-abs-no-hb20/" }
  - { titulo: "Hyundai HB20 Clube - Luz ABS acesa (HB20 Clube)", url: "https://hb20sclube.com.br/viewtopic.php?f=22&t=15763" }
  - { titulo: "Hyundai HB20 - Sistema de freios anti-bloqueio ABS (Bautoportu)", url: "https://www.bautoportu.com/hyundai_hb20-822/sistema_de_freios_anti_bloqueio_abs_se_equipado_-1020.html" }
draft: false
---

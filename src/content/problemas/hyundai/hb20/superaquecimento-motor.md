...
entidade:
  marca: "Hyundai"
  modelo: "HB20"
  motor: "1.0 12V Kappa / 1.0T Turbo"
  geracao: "2012 em diante"
...
imagemAlt: "Badge Hachiroku sobre diagnóstico de superaquecimento no Hyundai HB20 motor 1.0"
faq:
  - pergunta: "Por que o HB20 superaquece com tanta frequência?"
    resposta: "O radiador do HB20 é compacto em relação ao volume de calor gerado, especialmente na versão turbo. Em trânsito lento ou com sistema de arrefecimento com qualquer falha (mangueira, termostato ou bomba), a temperatura escapa do limite rapidamente."
  - pergunta: "Posso continuar dirigindo com o ponteiro de temperatura no máximo?"
    resposta: "Não. Desligar o motor imediatamente é obrigatório. Continuar dirigindo com o motor superaquecido pode deformar o cabeçote, fundir juntas e causar dano irreversível ao bloco, elevando o custo de reparo em dezenas de vezes."
  - pergunta: "Com que frequência devo trocar o fluido de arrefecimento do HB20?"
    resposta: "A Hyundai recomenda a troca do fluido de arrefecimento a cada 40.000 km ou 2 anos, o que ocorrer primeiro. Fluido degradado perde capacidade de inibir corrosão e prejudica a eficiência da troca de calor."
  - pergunta: "O termostato do HB20 tem tendência a falhar?"
    resposta: "Sim. O termostato do motor Kappa 1.0 é uma peça consumível com vida útil inferior a de motores de maior cilindrada. Falha travado em fechado (motor ferve) ou aberto (motor não aquece, perde potência e aumenta consumo)."
  - pergunta: "A versão turbo superaquece mais do que a 1.0 simples?"
    resposta: "A versão 1.0T Turbo produz mais calor e possui intercooler integrado ao sistema. Qualquer obstrução no circuito de resfriamento do intercooler agrava o superaquecimento e pode danificar o turbocompressor além do motor."
passos:
  - nome: "Checar o nível do fluido de arrefecimento com motor frio"
    texto: "Com o motor completamente frio, abra o reservatório de expansão (vasilha translúcida próxima ao radiador) e verifique se o nível está entre MIN e MAX. Nunca abra a tampa do radiador com o motor quente."
  - nome: "Inspecionar mangueiras e conexões"
    texto: "Aperte levemente cada mangueira com a mão (motor frio). Mangueiras moles, ressecadas, com trincas ou manchas úmidas ao redor das abraçadeiras indicam vazamento iminente ou em curso."
  - nome: "Verificar o funcionamento do eletroventilador"
    texto: "Ligue o ar-condicionado em marcha lenta. O eletroventilador traseiro do radiador deve acionar em poucos segundos. Se não girar, o motor pode superaquecer em trânsito parado mesmo sem qualquer falha mecânica."
  - nome: "Testar o termostato"
    texto: "Com o motor frio, observe o tempo que a mangueira superior do radiador leva para esquentar após a partida. O ideal é 3 a 5 minutos. Se esquentar imediatamente, o termostato pode estar travado aberto. Se o motor ferve antes de a mangueira aquecer, está travado fechado."
  - nome: "Inspecionar a bomba d'água"
    texto: "Com o motor frio, balanceie levemente a polia da bomba d'água. Folga ou ruído indica rolamento desgastado. Vazamento pela bucha central (orifício de drenagem) confirma falha do retentor e exige troca imediata da bomba."
afiliados:
  - produto: "Fluido de arrefecimento concentrado Hyundai compatível"
    nota: "Use sempre fluido OAT ou HOAT conforme recomendação do manual. Jamais misture fluidos de cores diferentes."
    busca: "fluido arrefecimento Hyundai HB20 concentrado"
    programa: "amazon"
  - produto: "Termostato motor 1.0 HB20 Kappa"
    nota: "Prefira peças de fabricantes com certificação OEM. Termostatos genéricos sem procedência têm vida útil muito reduzida."
    busca: "termostato HB20 1.0 Kappa"
...
pontosChave:
  ...
  - "Acao: desligar o motor imediatamente, nunca abrir o radiador quente, levar ao mecânico antes de religar"
fontes:
  - { titulo: "Manual do Proprietário Hyundai HB20 2020", url: "https://www.hyundai.com.br/content/dam/hyundai/br/pt/models/hb20/manual-proprietario.pdf" }
  - { titulo: "Hyundai Global - Engine Cooling System Technical Bulletin", url: "https://www.hyundai.com" }
draft: false
---
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Nunca ignore o ponteiro.</strong> Um motor que atinge temperatura crítica por menos de dois minutos já pode ter a junta do cabeçote comprometida. O reparo sai entre R$ 1.800 e R$ 4.500 dependendo da extensão do dano.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Atenção ao vapor branco pelo escapamento.</strong> Se o vapor branco sair pelo tubo de escape, especialmente na partida a frio com persistência, pode indicar junta do cabeçote comprometida, ou seja, fluido entrando na câmara de combustão. Esse é um estágio mais grave.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Troca preventiva.</strong> Em revisões após 80.000 km, peça ao mecânico para incluir a inspeção visual e tátil de todas as mangueiras. O custo de troca preventiva é muito menor que o reboque e o reparo de cabeçote.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Não adie a troca da bomba.</strong> Se a bomba travar completamente enquanto o motor está em operação, o superaquecimento é imediato e severo. Em motores que usam a mesma correia para acionar a bomba e o comando de válvulas, o travamento pode causar ruptura da correia e interferência de válvulas.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Tempo de resfriamento após uso.** Após uma viagem longa ou uso em subidas com o turbo acionado, deixe o motor funcionar em marcha lenta por 2 a 3 minutos antes de desligar. Isso permite que o fluido continue circulando e resfriando o turbo, evitando o cozimento do óleo interno.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Nunca complete com água pura.</strong> Em emergência, água destilada pode ser usada temporariamente, mas água comum contém minerais que aceleram a corrosão e formam depósitos. Assim que possível, drene e reponha com a mistura correta de fluido mais água destilada.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Guincho é mais barato que motor.</strong> O custo de um guincho está entre R$ 150 e R$ 400. A troca de cabeçote ou retífica do motor parte de R$ 2.500. A decisão matemática é simples.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Guarde os comprovantes de revisão.</strong> Em caso de garantia ou revisão em concessionária, o histórico de manutenção comprova que as trocas foram feitas no prazo correto, o que pode evitar disputas sobre cobertura de defeitos.</p></aside>

...
imagemAlt: "Badge Hachiroku com diagnóstico de ar-condicionado fraco no Hyundai Santa Fe 3.5 V6"
faq:
  - pergunta: "Por que o ar-condicionado do Santa Fe 3.5 V6 fica fraco com o carro cheio?"
    resposta: "Com 7 passageiros e forte incidência solar, a carga térmica na cabine quase dobra. O sistema tem capacidade para isso, mas qualquer restrição no condensador ou queda de carga de gás amplifica o problema exponencialmente."
  - pergunta: "Qual gás refrigerante o Santa Fe 3.5 usa?"
    resposta: "O Santa Fe 3.5 V6 das gerações DM e TM utiliza R134a. A carga nominal fica entre 650 g e 750 g dependendo da versão com ou sem evaporador traseiro."
  - pergunta: "O condensador do Santa Fe entope com frequência?"
    resposta: "Sim. A grade dianteira do Santa Fe é relativamente fechada e o condensador fica diretamente exposto a insetos e detritos. Em climas quentes e em estradas de terra, o entupimento parcial é uma das causas mais comuns de perda de eficiência."
  - pergunta: "O compressor do Santa Fe 3.5 V6 é confiável?"
    resposta: "O compressor Sanden ou Halla original é bem dimensionado para o motor 3.5 V6. O ponto fraco costuma ser a embreagem magnética, que sofre desgaste em ciclos frequentes de liga/desliga em tráfego urbano intenso."
  - pergunta: "Posso recarregar o gás do Santa Fe em qualquer oficina?"
    resposta: "Tecnicamente sim, mas exija que a oficina faça vacuômetro antes da recarga e meça pressão nas linhas de alta e baixa. Simplesmente adicionar gás sem verificar vazamento é dinheiro perdido em poucos meses."
passos:
  - nome: "Inspecionar e limpar o condensador"
    texto: "Com o motor frio, remova a grade dianteira inferior e use um borrifador de água em pressão baixa para lavar as aletas do condensador de fora para dentro. Insetos, lama e pelos de animal bloqueiam a passagem de ar e são a causa número 1 de A/C fraco no Santa Fe."
  - nome: "Trocar o filtro de cabine"
    texto: "O filtro de cabine do Santa Fe fica atrás do porta-luvas no lado do passageiro. Um filtro saturado reduz drasticamente a vazão de ar pelo evaporador. A troca é recomendada a cada 15.000 km ou 12 meses, o que ocorrer primeiro."
  - nome: "Medir pressão do sistema com manifold"
    texto: "Conecte o manifold nas saídas de alta e baixa pressão com o motor em 1.500 rpm e A/C no máximo. Baixa em torno de 30-40 PSI e alta entre 180-220 PSI indica carga adequada de R134a. Valores fora dessa faixa apontam para sub ou sobrecarga de gás."
  - nome: "Verificar embreagem do compressor"
    texto: "Com o A/C ligado, observe se o disco da embreagem magnética engaja e permanece travado. Ciclos rápidos de liga/desliga (curtos demais) indicam pressostato atuando por baixa pressão ou embreagem com folga excessiva acima de 0,5 mm."
  - nome: "Inspecionar válvula de expansão e evaporador traseiro"
    texto: "Se as versões com evaporador traseiro apresentam ar quente apenas no segundo fileira, a válvula de expansão traseira ou o evaporador com leve vazamento costumam ser os culpados. Use lâmpada UV com corante para rastrear o ponto de fuga."
afiliados:
  - produto: "Filtro de cabine para Hyundai Santa Fe"
    nota: "Troca obrigatória a cada 15.000 km. Modelo com camada de carvão ativado é preferível em cidades com poluição alta."
    busca: "filtro cabine Hyundai Santa Fe"
    programa: "amazon"
    cta: "Ver produto"
  - produto: "Kit manifold para ar-condicionado automotivo"
    nota: "Ferramenta essencial para medir pressão de alta e baixa e diagnosticar carga de gás antes de qualquer recarga."
    busca: "manifold ar condicionado automotivo R134a"
...
pontosChave:
  ...
  - "Acao: limpar condensador, trocar filtro de cabine, medir pressão com manifold e inspecionar embreagem antes de recarregar gás"
  - "Atencao: versões com evaporador traseiro têm circuito independente; ar quente apenas na segunda fileira aponta para problema exclusivo no circuito traseiro"
fontes:
  - { titulo: "Hyundai Santa Fe SM (DM) 2013-2018 Service Manual - HVAC System", url: "https://www.hyundaiusa.com/us/en/site-tools/owner-resources/shop-manuals.html" }
  - { titulo: "R134a System Pressure-Temperature Chart - ASHRAE", url: "https://www.ashrae.org/technical-resources/free-resources" }
  - { titulo: "PRONAR - Regulamentação de Gases Refrigerantes Automotivos Brasil", url: "https://www.ibama.gov.br/quimicos-e-biologicos/substancias-quimicas/gases-refrigerantes" }
draft: false
---
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Sinal de alerta.</strong> A/C que era eficiente e foi perdendo capacidade aos poucos, ao longo de meses, quase sempre indica condensador progressivamente entupido. O problema piora no verão porque o calor ambiente já é mais alto e a margem de eficiência do condensador cai ao mesmo tempo.</p></aside>
...
<aside class="telltale" role="note"><span aria-hidden="true">⚠️</span><p><strong>Atenção.</strong> Um filtro de cabine saturado não reduz o resfriamento do gás refrigerante, mas diminui drasticamente a quantidade de ar que passa pelo evaporador. O resultado prático é ar morno e vazão baixa, mesmo com o sistema de refrigeração funcionando bem.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Referência técnica.</strong> Pressão de baixa muito abaixo de 25 PSI com alta também baixa indica falta de gás. Pressão de baixa acima de 50 PSI com alta acima de 280 PSI indica sobrecarga ou condensador sem trocar calor adequadamente. Cada cenário tem uma solução diferente.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Sinal de alerta.</strong> Se o A/C foi recarregado há menos de 12 meses e já está fraco de novo, existe vazamento ativo. Recarregar mais uma vez sem localizar e corrigir a fuga é jogar dinheiro fora.</p></aside>
...
<aside class="telltale" role="note"><span aria-hidden="true">⚠️</span><p><strong>Atenção.</strong> A folga ideal entre o disco e o rotor da embreagem magnética é de 0,3 mm a 0,5 mm. Quando essa folga ultrapassa 0,6 mm, a embreagem começa a escorregar no engajamento, reduz o trabalho efetivo do compressor e gera calor adicional. O ajuste ou troca da embreagem custa muito menos que um compressor novo.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Informação técnica.</strong> O circuito traseiro do Santa Fe compartilha o mesmo compressor e a mesma carga de gás do circuito dianteiro. O que diferencia os dois é a válvula de expansão traseira, que regula a entrada de fluido refrigerante no evaporador da segunda fileira. Uma válvula travada ou com entulho interno interrompe o fluxo para o traseiro sem afetar o dianteiro.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Referência de saúde do sistema.</strong> Saída de ar entre 6 e 10 graus Celsius indica sistema funcionando bem. Entre 10 e 14 graus indica perda moderada de eficiência (verifique condensador e filtro de cabine). Acima de 16 graus indica problema significativo que exige diagnóstico com manifold e análise de carga de gás.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Solução complementar.</strong> Películas de controle solar com rejeição de calor acima de 60% reduzem significativamente a carga térmica dentro da cabine e permitem que o A/C atinja temperatura confortável mais rápido, mesmo em dias de sol intenso. Não substituem a manutenção, mas complementam o resultado.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Boa prática.</strong> Ligar o A/C por pelo menos 10 minutos por semana, mesmo no inverno, é uma prática recomendada pelos fabricantes de compressores. O óleo lubrificante circula junto com o gás refrigerante. Se o compressor ficar parado por meses, o óleo escoa para as partes mais baixas e o compressor arranca a seco no próximo uso.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Alerta de custo desnecessário.</strong> Muitas trocas de compressor no Santa Fe são realizadas sem que o compressor esteja com defeito real. O diagnóstico correto com manifold e inspeção da embreagem evita um gasto de R$ 1.200 a R$ 2.500 que não vai resolver o problema.</p></aside>

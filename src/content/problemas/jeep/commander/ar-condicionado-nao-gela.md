...
entidade:
  ...
  geracao: "1ª geração brasileira (2022 em diante)"
defeito: "ar-condicionado fraco, demora a gelar ou para de funcionar"
kicker: "DEFEITO CRÔNICO"
intencao: "Diagnóstico"
entidadesEssenciais:
  - "ar-condicionado Jeep Commander"
  - "refrigerante R1234yf"
  - "compressor de capacidade variável"
  - "clima dual zone"
  - "AC traseiro Commander"
  - "condensador entupido"
  - "atuador de mistura HVAC"
  - "recarga de gás R1234yf"
  - "Stellantis Brasil"
...
imagemAlt: "Ar-condicionado fraco no Jeep Commander 2022: diagnóstico e causas do sistema R1234yf"
faq:
  - pergunta: "Por que o ar-condicionado do Jeep Commander demora tanto para gelar?"
    resposta: "O Commander 2022+ usa o refrigerante R1234yf, que tem capacidade de troca de calor ligeiramente inferior ao antigo R134a em determinadas condições de alta temperatura. Além disso, o compressor de capacidade variável pode ficar operando em regime reduzido por falha eletrônica, entregando frio insuficiente sem desligar completamente. A combinação desses dois fatores é a principal causa de reclamações de AC 'que gela pouco'."
  - pergunta: "Posso recarregar o Commander com R134a em vez de R1234yf para economizar?"
    resposta: "Não. Os sistemas são incompatíveis. O R134a opera em pressões diferentes, tem óleo lubrificante distinto e os vedantes internos do compressor do Commander não foram projetados para o R134a. Misturar ou substituir o refrigerante pode danificar o compressor, deteriorar as vedações e contaminar o circuito inteiro. O custo do reparo posterior é muito maior do que a diferença de preço entre os refrigerantes."
  - pergunta: "O ar-condicionado traseiro do Commander pode parar de funcionar independentemente do dianteiro?"
    resposta: "Sim. O sistema de AC traseiro nas versões Limited e Overland tem uma serpentina evaporadora separada, localizada no teto do veículo. Essa serpentina pode entupir com poeira, mofo e resíduos de drenagem bloqueada, fazendo a fila de trás sentir calor mesmo com o AC dianteiro gelando normalmente. O diagnóstico e a limpeza da serpentina traseira devem ser feitos por um técnico de AC automotivo com acesso ao painel de teto."
  - pergunta: "O que é o atuador de mistura do clima dual zone e por que ele falha?"
    resposta: "O Commander tem controle de temperatura independente para o lado do motorista e do passageiro. Cada lado tem um atuador de mistura, que é um pequeno motor elétrico acoplado a uma tampa que regula a proporção de ar quente e ar frio. Quando esse atuador falha, um lado do painel fica sempre frio ou sempre quente, independentemente do que está configurado no display. A peça em si custa entre R$ 180 e R$ 350, mas a mão de obra de acesso pode elevar o custo total."
  - pergunta: "Qual o custo de uma recarga de ar-condicionado do Jeep Commander?"
    resposta: "A recarga do Commander com R1234yf custa entre R$ 500 e R$ 900 em uma oficina equipada para esse refrigerante, incluindo evacuação, busca de vazamento por nitrogênio e recarga na quantidade exata. O preço é significativamente maior que o do R134a (R$ 200 a R$ 350) porque o R1234yf é mais caro e o equipamento de recarga é diferente. Nem toda oficina de AC tem a máquina certificada para o R1234yf."
passos:
  - nome: "Identifique em qual parte o problema ocorre"
    texto: "O primeiro passo é determinar se o AC fraco afeta apenas a parte dianteira, apenas a traseira ou todo o sistema. Ligue o AC no máximo, espere cinco minutos e sinta a temperatura nas saídas de ar dianteiras (painel) e traseiras (teto). Se o dianteiro gela e o traseiro não, o problema é na serpentina ou no circuito traseiro. Se nenhum dos dois gela bem, o problema é no circuito principal (compressor, gás ou condensador)."
  - nome: "Verifique a pressão do sistema antes de sair recarregando"
    texto: "Recarregar gás em um sistema com vazamento não resolve o problema e desperdiça dinheiro. Uma oficina com manifold para R1234yf consegue verificar a pressão do lado baixo e do lado alto do circuito com o AC ligado. Pressão fora da faixa correta (baixa demais ou alta demais) indica o tipo de problema: gás baixo por vazamento, compressor fraco ou condensador entupido. Sem essa medição, qualquer diagnóstico é chute."
  - nome: "Inspecione o condensador e a entrada de ar"
    texto: "O condensador fica na frente do radiador, atrás da grade dianteira. Em Commander usados com mais de 30.000 km, é comum acumular insetos, folhas e sujeira compactada entre as aletas do condensador e as aletas do radiador. Essa obstrução impede a dissipação de calor e derruba a eficiência do AC drasticamente. Com o carro frio e desligado, observe pela grade se as aletas do condensador estão visivelmente entupidas. Lavagem com jato de água suave (nunca pressão alta direto nas aletas) costuma resolver."
  - nome: "No dual zone, teste cada lado individualmente"
    texto: "Se um lado do painel entrega temperatura diferente do outro lado, configure o motorista para o mínimo (16°C ou LO) e o passageiro para o máximo (28°C ou HI). Aguarde dois minutos e sinta as saídas de cada lado. Se os dois lados ficarem com a mesma temperatura (ou se um não variar), o atuador de mistura daquele lado está travado ou com defeito. Anote qual lado apresenta o problema antes de ir à oficina."
  - nome: "Exija certificação para trabalhar com R1234yf"
    texto: "O R1234yf é um refrigerante ligeiramente inflamável (classificação A2L) e requer equipamento de recarga certificado e técnico treinado. Ao buscar uma oficina para recarga ou diagnóstico do AC do Commander, pergunte diretamente se eles têm máquina de recuperação e recarga para R1234yf. Oficinas que trabalham só com R134a não estão preparadas para o seu Commander. Aceitar a troca por R134a é um erro que pode custar caro."
afiliados:
  - produto: "Detector de vazamento de gás refrigerante automotivo"
    nota: "Útil para identificar pontos de vazamento no sistema antes de levar à oficina. Funciona com R1234yf e R134a."
    busca: "detector vazamento gas refrigerante automotivo R1234yf"
    programa: "amazon"
    cta: "Ver produto"
  - produto: "Filtro secador de ar-condicionado Jeep Commander"
    nota: "Componente que deve ser substituído sempre que o circuito for aberto para manutenção. Peça original ou equivalente certificado."
    busca: "filtro secador ar condicionado Jeep Commander 2022"
    programa: "mercadoLivre"
relacionados:
  - titulo: "Todos os problemas conhecidos do Jeep Commander"
    url: "/problemas/jeep/commander/"
  - titulo: "Ficha técnica: Jeep Commander Longitude 1.3 Turbo"
    url: "/ficha-tecnica/jeep/commander-longitude-1-3-turbo/"
pontosChave:
  - "Sintoma: AC que demora a gelar, gela pouco ou para de funcionar no Commander 2022+."
  - "Causa: sistema usa R1234yf (mais caro e menos disponível), compressor de capacidade variável com falha silenciosa, condensador entupido ou atuador de mistura do dual zone com defeito."
  - "Ação: verificar pressão do circuito com manifold antes de recarregar; inspecionar condensador; testar os dois lados do dual zone individualmente."
  - "Atenção: NUNCA substituir o R1234yf por R134a. Os sistemas são incompatíveis e a mistura danifica compressor e vedações."
fontes:
  - { titulo: "Stellantis Brasil - Informações técnicas Jeep Commander", url: "https://www.stellantis.com/pt_br" }
  - { titulo: "PROCON-SP - Reclamações Jeep Commander 2022-2024", url: "https://www.procon.sp.gov.br/" }
  - { titulo: "ANPG - Normas para refrigerante R1234yf no Brasil", url: "https://www.anpg.gov.br/" }
  - { titulo: "SAE International - R1234yf vs R134a performance comparison", url: "https://www.sae.org/publications/technical-papers/content/2013-01-0684/" }
draft: false
---
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Nunca misture R134a com R1234yf.</strong> Os dois refrigerantes operam em pressões diferentes e usam óleos lubrificantes distintos. As vedações internas do compressor do Commander não são compatíveis com R134a. Uma oficina que coloque R134a no circuito do Commander pode danificar o compressor, contaminar o filtro secador e inutilizar as mangueiras. O custo do reparo posterior supera em muito a diferença de preço entre os refrigerantes.</p></aside>
...
<aside class="telltale" role="note"><span aria-hidden="true">⚠️</span><p><strong>Falha do compressor pode ser eletrônica ou mecânica.</strong> Antes de trocar o compressor, peça para a oficina ler os códigos de falha da central de clima com scanner compatível com Stellantis (IDS, wiTECH ou similar). Uma falha no solenóide de controle de capacidade pode mimetizar defeito mecânico e a peça custa muito menos que um compressor completo.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Boa prática de prevenção.</strong> Inspecione o condensador visualmente a cada 15.000 km ou antes de viagens longas em estrada. Uma lavagem preventiva com mangueira de jardim (sem pressão) pode ser feita pelo próprio dono com o carro desligado e o capô aberto. Cinco minutos de atenção evitam perda significativa de eficiência do AC.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>O AC traseiro exige manutenção específica.</strong> A higienização da serpentina traseira e a desobstrução do dreno são procedimentos diferentes da manutenção do AC dianteiro. Nem toda oficina de AC automotivo trabalha com a unidade traseira do Commander. Procure uma oficina que tenha experiência com SUVs de sete lugares com AC traseiro ou uma concessionária Jeep.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Verifique o filtro antes de qualquer diagnóstico mais complexo.</strong> Se o AC ficou fraco de forma gradual e você não se lembra de quando trocou o filtro de cabine pela última vez, comece por ele. É o componente mais barato e de mais fácil substituição do sistema de climatização.</p></aside>
...
1. Acesse o site oficial de recalls do DENATRAN/SENATRAN: [https://www.gov.br/senatran/pt-br](https://www.gov.br/senatran/pt-br).
2. Digite o chassi (número VIN) do seu carro na consulta de recall.
3. Se houver recall, o reparo é obrigatoriamente gratuito na rede Stellantis, mesmo fora da garantia.

<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Recall aberto obriga a concessionária a reparar sem custo.</strong> Se o seu Commander tiver um recall relacionado ao sistema de AC ou ao sistema elétrico e a concessionária negar o serviço gratuito, registre uma reclamação no PROCON do seu estado. O recall é uma obrigação legal da montadora, não uma gentileza.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Exija nota fiscal do serviço de recarga.</strong> Uma recarga de R1234yf sem nota fiscal e sem registro do volume exato colocado no circuito é sinal de serviço improvisado. O circuito do Commander tem uma quantidade exata especificada pelo fabricante. Excesso de gás causa pressão alta e danos ao compressor. Falta de gás significa que você pagou por uma recarga incompleta.</p></aside>
...
1. Comece pelo filtro de cabine. É o mais barato e mais esquecido.
2. Inspecione o condensador visualmente. Sujeira visível, lave com cuidado.
3. Teste o dual zone com temperaturas opostas. Um lado que não varia é atuador.
4. Isole dianteiro e traseiro. Identifique onde o problema está concentrado.
5. Leve a uma oficina com equipamento para R1234yf. Exija nota fiscal do serviço.
6. Consulte recalls ativos antes de autorizar qualquer reparo pago.

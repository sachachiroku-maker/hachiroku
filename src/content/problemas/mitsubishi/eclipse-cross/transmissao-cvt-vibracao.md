...
seoTitle: "CVT Eclipse Cross 1.5 Turbo Vibra e Patina em"
...
entidade:
  ...
  motor: "1.5 MIVEC Turbo"
defeito: "vibração e patinação no câmbio CVT em subidas e acelerações plenas por superaquecimento do variador"
...
imagemAlt: "Emblema Hachiroku representando diagnóstico de vibração e patinação no câmbio CVT do Mitsubishi Eclipse Cross 1.5 MIVEC Turbo"
pontosChave:
  - "Sintoma: vibração perceptível no assoalho e patinação do câmbio CVT durante subidas longas e acelerações plenas, com o motor subindo de giro sem o carro acompanhar proporcionalmente."
  - "Causa: superaquecimento do variador CVT provocado por fluido Diamond ATF SP-III degradado ou pela combinação de alta carga do motor 1.5 turbo com o câmbio em temperatura elevada, levando ao escorregamento da correia nas polias."
  - "Ação: trocar o fluido CVT com Diamond ATF SP-III homologado a cada 40.000 km, evitar acelerações agressivas repetidas em subidas e, se o problema persistir com fluido em dia, instalar resfriador CVT auxiliar e levar a transmissão para inspeção interna."
faq:
  - pergunta: "Por que o câmbio CVT do Eclipse Cross vibra apenas em subidas ou na aceleração plena?"
    resposta: "Em subidas e em acelerações plenas, o motor 1.5 MIVEC Turbo entrega torque máximo ao câmbio CVT de forma contínua. Para multiplicar esse torque, as polias do variador abrem ao máximo, e a correia de aço que as une trabalha sob pressão e temperatura muito mais altas do que em pista plana. Se o fluido estiver degradado ou o câmbio já estiver quente de uso anterior, o coeficiente de atrito entre a correia e as polias cai, gerando escorregamento. Esse escorregamento é o que o motorista percebe como vibração e patinação."
  - pergunta: "O Eclipse Cross 1.5 turbo aguenta acelerações plenas frequentes sem danificar o CVT?"
    resposta: "O motor 1.5 MIVEC Turbo tem torque elevado para a categoria, o que impõe carga maior ao CVT em relação a motores aspirados de cilindrada similar. Acelerações plenas isoladas, com fluido em dia e câmbio em temperatura normal, não causam dano. O problema aparece quando as acelerações plenas se repetem em sequência, especialmente em subidas, pois o câmbio não tem tempo suficiente para dissipar o calor entre uma aceleração e a seguinte. Fluido limpo e uso progressivo do acelerador em subidas longas são os maiores aliados do CVT nesse cenário."
  - pergunta: "A patinação do câmbio CVT do Eclipse Cross pode danificar a transmissão de forma permanente?"
    resposta: "Sim, se ignorada. Cada episódio de escorregamento da correia nas polias cria desgaste microscópico nas superfícies internas do variador. Episódios isolados com fluido em dia raramente causam dano imediato. O problema crônico ocorre quando a patinação se repete com frequência, especialmente com fluido degradado: nesse caso, as polias marcam, a correia desgasta e a transmissão perde a capacidade de transmitir torque de forma eficiente, exigindo reconstrução."
  - pergunta: "Qual fluido usar no câmbio CVT do Eclipse Cross 1.5?"
    resposta: "A Mitsubishi especifica o Diamond ATF SP-III (também listado como MMCVTF em alguns mercados) para o câmbio CVT do Eclipse Cross. Nunca use fluido ATF genérico tipo Dexron III ou Mercon: esses produtos não possuem os aditivos de superfície necessários para a correia pushbelt e aumentam o escorregamento em alta temperatura, agravando exatamente o problema de vibração e patinação."
  - pergunta: "Em que quilometragem devo trocar o fluido CVT do Eclipse Cross?"
    resposta: "A recomendação prática para o câmbio CVT do Eclipse Cross é a troca do Diamond ATF SP-III a cada 40.000 km. Em uso com muitas subidas, tráfego urbano pesado ou em regiões de calor intenso, reduza esse intervalo para 30.000 km. Muitas concessionárias e oficinas generalistas omitem esse item das revisões básicas, então cabe ao proprietário monitorar o quilômetro da última troca."
  - pergunta: "O câmbio entra em modo de proteção durante a patinação?"
    resposta: "Sim. Quando a temperatura do fluido CVT ultrapassa o limite programado pela Mitsubishi, a unidade de controle da transmissão ativa o modo de proteção, que limita a potência entregue ao câmbio e pode reduzir a velocidade máxima do veículo. O motorista percebe queda brusca de desempenho, às vezes acompanhada de mensagem de alerta no painel. Se isso ocorrer, reduza a velocidade, pare em local seguro e aguarde o resfriamento por pelo menos 10 minutos antes de retomar."
  - pergunta: "Vale instalar um resfriador CVT externo no Eclipse Cross?"
    resposta: "Para proprietários que frequentam trechos com muitas subidas ou que usam o veículo em situações de alta demanda térmica com regularidade, um kit de resfriador CVT externo é a melhoria preventiva mais eficaz. O resfriador adiciona capacidade de dissipação de calor ao câmbio sem alterar o funcionamento original. O custo de instalação costuma ficar entre R$ 600 e R$ 1.200, dependendo do kit e da mão de obra, valor muito inferior ao de uma reconstrução do câmbio."
passos:
  - nome: "Identifique os sintomas com precisão"
    texto: "Anote em que condições a vibração e a patinação aparecem: apenas em subidas longas, somente em acelerações plenas do zero ao máximo, ou também em retomadas na estrada. Registre se há mensagem de falha no painel e em que quilometragem o problema começou. Quanto mais detalhado o relato, mais rápido o especialista encontra a causa real, seja fluido degradado, desgaste interno ou falha no sensor de temperatura do câmbio."
  - nome: "Verifique o estado e o intervalo do fluido Diamond ATF SP-III"
    texto: "Localize o bujão de verificação lateral do câmbio CVT com o veículo em temperatura de trabalho. O Diamond ATF SP-III original é vermelho-âmbar claro e translúcido. Fluido escuro, com cheiro de queimado ou com partículas metálicas em suspensão indica degradação severa. Se a última troca foi há mais de 40.000 km, ou se não há registro de troca alguma, trate a troca do fluido como primeira prioridade antes de qualquer outro diagnóstico."
  - nome: "Troque o fluido pelo Diamond ATF SP-III homologado"
    texto: "Faça a drenagem e o reabastecimento completo com Mitsubishi Diamond ATF SP-III. Não use fluidos ATF genéricos nem equivalentes não certificados pela Mitsubishi: a formulação específica desse fluido é o que garante o coeficiente de atrito correto entre a correia e as polias do variador. Após a troca, rode pelo menos 200 km em uso normal antes de repetir o teste em subidas para avaliar se os sintomas cessaram."
  - nome: "Leia os códigos de falha com scanner OBD2"
    texto: "Conecte um scanner OBD2 compatível com o protocolo CAN do Eclipse Cross e registre todos os códigos ativos e pendentes ligados à transmissão. Os códigos mais associados ao superaquecimento e à patinação do CVT são P0868 (pressão de fluido CVT baixa), P0740 (embreagem de bloqueio do conversor de torque) e P0720 (sensor de velocidade de saída). Esses códigos direcionam a diagnose e evitam substituição de peças desnecessárias antes de uma inspeção interna."
  - nome: "Monitore a temperatura da carcaça do câmbio em campo"
    texto: "Após a troca de fluido, refaça o percurso de subida ou de aceleração plena que gerava os sintomas e, ao parar, meça a temperatura externa da carcaça metálica do câmbio com termômetro infravermelho. Abaixo de 90 graus Celsius é operação normal. Entre 90 e 110 graus é zona de atenção. Acima de 110 graus indica câmbio sobrecarregado termicamente mesmo com fluido correto: considere a instalação de resfriador externo e agende inspeção interna com especialista em transmissões CVT."
afiliados:
  - produto: "Fluido CVT Mitsubishi Diamond ATF SP-III"
    nota: "Use somente fluido homologado pela Mitsubishi. Fluidos ATF genéricos não protegem a correia pushbelt em altas temperaturas e agravam a patinação."
    busca: "fluido cvt mitsubishi diamond atf"
    programa: amazon
    cta: "Ver fluido"
  - produto: "Scanner OBD2 Bluetooth transmissão"
    nota: "Leitura de códigos de falha do câmbio CVT e monitoramento de temperatura em tempo real antes que o desgaste avance."
    busca: "scanner obd2 bluetooth transmissao cvt"
    programa: amazon
    cta: "Ver scanner"
  - produto: "Termômetro infravermelho automotivo"
    nota: "Permite medir a temperatura da carcaça do câmbio imediatamente após subidas e acelerações para confirmar superaquecimento real."
    busca: "termometro infrared caixa cambio automotivo"
    programa: amazon
    cta: "Ver termômetro"
fontes:
  - titulo: "Mitsubishi Eclipse Cross Owner's Manual - Transmission Fluid and CVT Specifications"
    url: "https://www.mitsubishi-motors.com/en/products/eclipse_cross/"
  - titulo: "NHTSA Complaints Database - Mitsubishi Eclipse Cross Power Train"
    url: "https://www.nhtsa.gov/vehicle/2022/MITSUBISHI/ECLIPSE+CROSS/SUV/AWD"
relacionados:
  - titulo: "CVT do Mitsubishi Outlander V6 superaquece em subidas e reboque"
    url: "/problemas/mitsubishi/outlander/cambio-cvt-superaquecimento/"
  - titulo: "Todos os problemas do Mitsubishi Eclipse Cross"
    url: "/problemas/mitsubishi/eclipse-cross/"
draft: false
---
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Não force em patinação.</strong> Se o câmbio entrar em patinação durante uma subida, reduza imediatamente o pedal e encontre um local seguro para parar. Forçar o acelerador com a correia escorregando acelera o desgaste das polias. Aguarde pelo menos 10 minutos com o motor em marcha lenta para o câmbio resfriar antes de continuar.</p></aside>
...
<aside class="telltale warning" role="note"><span aria-hidden="true">⚠️</span><p><strong>Modo manual em subidas.</strong> Em subidas longas com o Eclipse Cross, prefira sempre o modo D automático ao modo de trocas manuais. No modo automático, a eletrônica ajusta a relação continuamente para reduzir o esforço no variador. No modo manual, o motorista fixa a relação e pode criar condições de aquecimento acelerado sem perceber.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Fluido certo, sem substituições.</strong> Use somente o Mitsubishi Diamond ATF SP-III ou fluido com certificação equivalente aprovada explicitamente pela Mitsubishi para o câmbio CVT do Eclipse Cross. Fluidos ATF genéricos, mesmo de marcas conhecidas, não possuem a formulação de aditivos de superfície necessária para a correia pushbelt e agravam o escorregamento em alta temperatura.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Ruído metálico interno é sinal de urgência.</strong> CVT com ruído metálico interno em uso tem desgaste ativo. Cada quilômetro rodado nessa condição aumenta o custo final do reparo. Agende inspeção com especialista em transmissões imediatamente e evite acelerações bruscas até a avaliação.</p></aside>
...
| Faixa de temperatura | Interpretação |
|---|---|
| Abaixo de 90 graus Celsius | Operação normal |
| Entre 90 e 110 graus | Zona de atenção, fluido deve estar em dia |
| Acima de 110 graus | Câmbio sobrecarregado, resfriador externo indicado |

<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Calibração do termômetro.</strong> Ajuste a emissividade do termômetro infravermelho para entre 0,85 e 0,95 ao medir superfícies metálicas pintadas. Valores fora dessa faixa podem subestimar a temperatura real da carcaça.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Resultado esperado.</strong> Proprietários que instalaram o resfriador CVT auxiliar em modelos com câmbio CVT turbo em uso intenso relatam eliminação ou redução significativa dos episódios de patinação e ativação do modo de proteção, mesmo em subidas longas em dias quentes.</p></aside>
...
| Scanner OBD2 para leitura de falhas | R$ 100 a R$ 400 |
| Termômetro infravermelho para diagnose | R$ 80 a R$ 300 |
| Kit resfriador CVT externo com instalação | R$ 600 a R$ 1.200 |
| Reconstrução do variador CVT com danos | R$ 7.000 a R$ 14.000 |
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Bom hábito.</strong> Anote o quilômetro de cada troca de fluido CVT na tampa do motor ou no manual do proprietário. Em Eclipse Cross usados sem histórico de manutenção, trate a troca do Diamond ATF SP-III como primeira providência antes de qualquer uso em trechos com subidas exigentes.</p></aside>

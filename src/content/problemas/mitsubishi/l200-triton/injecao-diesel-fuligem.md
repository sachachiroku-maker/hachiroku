...
entidade:
  ...
  motor: "2.4 diesel 4N15"
defeito: "excesso de fumaça preta e fuligem pelo escapamento em acelerações por DPF saturado ou injetor com vazamento"
...
imagemAlt: "Fumaça preta no escapamento do Mitsubishi L200 Triton Sport 2.4 diesel 4N15"
pontosChave:
  - "Sintoma: fumaça preta densa e fuligem saindo pelo escapamento especialmente durante acelerações bruscas"
  - "Causa: DPF saturado incapaz de reter as partículas, ou injetor com vazamento interno que envia combustível em excesso para a câmara"
  - "Ação: fazer diagnóstico eletrônico com scanner antes de qualquer intervenção, pois os dois problemas exigem abordagens distintas"
faq:
  - pergunta: "Por que o L200 Triton 2.4 diesel solta fumaça preta no escapamento?"
    resposta: "A fumaça preta em um motor diesel indica combustão incompleta ou sobrecarga de particulados no sistema de exaustão. No 4N15 do L200 Triton, as duas causas mais comuns são o filtro de partículas DPF saturado, que não consegue mais reter a fuligem e a deixa escapar, e um injetor common rail com vazamento interno, que despeja combustível em excesso na câmara sem que todo ele seja queimado. As duas situações produzem o mesmo sintoma visual, mas exigem soluções completamente diferentes."
  - pergunta: "Como saber se a fumaça preta é causada pelo DPF ou pelo injetor?"
  ...
  - pergunta: "A fumaça preta do Triton 2.4 diesel aparece só na aceleração, isso muda o diagnóstico?"
    resposta: "Sim. Fumaça preta somente nas acelerações bruscas, com o motor se comportando normalmente em marcha lenta e em velocidade constante, aponta mais para um injetor com retorno excessivo de combustível durante a demanda máxima de carga. O DPF saturado tende a produzir fuligem contínua ou em qualquer regime de carga. De todo modo, o diagnóstico eletrônico ainda é necessário para confirmar, pois o DPF degradado pode se comportar de forma intermitente dependendo do nível de entupimento."
  - pergunta: "O injetor com vazamento do L200 Triton pode ser limpo ou precisa ser substituído?"
    resposta: "Depende do tipo e da gravidade do vazamento. Injetores com vazamento externo pelos retornos ou com sujeira nos bicos podem ser limpos e calibrados em bancada especializada, com custo entre R$ 350 e R$ 700 por peça. Injetores com desgaste interno severo no êmbolo ou na válvula de controle não respondem à limpeza e precisam ser substituídos. Peças novas para o 4N15 custam entre R$ 900 e R$ 1.800 cada, dependendo do fornecedor. O diagnóstico em bancada é obrigatório antes de decidir."
  - pergunta: "Posso continuar usando o Triton com fumaça preta enquanto marco a revisão?"
    resposta: "Por pouco tempo e com cautela. Fumaça preta contínua indica combustão ineficiente, que sobrecarrega o DPF e pode levar o motor a entrar em modo de proteção com limitação de potência. Além disso, vazamento de injetor progressivo piora rapidamente e pode causar diluição do óleo do motor com diesel, danificando mancais e bronzinas. O ideal é não ultrapassar 5 a 7 dias de uso normal após identificar o problema, especialmente se o nível de óleo estiver subindo (sinal de diluição por diesel)."
  - pergunta: "Qual o custo total de resolver fumaça preta no L200 Triton 2.4 diesel?"
    resposta: "O custo varia bastante conforme a causa. Regeneração ativa do DPF com scanner: R$ 150 a R$ 400. Limpeza e calibração de injetores em bancada: R$ 350 a R$ 700 por peça, sendo 4 cilindros no total. Substituição de injetor: R$ 900 a R$ 1.800 por peça mais mão de obra. Troca do DPF completo: R$ 4.000 a R$ 7.000. Quando os dois problemas ocorrem juntos, o orçamento pode ultrapassar R$ 5.000 facilmente, por isso o diagnóstico eletrônico antes de qualquer serviço é o passo mais importante."
passos:
  - nome: "Observar o padrão da fumaça e registrar as condições"
    texto: "Antes de ir à oficina, observe com atenção quando a fumaça aparece. Ela surge apenas nas acelerações bruscas ou também em marcha lenta? O motor perde potência junto com a fumaça? Há cheiro forte de diesel cru no escapamento? O consumo de combustível aumentou nas últimas semanas? Verifique também o nível de óleo: se ele subiu acima da marca máxima desde a última troca, há risco de diluição por diesel, o que indica injetor com vazamento grave. Registre essas informações antes de ir à oficina para ajudar o técnico a fechar o diagnóstico."
  - nome: "Fazer diagnóstico eletrônico com scanner compatível com o 4N15"
    texto: "Leve o veículo a uma concessionária Mitsubishi ou oficina com scanner que suporte o protocolo do motor 4N15 (MUT-III ou equivalente com leitura de dados ao vivo de DPF e sistema common rail). Peça os seguintes dados por escrito: percentual de saturação do DPF, códigos de falha ativos (P2002, P244A, P2463 para DPF; P0200 a P0209 para injetores), dados ao vivo de quantidade injetada por cilindro e valor de retorno de combustível por injetor. Com esses números em mãos você tem base para decidir o próximo passo sem depender apenas da opinião verbal do técnico."
  - nome: "Tratar o DPF conforme o nível de saturação"
    texto: "Se o scanner confirmar saturação do DPF como causa ou cofator do problema, o nível percentual define o tratamento. Saturação abaixo de 70%: tente primeiro a regeneração passiva na rodovia (90 km/h constantes por 30 minutos com o motor aquecido) antes de ir à oficina. Saturação entre 70% e 85%: regeneração ativa com scanner na oficina, custo entre R$ 150 e R$ 400. Saturação acima de 85%: a troca do DPF é provável. Nesse caso, exija que o reset do contador de fuligem no software do veículo seja incluído no serviço. Sem esse reset, o problema retorna antes do esperado."
  - nome: "Encaminhar os injetores para diagnóstico em bancada"
    texto: "Se o scanner indicar desequilíbrio de injeção entre cilindros, retorno excessivo de combustível em algum injetor ou códigos de falha de injetor, encaminhe as peças para teste em bancada especializada. A bancada mede a quantidade injetada em cada pulso, verifica o selamento interno e identifica o nível de desgaste. Com o laudo em mãos, decida entre limpeza e calibração (viável quando o desgaste é baixo) ou substituição (necessária quando o êmbolo ou a válvula de controle estão fora de especificação). Nunca substitua injetor sem laudo de bancada: o mesmo sintoma pode ser causado por problemas elétricos no chicote ou na ECU."
  - nome: "Verificar o nível de óleo e descartar diluição por diesel"
    texto: "Após o diagnóstico, e antes de qualquer serviço mais profundo, retire a vareta de óleo e examine o fluido. Óleo com cheiro de diesel, cor mais clara do que o normal ou nível acima da marca máxima sem que o motor tenha sido abastecido com mais óleo são sinais de diluição. Nesse caso, a troca de óleo imediata é obrigatória antes de devolver o veículo ao uso. A diluição por diesel destrói a viscosidade do óleo e pode danificar mancais e bronzinas em poucas centenas de quilômetros. A causa raiz (injetor com vazamento) precisa ser resolvida para que a diluição não retorne."
afiliados:
  - produto: "Scanner OBD2 com suporte a diesel, DPF e injetores common rail"
    nota: "leitura de dados ao vivo de injetores e DPF para diagnóstico doméstico antes de ir à oficina"
    busca: "scanner obd2 diesel DPF injetor common rail"
    programa: amazon
    cta: "Ver na Amazon"
  - produto: "Aditivo limpeza de injetores diesel common rail"
    nota: "uso preventivo no tanque a cada troca de óleo; auxilia na remoção de depósitos nos bicos dos injetores antes que causem desequilíbrio de injeção"
    busca: "aditivo limpeza injetor diesel common rail"
    programa: amazon
    cta: "Ver na Amazon"
  - produto: "Óleo motor diesel 5W-30 low SAPS compatível com DPF"
    nota: "especificação correta para motores com DPF reduz geração de cinzas e prolonga a vida útil do filtro"
    busca: "óleo motor diesel 5W-30 low SAPS DPF"
    programa: amazon
    cta: "Ver na Amazon"
fontes:
  - titulo: "Mitsubishi L200 Triton Sport - Manual do Proprietário e Informações Técnicas"
    url: "https://www.mitsubishi-motors.com.br/servicos/manuais"
  - titulo: "IBAMA - Programa PROCONVE BR6 e normas de emissões para veículos diesel"
    url: "https://www.ibama.gov.br/proconve"
relacionados:
  - titulo: "Filtro DPF entupindo no L200 Triton 2.4 diesel"
    url: "/problemas/mitsubishi/l200-triton/filtro-particulas-dpf/"
  - titulo: "Corrente do motor 4N15 no L200 Triton: desgaste e barulho"
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Não ignore.</strong> Fumaça preta contínua sobrecarrega o DPF e pode diluir o óleo do motor com diesel. O uso prolongado sem diagnóstico transforma um problema de R$ 400 em um orçamento que pode passar de R$ 5.000.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Por que os dois ocorrem juntos.</strong> Injetor com vazamento gera mais fuligem do que o motor deveria produzir, acelerando a saturação do DPF. Em muitos casos diagnosticados no 4N15, o injetor é a causa original e o DPF saturado é consequência direta. Tratar só o DPF sem verificar os injetores faz o filtro saturar novamente em tempo muito menor do que o normal.</p></aside>
...
<aside class="telltale warning" role="note"><span aria-hidden="true">⚠️</span><p><strong>Nível de óleo acima do máximo.</strong> Se a vareta mostrar óleo acima da marca máxima sem que nenhum óleo tenha sido adicionado desde a última troca, troque o óleo imediatamente e vá à oficina. A diluição com diesel destrói a viscosidade e pode danificar mancais em poucas centenas de quilômetros.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Dados que importam.</strong> Percentual de saturação do DPF, quantidade injetada por cilindro e valor de retorno de combustível por injetor. Esses três grupos de dados respondem à pergunta: é o filtro, é o injetor ou são os dois?</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Troca do DPF com causa raiz.</strong> Se o injetor com vazamento for confirmado como a causa da saturação acelerada do DPF, ele precisa ser resolvido antes ou junto com a troca do filtro. Um DPF novo com injetor defeituoso satura em tempo muito menor do que o normal.</p></aside>
...
<aside class="telltale warning" role="note"><span aria-hidden="true">⚠️</span><p><strong>Nunca substitua no escuro.</strong> O mesmo sintoma de fumaça preta e desequilíbrio de cilindros pode ser causado por problema elétrico no chicote do injetor ou falha na ECU, e não pelo injetor em si. O laudo de bancada confirma se a peça mecânica está com defeito antes de qualquer troca.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Óleo diluído mata mancais.</strong> Diesel no óleo reduz a viscosidade do lubrificante abaixo do valor mínimo necessário para proteger mancais e bronzinas. O dano começa silenciosamente e pode resultar em quebra de motor em poucas centenas de quilômetros de uso normal.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Prevenção de baixo custo.</strong> Diesel S10, óleo low SAPS e rodagem de 30 minutos a cada 400 km resolvem a maior parte dos casos de saturação prematura do DPF e reduzem a formação de depósitos nos injetores do 4N15.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Resumo de ação.</strong> Fumaça preta: diagnóstico com scanner primeiro. DPF saturado abaixo de 70%: regeneração passiva na rodovia. DPF saturado acima de 70%: regeneração ativa ou troca. Injetor com defeito: bancada antes de trocar. Óleo diluído: troca imediata após resolver a causa raiz.</p></aside>

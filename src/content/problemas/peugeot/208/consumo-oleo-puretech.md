...
entidade:
  marca: "Peugeot"
  modelo: "208"
  motor: "1.2 PureTech 3 cilindros turbo"
...
imagemAlt: "Motor 1.2 PureTech 3 cilindros turbo do Peugeot 208 com consumo excessivo de óleo"
pontosChave:
  - "Sintoma: nível de óleo cai de MAX para MIN em menos de 5.000 km, acompanhado de fumaça azulada no escapamento ao arrancar a frio."
  - "Causa: anéis de pistão com folga excessiva e retentores de válvula desgastados permitem que o óleo entre na câmara de combustão e seja queimado junto com o combustível."
  - "Ação: verificar o nível a cada 2.000 km, solicitar teste de compressão e leak-down em oficina especializada em PSA e usar somente óleo 5W-30 sintético com aprovação PSA B71 2290."
faq:
  - pergunta: "O motor 1.2 PureTech do Peugeot 208 realmente consome mais óleo que o normal?"
    resposta: "Sim. O motor 1.2 PureTech 3 cilindros turbo do 208 tem histórico documentado de consumo de óleo acima da média em comparação com outros motores de mesma cilindrada. Relatos em fóruns como PeugeotClub.com.br e registros em órgãos de defesa do consumidor apontam para consumo entre 0,5 e 1,5 litro a cada 1.000 km em parte dos exemplares, especialmente entre 40.000 e 80.000 km. A Peugeot considera normal até 0,5 litro por 1.000 km para motores turbo, mas vários proprietários relatam consumo além desse limite dentro do período de garantia."
  - pergunta: "Qual é o sinal mais fácil de perceber que meu 208 PureTech está consumindo óleo?"
    resposta: "O sinal mais direto é a queda do nível de óleo na vareta entre trocas. Se o nível cai de MAX para MIN em menos de 5.000 km, o consumo já ultrapassa o tolerado. Outros sinais visíveis: fumaça azulada ou cinzenta na saída do escapamento ao ligar o motor frio de manhã, odor de óleo queimado no habitáculo em desaceleração e velas de ignição com aspecto oleoso na ponta do eletrodo."
  - pergunta: "Por que o motor 1.2 PureTech de 3 cilindros é mais propenso ao problema?"
    resposta: "A arquitetura de 3 cilindros gera vibrações e pulsos de pressão no cárter mais intensos do que um motor de 4 cilindros de deslocamento equivalente. Esses pulsos sobrecarregam os anéis de pistão e os retentores de válvula, componentes que já trabalham sob alta pressão por conta do turbo. Além disso, o motor usa correia dentada banhada a óleo no comando de distribuição: qualquer degradação do lubrificante impacta diretamente a pressão e a qualidade da lubrificação nos pontos mais críticos do motor."
  - pergunta: "É possível resolver o consumo de óleo do PureTech sem abrir o motor?"
    resposta: "Depende da causa. Se o problema está apenas no turbocompressor com folga no eixo, a troca do turbo resolve sem abrir o bloco. Se a origem são os retentores de válvula, é necessário remover o cabeçote. Se os anéis de pistão estão com folga excessiva, exige desmontagem completa do motor. Por isso o diagnóstico preciso, via teste de compressão e leak-down, é obrigatório antes de autorizar qualquer serviço. Abrir o motor pelo motivo errado dobra o custo sem resolver o problema."
  - pergunta: "O problema tem cobertura de garantia pela Peugeot Brasil?"
    resposta: "Motores com consumo de óleo excessivo dentro do período de garantia (3 anos ou 100.000 km, o que ocorrer primeiro, para veículos novos) devem ser avaliados pela concessionária. A cobertura depende da comprovação de que o consumo excede o limite definido pela montadora e de que as trocas de óleo foram feitas dentro do prazo e com o lubrificante correto. Proprietários com histórico de manutenção documentado em concessionária têm maior chance de aprovação do reparo em garantia. Casos negados pela montadora podem ser encaminhados ao PROCON ou ao Sindipeças para mediação."
  - pergunta: "Qual óleo devo usar no Peugeot 208 1.2 PureTech para minimizar o consumo?"
    resposta: "A Peugeot especifica exclusivamente óleo sintético 5W-30 com aprovação PSA B71 2290 para o motor 1.2 PureTech. Usar lubrificantes fora dessa especificação, como 10W-40 semissintético ou mineral, compromete a lubrificação nos pontos mais sensíveis do motor de 3 cilindros turbo e pode acelerar o desgaste dos anéis e retentores. A troca deve ser feita a cada 10.000 km ou 12 meses, adotando o menor intervalo. Em uso urbano intenso com paradas e partidas frequentes, reduzir para 7.500 km é uma prática recomendada por mecânicos especializados em PSA."
  - pergunta: "Quanto custa resolver o consumo de óleo no Peugeot 208 1.2 PureTech?"
    resposta: "Os custos variam conforme a origem do problema: troca do turbocompressor com folga no eixo sai entre R$ 1.800 e R$ 3.500 (peça mais mão de obra). Retífica de cabeçote com troca dos retentores de válvula fica entre R$ 1.200 e R$ 2.500. Retífica completa do motor com troca dos anéis de pistão pode variar de R$ 4.000 a R$ 7.000. A troca por motor usado de baixa quilometragem fica entre R$ 5.000 e R$ 9.000 incluindo instalação. O diagnóstico correto antes de qualquer serviço é o que define em qual faixa de custo o proprietário vai se enquadrar."
passos:
  - nome: "Monitore o nível de óleo a cada 2.000 km"
    texto: "Com o motor frio e o carro em superfície plana, retire a vareta de nível e anote a quilometragem no momento em que o óleo está em MAX. Repita a verificação a cada 2.000 km. Se o nível cair abaixo da metade da vareta em 3.000 km, o consumo ultrapassa 0,3 litro por 1.000 km. Se cair para MIN ou abaixo em menos de 5.000 km, o consumo já está acima do limite tolerado pela Peugeot. Complete o nível com óleo 5W-30 PSA B71 2290 aprovado antes de continuar rodando."
  - nome: "Observe o escapamento nos primeiros arranques a frio"
    texto: "Nas manhãs frias ou após o carro ficar parado por mais de 6 horas, observe o escapamento nos primeiros 30 a 60 segundos de funcionamento. Uma névoa branca fina é condensação normal de água. Fumaça com tom azulado ou cinza-azulado, mais densa, com cheiro característico de óleo queimado, indica óleo sendo queimado no motor. Tire um vídeo no celular: o registro ajuda a mostrar ao mecânico e a documentar o caso para eventual acionamento de garantia."
  - nome: "Inspecione as velas de ignição"
    texto: "Com o motor frio, remova as 3 velas de ignição do PureTech. Uma vela em boas condições tem a ponta do eletrodo acinzentada ou marrom-clara. Vela com aspecto oleoso, com depósito preto gorduroso na ponta ou na rosca, ou com isolador encharcado de óleo indica consumo no cilindro correspondente. Uma vela oleosa também causa falha de ignição: o scanner OBD2 pode mostrar código P0300 a P0302 (misfire) como sintoma secundário do consumo."
  - nome: "Solicite o teste de compressão e o teste de leak-down"
    texto: "Leve o carro a um mecânico especializado em PSA e solicite os dois testes diagnósticos: (1) teste de compressão de cilindros, com o motor na temperatura de trabalho, que deve apresentar entre 140 e 180 PSI em cada cilindro com variação máxima de 15% entre eles; (2) teste de leak-down, em que ar comprimido é injetado no cilindro com o pistão no ponto morto superior. O local de saída do ar indica a origem: pelo cárter aponta para anéis, pela admissão ou escape aponta para válvulas, pelo radiador aponta para a junta de cabeçote."
  - nome: "Verifique o turbocompressor independentemente"
    texto: "O turbo do 1.2 PureTech usa óleo do motor para lubrificar o eixo do rotor. Um turbo com desgaste no eixo vaza óleo para o sistema de admissão e para o escapamento. Para verificar: com o motor frio, inspecione o interior do duto de admissão após o turbo. Presença de película de óleo nas paredes internas do duto ou do intercooler indica vazamento do turbo. Um turbo gasto também produz assobio agudo em aceleração. A substituição do turbo resolve o consumo de óleo atribuível a esse componente sem necessidade de abrir o bloco."
afiliados:
  - produto: "Óleo 5W-30 sintético aprovado PSA (conforme especificação B71 2290)"
    nota: "Lubrificante na especificação exata exigida pelo motor 1.2 PureTech. Usar óleo fora da aprovação PSA é o principal fator"
    busca: "óleo 5w-30 sintético aprovado psa (conforme especificação b71 2290)"
    programa: amazon
    cta: "Ver peça recomendada"
  - produto: "Testador de pressão de óleo automotivo"
    nota: "Manômetro de pressão de óleo para diagnóstico doméstico. Permite verificar se a pressão de óleo do PureTech está dentro "
    busca: "testador de pressão de óleo automotivo"
    programa: amazon
    cta: "Ver peça recomendada"
  - produto: "Kit de vedantes e retentores para motor PSA"
    nota: "Kit de vedação para manutenção preventiva ou reparo dos retentores de válvula e retentores do turbo. Compatível com moto"
    busca: "kit de vedantes e retentores para motor psa"
    programa: amazon
    cta: "Ver peça recomendada"
fontes:
...
| Origem | Como identificar | Onde verificar |
|---|---|---|
| Retentor do virabrequim | Mancha de óleo embaixo do carro, na parte frontal | Embaixo do motor, próximo à polia do alternador |
| Junta da tampa de válvulas | Óleo ressecado na lateral do cabeçote | Parte superior do motor, base da tampa |
| Retentor do turbo (saída) | Fumaça azulada constante, não só a frio | Duto de saída do turbo para o escapamento |
| Retentor do turbo (entrada) | Óleo no duto de admissão após o turbo | Interior do tubo de ar entre turbo e intercooler |
| Anéis de pistão | Fumaça azulada a frio, queda de nível sem mancha embaixo | Teste de compressão e leak-down |
| Retentores de válvula | Fumaça azulada só no arranque, desaparece quente | Teste de leak-down no cilindro |

...
entidade:
  marca: "Peugeot"
  modelo: "208"
  motor: "1.2 PureTech aspirado 82 cv (EB2)"
  geracao: "208 pré-2020 (motor aspirado, 2017-2020)"
defeito: "consumo excessivo de óleo"
kicker: "DEFEITO CRÔNICO · ALTA ATENÇÃO"
intencao: "Diagnóstico"
entidadesEssenciais:
  - "motor 1.2 PureTech aspirado de 3 cilindros (EB2)"
  - "retentores de haste de válvula"
  - "anéis de controle de óleo do pistão"
  - "correia dentada banhada a óleo"
  - "óleo 0W-30 PSA B71 2312"
  - "consumo de óleo"
  - "PureTech turbo europeu (não vendido no Brasil)"
autor:
  nome: "Redação Hachiroku"
pubDate: 2026-06-20
updatedDate: 2026-07-02
disclaimer: "Este conteúdo é informativo e diagnóstico. Consumo de óleo acima de 0,5 litro por 1.000 km pede avaliação por mecânico qualificado. Continuar rodando com o nível abaixo do mínimo pode causar dano irreversível ao motor. Confirme sempre a especificação de óleo no manual do seu ano."
imagem: "/logos/hachiroku-badge-86.png"
imagemAlt: "Motor 1.2 PureTech aspirado de 3 cilindros do Peugeot 208 com consumo de óleo"
pontosChave:
  - "Sintoma: nível de óleo caindo de MAX para MIN em poucos milhares de km, fumaça azulada ao arrancar a frio e velas com ponta oleosa. A Peugeot trata até 0,5 litro por 1.000 km como aceitável, e há relatos de donos acima disso."
  - "Causa: no aspirado a origem típica são os retentores de haste de válvula ressecados e o anel de controle de óleo empastado com carvão, não o turbo (o 208 brasileiro nunca teve o PureTech turbo). O motor também usa correia banhada a óleo, sensível ao lubrificante errado."
  - "Ação: verificar o nível a cada 2.000 km, pedir teste de compressão e leak-down em oficina de linha PSA e usar somente óleo 0W-30 na especificação PSA B71 2312, trocado a cada 10.000 km ou 12 meses."
faq:
  - pergunta: "O Peugeot 208 vendido no Brasil teve o motor 1.2 PureTech turbo?"
    resposta: "Não. O 1.2 PureTech turbo de 3 cilindros (as versões europeias de 100, 110 e 130 cv, com fama de correia banhada a óleo que se desfaz) nunca foi vendido no Brasil. O 208 brasileiro que usou a marca PureTech recebeu o 1.2 aspirado de 3 cilindros (código EB2, na casa dos 82 cv a 90 cv em flex), montado no 208 da fase anterior a 2020, ao lado do 1.6 aspirado. O 208 atual usa outros motores: o 1.0 Firefly aspirado e o 1.0 Turbo 200, ambos de origem Fiat dentro da Stellantis. Ou seja, quando alguém fala do 'problema do PureTech turbo', está falando de um carro que não circulou por aqui de fábrica."
  - pergunta: "O 1.2 PureTech aspirado do 208 realmente consome óleo?"
    resposta: "Há relatos consistentes de donos, no Brasil e na Europa, de consumo acima da média nesse motor aspirado, com casos citando cerca de 1 litro a cada 1.000 km. A Peugeot considera normal um consumo de até 0,5 litro por 1.000 km, então parte dos relatos fica acima do limite da própria montadora. No aspirado, as causas mais apontadas por mecânicos e fóruns são os retentores de haste de válvula ressecados e o anel de controle de óleo do pistão empastado com carvão, que deixam o óleo passar para a câmara de combustão."
  - pergunta: "O motor aspirado também tem correia dentada banhada a óleo?"
  ...
  - pergunta: "O consumo de óleo tem cobertura de garantia da Peugeot no Brasil?"
...
passos:
  - nome: "Monitore o nível de óleo a cada 2.000 km"
    texto: "Com o motor frio e o carro em piso plano, retire a vareta e anote a quilometragem com o óleo no MAX. Repita a cada 2.000 km. Se o nível cair para MIN ou abaixo em menos de 5.000 km, o consumo já passa do limite tolerado pela Peugeot. Complete apenas com óleo 0W-30 na especificação PSA B71 2312 antes de seguir rodando, e leve sempre uma garrafa no porta-malas se o carro já consome."
  - nome: "Observe o escapamento no arranque a frio"
    texto: "Nas manhãs frias ou depois de o carro ficar parado várias horas, olhe o escapamento nos primeiros 30 a 60 segundos. Uma névoa branca fina é só condensação de água. Fumaça de tom azulado, mais densa, com cheiro de óleo queimado, indica óleo sendo queimado. Grave um vídeo no celular: ajuda no diagnóstico e serve de registro para eventual acionamento de garantia."
  - nome: "Inspecione as 3 velas de ignição"
    texto: "Com o motor frio, remova as velas. Ponta acinzentada ou marrom-clara é sinal de vela saudável. Ponta oleosa, com depósito preto gorduroso ou isolador encharcado, aponta consumo no cilindro correspondente. Vela oleosa também gera falha de ignição, e o scanner pode registrar códigos de misfire (P0300 a P0303) como sintoma secundário."
  - nome: "Solicite teste de compressão e leak-down"
    texto: "Em uma oficina de linha PSA, peça os dois testes. A compressão mede a pressão de cada cilindro com o motor quente. O leak-down injeta ar no cilindro e mostra por onde ele escapa: pelo tubo do cárter aponta anéis, pela admissão ou escape aponta válvulas ou seus retentores, pelo radiador aponta junta de cabeçote. É o que separa 'trocar retentor' de 'abrir o motor'."
  - nome: "Confira a correia banhada a óleo e o histórico de lubrificante"
    texto: "Levante o histórico de trocas de óleo. Se em algum momento entrou óleo fora da especificação PSA B71 2312, ou o intervalo de 10.000 km estourou, a correia banhada a óleo pode estar degradada mesmo com pouca quilometragem. Peça inspeção da correia junto do diagnóstico de consumo, porque os dois problemas nascem do mesmo lugar: lubrificante inadequado."
afiliados:
  - produto: "Óleo 0W-30 sintético aprovado PSA B71 2312"
    nota: "Especificação exata do 1.2 PureTech e a que protege a correia banhada a óleo. Óleo fora da norma é o principal acelerador do problema."
    busca: "oleo 0w30 sintetico psa b71 2312"
    programa: amazon
    cta: "Ver óleo recomendado"
  - produto: "Scanner OBD2 Bluetooth"
    nota: "Ajuda a flagrar códigos de falha de ignição (misfire) que acompanham a vela oleosa e a luz de injeção."
    busca: "scanner obd2 bluetooth"
    programa: amazon
  - produto: "Kit de retentores de haste de válvula para motor PSA"
    nota: "Peça de reparo da causa mais comum de consumo de óleo no aspirado. A troca exige remoção do cabeçote por profissional."
    busca: "kit retentor valvula peugeot 208 1.2"
...
<aside class="telltale danger" role="note"><span aria-hidden="true">🔴</span><p><strong>Cuidado.</strong> Nunca rode com o nível de óleo abaixo do mínimo neste motor de 3 cilindros. Os mancais de biela são os primeiros a sofrer dano permanente por falta de lubrificação, e o custo do reparo salta de "trocar um retentor" para "abrir o motor".</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Por que isso importa.</strong> Se você leu que "o PureTech quebra correia e funde o motor", saiba que a maior parte desses relatos é do turbo europeu. O 208 brasileiro tem o aspirado, que tem um perfil de consumo de óleo próprio, mais ligado a válvulas e anéis. Diagnosticar o carro certo evita gastar dinheiro no problema errado.</p></aside>
...
<aside class="telltale warning" role="note"><span aria-hidden="true">⚠️</span><p><strong>Atenção.</strong> O óleo que lubrifica a correia é o mesmo que circula pelo resto do motor. Óleo degradado ou fora da especificação 0W-30 PSA B71 2312 ataca ao mesmo tempo a correia, os anéis e os retentores. É por isso que o lubrificante certo não é detalhe: é a peça de manutenção mais barata que protege as mais caras.</p></aside>
...
<aside class="telltale warning" role="note"><span aria-hidden="true">⚠️</span><p><strong>Atenção.</strong> No estágio avançado, o catalisador contaminado pode obstruir parte do escapamento, gerando perda de potência. Trocar o catalisador acrescenta uma conta à parte ao reparo do motor, então quanto antes o consumo for flagrado, menor o estrago.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Vale saber.</strong> É o diagnóstico, e não o palpite, que define em qual linha dessa tabela você cai. Abrir o motor achando que é anel quando eram só os retentores de válvula dobra a conta sem necessidade. Gaste primeiro nos R$ 200 a R$ 400 do teste de compressão e leak-down.</p></aside>
...
2. Leve à concessionária com pelo menos 3 registros de queda de nível documentados.
3. Abra ordem de serviço com a descrição explícita do sintoma e dos valores medidos.
4. Guarde as notas de todas as trocas de óleo feitas no prazo, com o óleo na especificação.
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Boa notícia.</strong> Um 208 1.2 PureTech aspirado com histórico de óleo na régua, na especificação certa, tem vida útil compatível com qualquer motor moderno da categoria. O mesmo histórico é o seu melhor argumento se um dia precisar reclamar de consumo.</p></aside>

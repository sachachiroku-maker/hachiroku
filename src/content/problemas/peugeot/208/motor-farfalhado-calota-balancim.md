...
entidade:
  marca: "Peugeot"
  modelo: "208"
  motor: "1.6 VTi 16V (EP6)"
  geracao: "2ª geração (2019-atual)"
defeito: "farfalhado na tampa de balancins"
...
imagemAlt: "Motor 1.6 VTi do Peugeot 208 com ruído na tampa de balancins"
faq:
  - pergunta: "O que é o farfalhado no motor do Peugeot 208?"
    resposta: "É um ruído metálico seco, semelhante a um chacoalhar de folhas de metal finas, localizado na parte superior do motor, na região do cabeçote. No 208 com motor 1.6 VTi (EP6), a tampa de balancins em plástico reforçado com fibra é a origem mais comum desse ruído. Com o desgaste, as vedações internas da tampa perdem vedação, a pressão de óleo na região dos balancins cai e os componentes passam a trabalhar com lubrificação insuficiente, gerando o farfalhado."
  - pergunta: "O farfalhado do 208 é perigoso para o motor?"
    resposta: "Depende da causa. Se o ruído vem de uma vedação da tampa de balancins com falha, a consequência imediata é a contaminação da região do cabeçote com vapor de óleo e eventual depósito de resíduo. A longo prazo, a lubrificação deficiente dos balancins pode causar desgaste prematuro nas pontas das válvulas e nos cames do árbol. Um farfalhado que piora progressivamente ou aparece acompanhado de luz de óleo ou perda de potência exige avaliação imediata."
  - pergunta: "É preciso trocar só a vedação ou a tampa inteira?"
    resposta: "Na maioria dos reparos, a orientação das oficinas especializadas em Peugeot é substituir a tampa de balancins completa em vez de tentar recorrer às vedações separadas. Isso porque a calota em plástico também pode apresentar microfissuras pelo calor cíclico do motor ao longo de 60.000 a 80.000 km. O custo de uma tampa nova mais mão de obra costuma ser menor que refazer o serviço depois de uma vedação que não segura."
  - pergunta: "Quanto custa trocar a tampa de balancins do Peugeot 208 1.6?"
    resposta: "A tampa de balancins do motor EP6 do 208 custa entre R$ 350 e R$ 700 em peça (original Stellantis ou paralela de qualidade). A mão de obra é de 1 a 2 horas de mecânico. Serviço completo em oficina especializada costuma sair entre R$ 500 e R$ 1.100 incluindo troca do óleo de motor recomendada junto ao serviço."
  - pergunta: "Com quantos quilômetros o problema costuma aparecer?"
    resposta: "Os relatos em fóruns de proprietários e registros de reclamações apontam para o intervalo de 60.000 a 90.000 km como janela mais comum para o aparecimento do farfalhado na tampa de balancins do 208 1.6 VTi. Carros com histórico de trocas de óleo atrasadas ou uso de lubrificante fora da especificação (5W-30 sintético) tendem a apresentar o problema mais cedo."
  - pergunta: "Qual o óleo correto para o motor 1.6 VTi do Peugeot 208?"
...
passos:
  - nome: "Identifique a origem do ruído"
    texto: "Com o motor frio, ligue o carro e aguarde 2 a 3 minutos sem acelerar. O farfalhado da tampa de balancins tende a ser mais audível nos primeiros minutos de funcionamento, quando a pressão de óleo ainda está se estabilizando. Localize o som: deve vir da parte superior do motor, próximo à tampa plástica que fica sobre o cabeçote. Um caninho de borracha ou estetoscópio barato ajuda a localizar o ponto exato."
  - nome: "Verifique o nível e a qualidade do óleo"
    texto: "Desligue o motor e aguarde 10 minutos. Puxe a vareta de nível: o óleo deve estar entre as marcas MIN e MAX. Observe a cor: óleo muito escuro, com aspecto de graxa ou com odor de queimado indica degradação avançada. Óleo abaixo do MIN com motor fazendo farfalhado é sinal de alerta grave — complete o nível com o óleo especificado (5W-30 sintético PSA B71 2290) antes de qualquer outra avaliação."
  - nome: "Inspecione a tampa de balancins visualmente"
    texto: "Com o motor frio, examine a tampa de balancins externamente. Manchas de óleo ressecado na base da tampa, especialmente na interface com o cabeçote, indicam falha de vedação. Verifique também os dutos de respiro do motor: se houver óleo emulsificado (cor leitosa) nos respiros, pode haver um problema de blow-by associado que exige diagnóstico mais profundo."
  - nome: "Cheque o trocador de calor de óleo (resfriador de óleo)"
    texto: "O motor EP6 tem um trocador de calor óleo/líquido de arrefecimento montado no bloco. Falha nas vedações desse componente pode gerar sintomas similares ao farfalhado da tampa: pressão de óleo instável e ruído no cabeçote. Um mecânico deve inspecionar o trocador ao mesmo tempo que avalia a tampa. A troca do trocador isolado costuma custar entre R$ 400 e R$ 800 em peças."
  - nome: "Troque a tampa de balancins e o óleo simultaneamente"
    texto: "Uma vez confirmada a origem do ruído na tampa, o serviço recomendado é substituir a tampa completa com vedação nova, trocar o óleo e o filtro de óleo no mesmo momento. Ao refazer a montagem, o torque dos parafusos da tampa deve seguir a sequência e valores do manual (geralmente 8 a 10 Nm, em cruz). Reapertar além do especificado pode deformar a flangia plástica da tampa."
pontosChave:
  - "O farfalhado no motor do Peugeot 208 1.6 VTi tem origem mais comum na tampa de balancins com vedação degradada após 60.000 a 90.000 km."
  - "O motor EP6 requer óleo sintético 5W-30 com aprovação PSA B71 2290: lubrificantes fora da especificação aceleram o problema."
  - "Trocar a tampa de balancins completa é mais confiável que substituir apenas as vedações separadas."
  - "O custo do serviço completo (tampa + óleo + filtro) fica entre R$ 500 e R$ 1.100 em oficina especializada."
  - "Ruído que piora rapidamente ou vem acompanhado de luz de óleo acesa exige parada imediata e diagnóstico profissional."
fontes:
  - { titulo: "Problemas comuns do motor EP6 1.6 (Fórum Clube do 208 Brasil)", url: "https://www.clubedo208.com.br/forum/" }
  - { titulo: "Peugeot 208 defeitos e problemas relatados (Reclame Aqui)", url: "https://www.reclameaqui.com.br/empresa/peugeot/" }
  - { titulo: "Motor EP6 consumo de óleo e ruído no cabeçote (Motor Show)", url: "https://motorshow.com.br/" }
  - { titulo: "Peugeot 208 2023 avaliação técnica (Quatro Rodas)", url: "https://quatrorodas.abril.com.br/" }
draft: false
---

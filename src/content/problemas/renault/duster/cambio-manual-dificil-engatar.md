...
entidade:
  ...
  geracao: "1ª e 2ª geração (2012-2023)"
defeito: "Câmbio manual dificultoso e engates duros"
...
imagemAlt: "Ilustração de câmbio manual do Renault Duster com destaque nos sincronizadores"
faq:
  - pergunta: "Por que o câmbio do Duster endurece com o tempo?"
    resposta: "O principal fator é o desgaste dos sincronizadores, agravado pelo uso de óleo de câmbio fora da especificação GL-4 75W90 ou com trocas atrasadas. Em veículos usados em off-road com 4x4 em baixa, o desgaste é ainda mais acelerado."
  - pergunta: "Qual o óleo correto para o câmbio manual do Duster?"
    resposta: "A Renault especifica óleo GL-4 75W90 para o câmbio manual de 6 marchas do Duster. O uso de GL-5 pode atacar os revestimentos dos sincronizadores de bronze, agravando o problema de engates duros."
  - pergunta: "O cabo de câmbio influencia nos engates duros?"
    resposta: "Sim. Um cabo desgastado, ressecado ou mal regulado aumenta o esforço necessário para trocar marchas e pode simular sintomas de sincronizadores ruins. É o primeiro item a inspecionar antes de abrir a caixa."
  - pergunta: "Com que frequência devo trocar o óleo do câmbio do Duster usado em off-road?"
    resposta: "Em uso off-road severo com tração 4x4 em baixa, recomenda-se trocar o óleo do câmbio a cada 40 mil km. Em uso predominantemente urbano, o intervalo pode ser estendido até 60 mil km, mas jamais negligencie a troca."
  - pergunta: "O câmbio duro do Duster tem conserto sem abrir a caixa?"
    resposta: "Sim, em muitos casos. Troca do óleo por GL-4 75W90 de qualidade e ajuste ou substituição do cabo de câmbio resolvem o problema sem desmontagem da transmissão. Só é necessário abrir a caixa quando os sincronizadores já estão danificados."
passos:
  - nome: "Verificar o cabo de câmbio"
    texto: "Com o veículo frio e em ponto morto, mova a alavanca em todas as direções. Resistência irregular, folga excessiva ou travamentos pontuais indicam cabo desgastado ou desregulado. Inspecione o trançado e os pontos de fixação sob o capô."
  - nome: "Checar o nível e condição do óleo do câmbio"
    texto: "Localize o tampão de nível na lateral da caixa de câmbio. O óleo deve estar na borda do orifício. Observe a cor: óleo escuro, com cheiro de queimado ou com partículas metálicas indica contaminação e desgaste interno."
  - nome: "Testar em frio e em quente"
    texto: "O câmbio duro exclusivamente a frio, que melhora após 5 a 10 minutos de uso, aponta para óleo viscoso demais ou degradado. Se o problema persiste com o câmbio quente, o foco muda para sincronizadores ou cabo."
  - nome: "Avaliar quais marchas estão afetadas"
    texto: "Marchas específicas com dificuldade de engate (especialmente 2ª e 3ª no Duster) direcionam o diagnóstico para os sincronizadores daquele grupo. Dificuldade generalizada em todas as marchas aponta para cabo ou óleo."
  - nome: "Definir a intervenção necessária"
    texto: "Se cabo e óleo estão em ordem e o problema persiste, o passo seguinte é a abertura da caixa para inspeção dos sincronizadores. Esse serviço exige oficina especializada em transmissões mecânicas."
afiliados:
  - produto: "Óleo de câmbio GL-4 75W90 sintético"
    nota: "Especificação obrigatória para o câmbio manual 6 marchas do Duster. Evite GL-5, que ataca os sincronizadores de bronze."
    busca: "óleo câmbio GL-4 75W90 sintético"
    programa: "amazon"
    cta: "Ver produto"
  - produto: "Cabo de câmbio Renault Duster"
    nota: "Peça de desgaste frequente no Duster. Prefira cabo original ou de fabricante reconhecido para manter a precisão de engate."
    busca: "cabo câmbio Renault Duster"
    programa: "mercadoLivre"
relacionados:
  - titulo: "Duster CVT: solavanco e falha de aceleração"
    url: "/problemas/renault/duster/cambio-cvt/"
  - titulo: "Duster: amortecedores dianteiros batem e vazam"
    url: "/problemas/renault/duster/amortecedores-dianteiros/"
pontosChave:
  - "Sintoma: alavanca de câmbio endurece, marchas entram com esforço ou recusam o engate"
  - "Causa: desgaste dos sincronizadores, cabo de câmbio ressecado ou óleo GL-5 no lugar de GL-4 75W90"
  - "Acao: trocar óleo por GL-4 75W90, ajustar ou substituir cabo; se persistir, inspecionar sincronizadores"
  - "Atencao: uso off-road com 4x4 em baixa acelera o desgaste interno — trocar óleo a cada 40 mil km nesses casos"
fontes:
  - { titulo: "Renault Duster manual do proprietário — transmissão manual (6 marchas)", url: "https://www.renault.com.br/servicos/manuais.html" }
  - { titulo: "Clube do Duster — relatos e soluções câmbio manual", url: "https://www.clubedoduster.com.br" }
draft: false
---
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Nunca use GL-5 no câmbio manual do Duster.</strong> Mesmo que um mecânico sugira ou que o produto seja "universal", o GL-5 destrói os sincronizadores de bronze progressivamente. O dano é irreversível sem troca das peças.</p></aside>
...
<aside class="telltale" role="note"><span aria-hidden="true">⚠️</span><p><strong>Sinal de alarme em off-road.</strong> Se o câmbio começar a "bugar" durante uma trilha, com marchas recusando em situação de inclinação ou esforço, pare assim que possível. Forçar o engate com sincronizadores desgastados pode bloquear a alavanca e deixar o veículo em uma marcha no meio do percurso.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>O cabo é o primeiro suspeito.</strong> Antes de qualquer diagnóstico interno na caixa, verifique o cabo. É a intervenção mais barata e rápida, e resolve o problema em uma parcela significativa dos casos.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Solução direta.</strong> Em 90% dos casos de câmbio duro só a frio, a troca por GL-4 75W90 sintético de qualidade resolve completamente. Intervenção simples, custo baixo, resultado imediato.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Não ignore marcha saindo sozinha.</strong> Câmbio que sai da 2ª ou da 3ª em aceleração é risco de segurança real. O motor sobe de rotação abruptamente e o controle do veículo fica comprometido. Pare de usar o carro em estradas rápidas até resolver.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Registro do resultado.</strong> Anote como o câmbio se comportava antes e como ficou após as intervenções. Esse registro é fundamental se o problema persistir e a caixa precisar ser aberta. O mecânico especializado vai precisar dessas informações.</p></aside>
...
<aside class="telltale" role="note"><span aria-hidden="true">⚠️</span><p><strong>Intervalo especial para off-road.</strong> Em uso severo com 4x4 em baixa frequente, o óleo do câmbio manual deve ser trocado a cada 40 mil km. Esse intervalo reduzido compensa o desgaste acelerado e preserva os sincronizadores.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Atenção na compra do óleo.</strong> Alguns óleos "GL-4/GL-5" ou "GL-5" são vendidos como compatíveis com caixas que pedem GL-4. Para os sincronizadores de bronze do Duster, qualquer produto que contenha GL-5 nos aditivos representa risco. Use apenas GL-4 puro.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Reforma preventiva.</strong> Se a caixa já for aberta para troca de sincronizadores danificados, aproveite para substituir os retentores e vedações enquanto está desmontada. O custo adicional é pequeno e previne vazamentos futuros.</p></aside>

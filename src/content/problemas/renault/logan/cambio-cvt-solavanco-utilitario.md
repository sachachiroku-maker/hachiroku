...
seoTitle: "CVT do Logan no uso comercial: desgaste, fluido"
...
faq:
  ...
  - pergunta: "Como o uso comercial afeta o CVT diferente do uso particular?"
    resposta: "Em uso particular normal, o Logan CVT funciona com variações suaves de carga e temperatura. Em uso comercial urbano (táxi, app), o câmbio opera constantemente em carga parcial baixa (trânsito lento), com temperatura elevada (ar-condicionado ligado por horas) e ciclos frequentes de aceleração-frenagem. Esse padrão eleva a temperatura do fluido CVT acima do ideal mais frequentemente, degrada o fluido mais rápido e exige que as polias ajustem a relação de transmissão com muito mais frequência do que no uso particular. O desgaste acumulado é significativamente maior."
passos:
  - nome: "Identifique o padrão de uso antes de qualquer diagnóstico"
    texto: "Anote a quilometragem do carro, o perfil de uso predominante (particular, app, táxi) e a data da última troca de fluido CVT. Se o fluido nunca foi trocado ou se a última troca foi há mais de 60 mil km (ou 40 mil km em uso comercial), o fluido degradado é a primeira hipótese a investigar antes de qualquer reparo nas peças mecânicas."
  - nome: "Verifique o comportamento do CVT em diferentes condições"
    texto: "Teste o câmbio em três situações: arranque do zero em plano, aceleração em subida leve e retomada depois de frear bruscamente. Solavanco no arranque do zero com câmbio frio tende a ser de fluido degradado. Solavanco em subida com carga tende a indicar desgaste de polia. Ruído de chiado em aceleração específica pode apontar para desgaste da correia interna."
  - nome: "Faça o flush do CVT com fluido correto e troca de filtro"
    texto: "Leve o Logan a uma oficina especializada em transmissões e solicite o flush completo do CVT, incluindo: drenagem do fluido antigo, limpeza do reservatório, troca do filtro interno (se acessível no modelo), reenchimento com fluido Renault CVT JWS 3320 na quantidade correta e verificação do nível. Não aceite 'troca parcial' em que só parte do fluido é renovado, pois o fluido antigo contamina o novo."
  - nome: "Avalie a resposta após o flush"
    texto: "Após o flush, dirige normalmente por ao menos 500 km antes de avaliar. O CVT pode apresentar solavancos leves nos primeiros quilômetros após a troca de fluido enquanto o sistema se adapta. Se os solavancos persistirem além de 500 km com o fluido novo, o problema provavelmente não é o fluido, mas desgaste mecânico das polias ou da correia."
  - nome: "Solicite inspeção das polias se o solavanco persistir"
    texto: "Com o câmbio desmontado, o mecânico pode inspecionar visualmente o estado das polias metálicas (presença de arranhões, picotes ou desgaste irregular no cone) e da correia metálica interna (empastado, desgaste das chapas). Com essas informações, é possível definir se a revisão das peças é viável ou se a substituição do câmbio completo por uma unidade revisada é a opção mais econômica."
pontosChave:
  - "O CVT Jatco X-Tronic do Renault Logan foi projetado para uso particular misto e sofre desgaste acelerado quando operado em uso comercial intenso, especialmente táxi e aplicativo em trânsito urbano."
  - "O fluido correto é o Renault CVT JWS 3320: usar fluido genérico ou ATF convencional danifica as polias metálicas e a correia interna da transmissão."
  - "Em uso comercial, o fluido deve ser trocado a cada 40 mil km. Em uso particular, a cada 60 mil km."
...
**Uso particular:**
Uma viagem de 25 km pela manhã com trânsito moderado, seguida de uma viagem de 25 km no fim do dia. O CVT faz entre 30 e 60 ciclos de aceleração e frenagem por viagem. O fluido atinge a temperatura de operação e se mantém estável por a maior parte do percurso.

**Uso como aplicativo:**
12 horas de operação contínua, com dezenas de corridas curtas de 5 a 15 km. O CVT faz 300 a 600 ou mais ciclos de aceleração e frenagem por dia, com paradas frequentes em que o câmbio opera em rotação baixa com o carro quase parado (situação de máximo deslizamento da correia nas polias). O ar-condicionado fica ligado por 12 horas, aumentando a carga térmica do motor e indiretamente do fluido. A temperatura do fluido CVT excede o ideal com mais frequência.

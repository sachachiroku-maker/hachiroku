...
entidade:
  ...
  modelo: "Hilux SRX"
  motor: "2.8 GD diesel"
defeito: "distribuição de ar desequilibrada entre cabine dianteira e bancada traseira, com eficiência reduzida no resfriamento dos bancos traseiros"
kicker: "DEFEITO COMUM"
intencao: "Diagnóstico"
entidadesEssenciais:
  - "duto de ar traseiro"
  - "difusor traseiro de cabine"
  - "caixa evaporadora"
  - "ventilação de segunda fileira"
  - "filtro de cabine"
  - "flap de distribuição"
  - "motorizado de modo"
  - "duto de piso traseiro"
  - "gás R-134a"
...
imagemAlt: "Interior cabine dupla Toyota Hilux SRX com destaque para difusores traseiros de ar-condicionado"
pontosChave:
  - "Sintoma: ar-condicionado sopra frio nos dutos dianteiros mas quase sem vazão ou com ar morno nos difusores e dutos de piso da segunda fileira, mesmo com o sistema no máximo."
  - "Causa: obstrução parcial ou desconexão dos dutos traseiros, falha no flap de distribuição interno (motorizado de modo) que não redireciona o fluxo para a segunda fileira, ou filtro de cabine colmatado que reduz a pressão de ar no sistema todo e prejudica mais os pontos de saída mais distantes da caixa evaporadora."
  - "Ação: trocar o filtro de cabine como primeiro passo, inspecionar visualmente os dutos e difusores traseiros, verificar a operação do motorizado de modo pelo painel de climatização e, se necessário, levar a uma oficina para avaliação do sistema de distribuição de ar."
faq:
  - pergunta: "Por que o ar-condicionado da Hilux SRX resfria bem na frente mas quase nada atrás?"
    resposta: "A Toyota Hilux SRX cabine dupla tem um sistema de ventilação que distribui o ar da caixa evaporadora por dutos que percorrem o painel dianteiro, o teto e os dutos de piso até a segunda fileira. Quando o filtro de cabine está entupido, a pressão de ar no sistema todo cai. Como os dutos traseiros ficam no final do percurso, eles são os primeiros a perder vazão. Além disso, o flap interno de distribuição de modo, quando travado ou com defeito no motorizado, pode manter o fluxo concentrado nos dutos dianteiros mesmo quando o painel indica distribuição geral. Dutos amassados ou parcialmente desconectados durante revisões internas de estofamento ou som automotivo também causam exatamente esse sintoma."
  - pergunta: "O filtro de cabine entupido pode causar ar fraco só atrás?"
    resposta: "Sim, e é a causa mais frequente. Um filtro de cabine colmatado reduz a pressão de ar em todo o sistema. Como os difusores traseiros ficam mais distantes da caixa evaporadora e dependem de pressão suficiente para receber fluxo, eles são os primeiros a ser prejudicados. Na prática, o motorista sente ar frio saindo bem pelos dutos do painel, enquanto os passageiros traseiros quase não sentem o ar. A troca do filtro de cabine, procedimento simples e barato (R$ 30 a R$ 80), resolve o problema em boa parte dos casos sem qualquer intervenção no sistema de refrigeração."
  - pergunta: "O que é o motorizado de modo e como ele afeta a distribuição de ar?"
    resposta: "O motorizado de modo é um pequeno atuador elétrico acoplado ao flap interno da caixa evaporadora. Esse flap direciona o fluxo de ar para diferentes rotas: painel, piso, parabrisa, ou combinações. Quando o motorizado trava mecanicamente (por desgaste da engrenagem plástica) ou perde o sinal elétrico, o flap fica preso em uma posição. Se travar na posição de escoamento apenas pelo painel dianteiro, os dutos de piso e traseiros ficam sem fluxo. O sintoma típico é que o ar-condicionado não responde à mudança de modo no painel ou emite um ruído de clique repetitivo quando selecionado. O diagnóstico pode ser feito com scanner automotivo na centralinha de climatização."
  - pergunta: "Como verificar se o duto traseiro está obstruído ou desconectado?"
    resposta: "O primeiro sinal é perceber com a mão se há saída de ar nos difusores e nas saídas de piso da segunda fileira com o ar-condicionado ligado no máximo. Se não houver fluxo perceptível mesmo com o sistema funcionando bem nos dutos dianteiros, o problema está nos dutos traseiros. A inspeção visual exige a remoção parcial do revestimento lateral ou do painel de teto (dependendo do percurso do duto no veículo). Dutos de plástico rígido podem trincar nas conexões após anos de uso; dutos flexíveis podem ser amassados por objetos armazenados no porta-malas ou por instalação de acessórios. Oficinas especializadas em climatização automotiva fazem essa verificação sem necessidade de desmontar o interior completo."
  - pergunta: "Trocar o filtro de cabine resolve o problema de ar fraco nos bancos traseiros?"
    resposta: "Em muitos casos, sim. O filtro de cabine da Hilux fica na rota de entrada de ar antes do evaporador. Quando está entupido, a queda de pressão de ar no sistema é generalizada, mas os dutos mais distantes, como os da segunda fileira, sentem mais o impacto. A troca do filtro de cabine deve ser sempre o primeiro passo no diagnóstico porque é simples, barata e elimina a variável mais comum. Se após a troca do filtro o fluxo nos difusores traseiros melhorar visivelmente, o problema estava no filtro. Se não melhorar, a investigação avança para motorizado de modo, dutos e carga de gás."
  - pergunta: "A carga de gás R-134a baixa afeta mais os bancos traseiros do que os dianteiros?"
    resposta: "Indiretamente, sim. Com carga de gás insuficiente, a capacidade de resfriamento do evaporador cai. O sistema ainda produz ar, mas menos frio. O resultado é que os dutos dianteiros, mais próximos do evaporador, ainda entregam alguma sensação de frescor, enquanto os dutos traseiros, além de receberem menos fluxo por percorrerem trajeto mais longo, entregam ar que já perdeu mais calor no caminho. Por isso, quando a queixa é ar fraco apenas atrás, é prudente verificar a carga de gás junto com o filtro de cabine antes de concluir que o problema é mecânico nos dutos."
passos:
  - nome: "Confirme a diferença de temperatura entre dutos dianteiros e traseiros"
    texto: "Com o motor aquecido e em marcha lenta, ligue o ar-condicionado na temperatura mínima e ventilação máxima. Coloque a mão sobre os dutos centrais do painel e anote a sensação de temperatura e vazão. Em seguida, faça o mesmo nos difusores laterais traseiros e nas saídas de piso da segunda fileira. Se a diferença de temperatura ou vazão for perceptível, o problema está na distribuição e não na capacidade total do sistema. Se os dutos dianteiros também estiverem com ar quente ou sem vazão, o problema pode estar no compressor, na carga de gás ou no filtro de cabine, que afeta o sistema todo."
  - nome: "Troque o filtro de cabine imediatamente"
    texto: "O filtro de cabine da Hilux fica acessível pelo porta-luvas do passageiro. Abra o porta-luvas, pressione as laterais para liberar as travas e remova o conjunto. O filtro de cabine fica em um compartimento atrás do porta-luvas. Remova o filtro antigo e instale um filtro novo compatível com a Hilux (filtros de papel, de carvão ativado ou combinados estão disponíveis no mercado). Um filtro colmatado tem cor cinza-escura a preta e aspecto comprimido. Após a troca, ligue o sistema e verifique se o fluxo nos dutos traseiros melhorou. Se melhorou significativamente, o filtro era a causa principal."
  - nome: "Teste os modos de ventilação pelo painel de climatização"
    texto: "Com o ar-condicionado ligado, percorra todos os modos de distribuição disponíveis no painel de climatização da Hilux SRX: painel, piso, painel e piso combinados, desembaçador. Observe se o ar-condicionado responde a cada mudança de modo. Em cada seleção, verifique com a mão quais saídas de ar estão ativas. Se o sistema não responde a um determinado modo (por exemplo, seleciona piso mas o ar continua saindo só pelo painel), o motorizado de modo desse percurso está com falha mecânica ou elétrica. Anote quais modos funcionam e quais não funcionam para facilitar o diagnóstico na oficina."
  - nome: "Inspecione visualmente os difusores e saídas traseiras"
    texto: "Com o ar-condicionado desligado, inspecione fisicamente os difusores traseiros (normalmente na coluna B ou no teto, dependendo da configuração da cabine dupla) e as saídas de piso da segunda fileira. Verifique se há obstrução visível por sujeira, objeto ou deformação. Com o ar-condicionado ligado no máximo, passe a mão ou um papel fino próximo a cada saída para detectar se há algum fluxo de ar, mesmo fraco. A ausência total de fluxo em uma saída específica indica bloqueio mecânico no duto ou flap fechado. Fluxo presente mas ar quente aponta para problema no ciclo de refrigeração."
  - nome: "Verifique a carga de gás R-134a em oficina especializada"
    texto: "Se a troca do filtro de cabine e a verificação dos modos não resolverem, leve o veículo a uma oficina especializada em ar-condicionado automotivo para medição das pressões de alta e baixa com manômetro. Com o motor em 1.500 rpm, os valores de referência para a Hilux 2.8 GD são: pressão de baixa entre 0,20 MPa e 0,35 MPa e pressão de alta entre 1,2 MPa e 1,7 MPa. Pressão de baixa reduzida indica carga de gás insuficiente. Sele qualquer vazamento antes de recarregar. A quantidade correta de R-134a para a Hilux é de aproximadamente 600 g a 650 g, confirmada na etiqueta do compartimento do motor."
  - nome: "Solicite inspeção e diagnóstico do motorizado de modo"
    texto: "Se os modos de ventilação não respondem corretamente mesmo com filtro novo e carga de gás adequada, o motorizado de modo ou a centralinha de climatização está com defeito. Em oficinas com scanner automotivo compatível com Toyota, é possível ler os códigos de falha da unidade de climatização e comandar os atuadores individualmente para confirmar qual motorizado não está respondendo. A substituição do motorizado de modo, quando necessária, exige desmontagem parcial do painel para acesso ao atuador. O custo da peça varia entre R$ 200 e R$ 600; a mão de obra depende da localização do atuador específico."
afiliados:
  - produto: "Filtro de Cabine para Toyota Hilux"
    nota: "Filtro de habitáculo compatível com Toyota Hilux, retém poeira, pólen e particulados antes do evaporador. Troca recomendada a cada 15.000 km a 20.000 km ou sempre que o ar traseiro enfraquecer."
    busca: "filtro cabine Toyota Hilux ar condicionado"
    programa: amazon
    cta: "Ver no site da Amazon"
  - produto: "Termômetro Digital para Duto de Ar-condicionado"
    nota: "Termômetro de sonda para medir a temperatura de saída nos dutos dianteiros e traseiros, permitindo comparar a distribuição de frio entre a primeira e a segunda fileira de assentos."
    busca: "termometro digital sonda ar condicionado automotivo duto"
    programa: amazon
    cta: "Ver no site da Amazon"
  - produto: "Kit Recarga Ar-condicionado Automotivo com Manômetro"
    nota: "Kit com manômetro de baixa pressão e carga de R-134a para verificação e reposição do gás. Permite checar a pressão do sistema antes de decidir pela recarga."

...
imagemAlt: "Diagrama do sistema de ar-condicionado do Toyota SW4 5ª geração com motor 2.8 GD-FTV"
faq:
  - pergunta: "Por que o AC do SW4 não gela com o carro cheio de passageiros?"
    resposta: "O SW4 tem 4.795 mm de comprimento, altura elevada e vidros grandes, criando um habitáculo com volume térmico alto. Com 7 pessoas e sol forte, o evaporador dianteiro sozinho não consegue suprir toda a demanda. Ligar o AC traseiro (nas versões que o possuem) distribui a carga e melhora muito o resfriamento."
  - pergunta: "Quanto custa recarregar o gás do ar-condicionado do SW4?"
    resposta: "Uma recarga convencional com verificação de pressão custa entre R$ 250 e R$ 400 em oficinas especializadas em climatização automotiva. Se houver vazamento, o custo sobe para cobrir a troca dos O-rings ou mangueiras danificadas."
  - pergunta: "Como saber se o condensador do SW4 está entupido?"
    resposta: "Visualmente: abra o capô e observe a grade dianteira do condensador contra a luz. Palhetas com insetos presos, poeira compactada ou deformações reduzem o fluxo de ar e aumentam a temperatura de condensação. O sintoma é AC que funciona bem em movimento e piora muito no trânsito parado."
  - pergunta: "O compressor do AC do SW4 dura quanto tempo?"
    resposta: "O compressor Denso de cilindrada variável, quando bem mantido (troca de filtro secador e recarga com o lubrificante correto), pode durar mais de 150.000 km. Recargas feitas sem purga adequada ou com óleo errado reduzem drasticamente essa vida útil."
  - pergunta: "O AC traseiro do SW4 tem peças separadas do dianteiro?"
    resposta: "Sim. A unidade traseira possui seu próprio evaporador e válvula de expansão. Um problema exclusivo no traseiro, como a válvula de expansão entupida, não afeta o circuito dianteiro. Por isso, é fundamental diagnosticar cada unidade separadamente antes de autorizar qualquer serviço."
passos:
  - nome: "Verificar temperatura de saída das saídas de ar"
    texto: "Com o motor em temperatura de operação e AC no máximo, use um termômetro de haste ou IR nas saídas centrais do painel. Um sistema saudável deve marcar entre 5 °C e 10 °C. Leituras acima de 15 °C indicam problema no circuito ou capacidade insuficiente."
  - nome: "Inspecionar o condensador visualmente"
    texto: "Com o carro frio, abra o capô e ilumie o condensador por trás com uma lanterna. Observe a entrada das palhetas. Insetos, pó compactado ou palhadas amassadas reduzem o fluxo de ar. Faça a limpeza com jato de água de baixa pressão de dentro para fora."
  - nome: "Verificar pressão do gás refrigerante"
    texto: "Leve o veículo a uma oficina com manifold e conecte nas válvulas Schrader do circuito. No lado baixo (sucção), a pressão esperada em operação é de aproximadamente 25 a 35 psi com o compressor ligado. Pressão muito baixa indica perda de gás; muito alta indica condensador ineficiente ou compressor com problema."
  - nome: "Avaliar funcionamento da embreagem do compressor"
    texto: "Com o AC ligado, observe o cubo central do compressor Denso. O disco de embreagem deve girar junto com a polia. Se escorregar (rotação irregular) ou se houver ruído metálico, a embreagem está com desgaste. Um compressor de cilindrada variável que não modula direito também não esfria adequadamente."
  - nome: "Testar a unidade traseira separadamente"
    texto: "Ligue o AC traseiro de forma independente (controle da 3ª fileira ou pelo painel central). Verifique se há fluxo de ar frio nas saídas do teto ou console traseiro. Temperatura acima de 18 °C na saída traseira com sistema ligado há 10 minutos indica falha na válvula de expansão ou no evaporador traseiro."
afiliados:
  - produto: "Termômetro digital de haste para diagnóstico de AC automotivo"
    nota: "Essencial para medir a temperatura de saída das saídas de ar e confirmar se o sistema está operando dentro da faixa esperada."
    busca: "termômetro digital automotivo ar condicionado"
    programa: "amazon"
    cta: "Ver produto"
...
relacionados:
  - titulo: "Todos os problemas conhecidos do Toyota SW4"
    url: "/problemas/toyota/sw4/"
  - titulo: "Ficha técnica do Toyota SW4 SRX 2.8 diesel"
    url: "/ficha-tecnica/toyota/sw4-srx-2-8-diesel/"
pontosChave:
  - "Sintoma: AC funciona bem em velocidade e piora no trânsito parado, ou não consegue resfriar a terceira fileira."
  - "Causa: habitáculo grande com alta carga térmica, condensador sujo, gás baixo, compressor Denso desgastado ou falha na unidade traseira."
  - "Ação: inspecionar condensador, medir pressão do gás e avaliar a unidade traseira separadamente antes de autorizar qualquer serviço."
  - "Atenção: recargas feitas sem verificar vazamento ou com óleo errado danificam o compressor Denso e multiplicam o custo do reparo."
fontes:
  - { titulo: "Toyota SW4 — Manual do Proprietário 2016 (sistema de climatização)", url: "https://www.toyota.com.br/content/dam/toyota/br/fichas-tecnicas/sw4.pdf" }
  - { titulo: "Denso Global — Variable Displacement Compressor Technology", url: "https://www.denso.com/global/en/products/automotive/ac-compressor/" }
draft: false
---
...
<aside class="telltale" role="note"><span aria-hidden="true">⚠️</span><p><strong>Atenção.</strong> Muitos proprietários relatam que o AC "funcionava bem" quando o carro era usado com 3 ou 4 pessoas, mas passou a "não gelar" ao aumentar o número de ocupantes. Nesse caso, o sistema não está com defeito: está sobrecarregado.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Diagnóstico fácil.</strong> Abra o capô com o carro frio e ilumine o condensador com uma lanterna pela parte traseira. Se as palhadas aparecerem bloqueadas por material sólido (insetos, poeira, capim), a limpeza resolverá o problema. O serviço custa entre R$ 100 e R$ 200 em um lava-rápido especializado ou funilaria.</p></aside>
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Atenção crítica.</strong> Recarregar o gás sem localizar e corrigir o vazamento é jogar dinheiro fora. Em 3 a 6 meses o sistema volta ao mesmo nível de problema. Toda recarga deve ser acompanhada de teste de estanqueidade com detector de gás ou corante UV.</p></aside>
...
<aside class="telltale" role="note"><span aria-hidden="true">⚠️</span><p><strong>Sinal de alerta.</strong> Se você ouvir um clique metálico repetido ou um ruído de raspado ao ligar o AC, desligue imediatamente o sistema de climatização e leve o veículo a uma oficina de AC. Operar com embreagem escorregando danifica o compressor internamente e eleva muito o custo do reparo.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Dica de diagnóstico.</strong> Com um termômetro de haste simples, meça a saída de ar do difusor traseiro (teto ou console traseiro) após 10 minutos de operação com o AC traseiro no máximo. Temperatura acima de 18 °C confirma problema na unidade traseira, mesmo que o dianteiro esteja resfriando bem.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Medida preventiva.</strong> Películas com fator de rejeição solar acima de 60% aplicadas nas janelas laterais e traseira reduzem significativamente a carga de calor na cabine. Essa medida não substitui o diagnóstico mecânico, mas melhora o conforto e reduz o desgaste do compressor a longo prazo.</p></aside>
...
|---|---|
| Limpeza do condensador | R$ 100 a R$ 200 |
| Recarga de gás (sem vazamento) | R$ 250 a R$ 400 |
| Recarga + troca de O-rings | R$ 400 a R$ 700 |
| Válvula de expansão traseira | R$ 300 a R$ 600 (peça) + MO |
| Compressor Denso novo + instalação | R$ 4.000 a R$ 7.000 |
| Película solar nas janelas | R$ 400 a R$ 900 (aplicação) |
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Nunca faça isso.</strong> Não tente recarregar o gás com latas de recarga vendidas em lojas de autopeças sem antes medir a pressão do circuito com manifold. Pressão em excesso danifica o compressor e pode causar falha da mangueira de alta pressão. O serviço de recarga precisa de equipamento calibrado.</p></aside>

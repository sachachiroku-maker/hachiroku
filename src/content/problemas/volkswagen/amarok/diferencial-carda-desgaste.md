...
defeito: "desgaste precoce nas juntas homocinéticas e eixo cardã do 4Motion"
...
imagemAlt: "Eixo cardã da Volkswagen Amarok V6 4Motion com cruzeta e junta homocinética"
faq:
  - pergunta: "A Amarok V6 4Motion tem problema com o cardã e o diferencial?"
    resposta: "Sim. O eixo cardã da Amarok V6 4Motion tem histórico de desgaste nas cruzetas (juntas universais) com ruído e vibração, geralmente entre 60.000 e 100.000 km. As juntas homocinéticas dos eixos dianteiros também apresentam desgaste precoce em Amaroks usadas fora de estrada sem manutenção adequada do óleo de diferencial."
  - pergunta: "Qual o barulho do cardã desgastado na Amarok?"
    resposta: "O cardã com cruzeta desgastada produz um barulho de clunque ou batida seca ao engrenar a marcha, especialmente saindo do repouso. Em velocidade de cruzeiro, o sintoma pode ser uma vibração que aumenta com a velocidade. O barulho é mais perceptível ao mudar de tração (de neutro para D ou R) e piora progressivamente conforme o desgaste avança."
  - pergunta: "Qual óleo usar no diferencial da Amarok V6 4Motion?"
    resposta: "O diferencial traseiro da Amarok V6 4Motion usa óleo SAE 75W90 GL-5 Full Synthetic. O acoplamento Haldex (diferencial central) usa fluido específico Haldex. A VW recomenda troca do óleo de diferencial a cada 60.000 km em uso normal e a cada 40.000 km em uso off-road intenso. Usar óleo convencional no lugar do sintético encurta a vida útil do diferencial."
  - pergunta: "Quantas cruzetas tem o cardã da Amarok?"
    resposta: "O eixo cardã da Amarok, que conecta o câmbio ao diferencial traseiro, tem duas cruzetas (juntas universais): uma na extremidade frontal (próxima ao câmbio) e outra na extremidade traseira (próxima ao diferencial). Algumas versões têm um eixo cardã em dois segmentos com três cruzetas e um mancal central. As cruzetas dianteiras são as que desgastam primeiro."
  - pergunta: "O reparo do cardã e das juntas homocinéticas da Amarok é caro?"
    resposta: "A troca das cruzetas do cardã fica entre R$ 500 e R$ 1.500 em peças e mão de obra, dependendo de quantas cruzetas precisam de troca e se o cardã pode ser reutilizado. A troca de um eixo cardã completo fica entre R$ 2.000 e R$ 4.000. Juntas homocinéticas dianteiras desgastadas custam entre R$ 800 e R$ 2.000 por eixo. O diagnóstico precoce reduz significativamente o custo."
passos:
  - nome: "Identifique os sintomas e localize sua origem"
    texto: "O barulho de clunque ao engrenar a marcha e a vibração que aumenta com a velocidade são os dois sintomas mais comuns do cardã com cruzeta desgastada na Amarok. Para distinguir o cardã das juntas homocinéticas dianteiras, preste atenção: o barulho do cardã é mais intenso ao sair do repouso em linha reta, enquanto o barulho das juntas homocinéticas é mais intenso em curvas fechadas em baixa velocidade (clique característico)."
  - nome: "Peça para verificar o cardã em elevador na próxima revisão"
    texto: "Com o veículo elevado em oficina, um mecânico pode verificar o jogo nas cruzetas do cardã manualmente: segure o cardã com duas mãos nas extremidades de uma cruzeta e tente torcer. Qualquer jogo perceptível indica desgaste que requer atenção. Cruzetas novas não têm jogo: o movimento deve ser suave mas sem folga angular."
  - nome: "Verifique o nível e o estado do óleo do diferencial"
    texto: "O diferencial traseiro e o acoplamento Haldex têm plugs de inspeção separados acessíveis por baixo do veículo. Em oficinas com elevador, solicite a verificação do nível e da cor do óleo de diferencial. Óleo escuro ou com partículas metálicas em suspensão indica desgaste avançado nos engrenamentos do diferencial. Óleo limpo e âmbar translúcido indica boa condição."
  - nome: "Troque o óleo de diferencial no prazo correto"
    texto: "O óleo de diferencial da Amarok V6 4Motion deve ser trocado a cada 60.000 km em uso normal de asfalto, ou a cada 40.000 km em Amaroks que fazem uso off-road regular (terreno arenoso, lama, subidas em tração total). Use óleo SAE 75W90 GL-5 Full Synthetic. A troca do fluido Haldex é um procedimento separado que deve ser feito no mesmo intervalo."
  - nome: "Avalie o estado das coifas das juntas homocinéticas"
    texto: "As juntas homocinéticas dos eixos dianteiros são protegidas por coifas de borracha. Quando a coifa rasga (por contato com pedra, galho ou desgaste natural), a graxa sai e a sujeira entra na junta. Uma junta exposta sem graxa degrada rapidamente. Inspecione as coifas visualmente na parte inferior do veículo: coifa íntegra é negra e elástica; coifa rasgada tem graxa espalhada ao redor e pode ter deformação."
pontosChave:
  - "O eixo cardã da Amarok V6 4Motion tem histórico de desgaste nas cruzetas com ruído de clunque e vibração, geralmente entre 60.000 e 100.000 km."
  - "O ruído ao sair do repouso com tração engrenada é o sintoma mais característico de cruzeta desgastada no cardã."
  - "A manutenção do óleo de diferencial SAE 75W90 GL-5 Full Synthetic a cada 60.000 km é a principal medida preventiva para a longevidade do sistema 4Motion."
  - "Coifas das juntas homocinéticas rasgadas levam ao desgaste rápido da junta; a coifa íntegra é pré-requisito para longevidade do eixo."
  - "O diagnóstico precoce reduz muito o custo: troca de cruzetas (R$ 500 a R$ 1.500) versus troca de cardã completo (R$ 2.000 a R$ 4.000) ou diferencial (R$ 5.000 a R$ 12.000)."
fontes:
  - { titulo: "VW Amarok: defeitos e problemas crônicos (MotorAgora)", url: "https://www.motoragora.com.br/defeitos-cronicos-da-amarok/" }
  - { titulo: "Problemas e defeitos comuns da Volkswagen Amarok (AgOraMotors)", url: "https://www.agoramotors.com.br/principais-problemas-volkswagen-amarok/" }
  - { titulo: "VW Amarok: problemas crônicos e defeitos (ClubMotor)", url: "https://www.clubmotor.com.br/vw-amarok-problemas-cronicos-defeitos-e-o-que-falam-da-picape/" }
draft: false
---
...
<aside class="telltale info" role="note">
  ...
  <p><strong>Vibração que aumenta com a velocidade.</strong> Além do clunque no arranque, cruzetas desgastadas podem gerar vibração que aumenta com a velocidade e diminui em velocidades diferentes. Essa vibração é causada pelo desbalanceamento dinâmico que o jogo na cruzeta cria no eixo girando. É diferente do desbalanceamento de pneu, que tem frequência constante em função do diâmetro do pneu.</p>
</aside>
...
<aside class="telltale warning" role="note">
  ...
  <p><strong>Uso off-road sem preparação adequada acelera o desgaste.</strong> A Amarok V6 4Motion foi projetada para uso misto asfalto e terra, mas não é um veículo de uso off-road extremo. Uso frequente em terrenos com lama profunda, areia fofa ou inclinações que exigem as rodas em ângulos extremos por períodos longos acelera o desgaste do cardã e das juntas homocinéticas acima do previsto.</p>
</aside>
...
- [Problemas crônicos da VW Amarok (MotorAgora)](https://www.motoragora.com.br/defeitos-cronicos-da-amarok/)
- [Principais problemas da Volkswagen Amarok (AgOraMotors)](https://www.agoramotors.com.br/principais-problemas-volkswagen-amarok/)
- [VW Amarok: problemas crônicos (ClubMotor)](https://www.clubmotor.com.br/vw-amarok-problemas-cronicos-defeitos-e-o-que-falam-da-picape/)

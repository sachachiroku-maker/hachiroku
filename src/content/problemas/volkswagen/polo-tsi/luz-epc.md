...
<aside class="telltale warning" role="note"><span aria-hidden="true">⚠️</span><p><strong>Apagar a luz não conserta nada.</strong> Limpar o código com o scanner sem corrigir a causa só remove o aviso temporariamente. Se a falha persistir, a central reacende o EPC no próximo ciclo. Apagar serve para confirmar um reparo, não para fingir que o problema sumiu.</p></aside>

...
defeito: "superaquecimento do motor por falha da bomba d'água"
kicker: "DEFEITO CRÔNICO"
intencao: "Diagnóstico"
entidadesEssenciais:
  - "motor 1.0 TSI EA211"
  - "bomba d'água de plástico VW"
...
imagemAlt: "Motor 1.0 TSI EA211 do Volkswagen Virtus com indicação de superaquecimento"
pontosChave:
  - "Sintoma: temperatura do motor sobe acima do normal, luz de temperatura acende ou ponteiro vai para a zona vermelha, frequentemente acompanhada de perda de desempenho e aquecimento do habitáculo."
  - "Causa: falha da bomba d'água de plástico do motor EA211, cujo impulsador se desprende do eixo ou parte antes da vida útil esperada, interrompendo a circulação do fluido de arrefecimento."
  - "Ação: desligar o motor imediatamente ao detectar o superaquecimento, aguardar resfriamento, verificar o nível do fluido e encaminhar para substituição da bomba d'água, termostato e fluido G12 como conjunto."
faq:
  - pergunta: "Por que a bomba d'água do Virtus 1.0 TSI falha tão cedo?"
    resposta: "A bomba d'água do motor EA211 tem o impulsador (rotor) fabricado em plástico reforçado. Com o tempo, especialmente em veículos que operaram com fluido fora de especificação ou que nunca tiveram o líquido trocado, o plástico degrada, racha ou se solta do eixo metálico. Quando isso acontece, o eixo gira, mas o rotor não move o fluido. O resultado é a perda de circulação do arrefecimento sem qualquer aviso sonoro ou vazamento visível. O problema não é exclusivo do Virtus: ocorre em todo o ecossistema EA211, incluindo Polo, T-Cross, Jetta e Golf com a mesma família de motores."
  - pergunta: "Qual o fluido de arrefecimento correto para o Virtus 1.0 TSI?"
    resposta: "O motor EA211 do Virtus exige fluido de arrefecimento do tipo G12 ou G12+, rosa ou lilás, na concentração de 50% com água destilada. O uso de aditivos de cor verde (tipo convencional) ou a mistura de fluidos de tipos diferentes provoca reação química que gera depósitos nos dutos e acelera a corrosão da bomba d'água, do termostato e das mangueiras. Nunca misture fluidos de cores diferentes sem lavar completamente o sistema."
  - pergunta: "Que sintomas aparecem antes do superaquecimento completo?"
    resposta: "Os sinais que antecedem o superaquecimento grave incluem: ponteiro de temperatura subindo acima da posição habitual (meio do marcador) e oscilando, aquecimento insuficiente da cabine no inverno (sinal de bolha de ar no sistema), cheiro adocicado de fluido quente vindo do compartimento do motor, consumo de fluido sem vazamento visível e, eventualmente, barulho de fervura ao desligar o motor. Esses sinais devem ser tratados como urgência."
  - pergunta: "É possível continuar rodando com o motor superaquecendo?"
    resposta: "Não. O superaquecimento do motor 1.0 TSI causa danos rápidos e progressivos: deformação da cabeça do bloco, queima da junta do cabeçote, dano aos anéis de segmento e, nos casos mais graves, fundição dos mancais. A recuperação de um motor que rodou superaquecido pode custar de R$ 8.000 a R$ 20.000 dependendo dos componentes afetados. Parar o veículo e aguardar o resgate é sempre a decisão correta."
  - pergunta: "O termostato precisa ser trocado junto com a bomba d'água?"
    resposta: "É altamente recomendável. O termostato do EA211 fica posicionado próximo à bomba d'água e opera nas mesmas condições de temperatura e pressão. Quando um componente falha, o outro geralmente já acumula desgaste. A troca do conjunto (bomba d'água, termostato e fluido) em uma única intervenção reduz o custo de mão de obra e evita ter que abrir o sistema de arrefecimento novamente em poucos meses."
  - pergunta: "O Polo 1.0 TSI tem o mesmo problema de bomba d'água?"
    resposta: "Sim. O motor EA211 é compartilhado entre Volkswagen Polo, Virtus, T-Cross, Nivus e Jetta. O problema com o impulsador de plástico da bomba d'água é estrutural do motor, não específico do modelo. Relatos de falha da bomba d'água aparecem em todos esses modelos com frequência similar, especialmente entre 60.000 e 100.000 km."
passos:
  - nome: "Identifique os sinais de alerta com o motor em operação"
    texto: "Observe o ponteiro de temperatura durante a condução. No motor EA211, o ponteiro normalmente estabiliza no centro exato do marcador após 5 a 10 minutos de aquecimento. Qualquer subida além desse ponto, especialmente em tráfego lento ou com o ar-condicionado ligado, é sinal de alerta. Se a luz de temperatura acender ou o ponteiro entrar na zona vermelha, desligue o motor imediatamente, acione o pisca-alerta e encoste o veículo em local seguro. Nunca continue rodando para chegar em casa ou em uma oficina."
  - nome: "Aguarde o resfriamento antes de inspecionar"
    texto: "Com o motor superaquecido, o fluido de arrefecimento está pressurizado e com temperatura acima de 100 graus. Abrir a tampa do reservatório ou do radiador com o motor quente pode causar queimaduras graves. Aguarde no mínimo 45 minutos com o motor desligado antes de tocar qualquer parte do sistema de arrefecimento. Use um pano espesso ao abrir a tampa do reservatório e vire o rosto para o lado."
  - nome: "Verifique o nível e a condição do fluido de arrefecimento"
    texto: "Com o motor frio, abra o reservatório de expansão e verifique se o nível está entre as marcas de mínimo e máximo. Anote a cor do fluido: fluido G12 correto deve ser rosa claro ou lilás translúcido. Fluido marrom, com partículas em suspensão ou com cheiro de queimado indica contaminação ou degradação. Se o nível estiver baixo sem vazamento visível, é provável que o sistema tenha perdido fluido por ebulição durante o superaquecimento, o que confirma que o episódio foi real. Não complete o nível com água pura de forma permanente: a diluição reduz o ponto de ebulição e protege menos contra corrosão."
  - nome: "Encaminhe para diagnóstico da bomba d'água e do termostato"
    texto: "Leve o veículo a uma oficina especializada em motores VW. O diagnóstico da bomba d'água no EA211 pode ser feito por inspeção visual após a remoção da correia acessória e da tampa da bomba. O mecânico vai verificar se o rotor está fixo ao eixo e se não há folga ou giro livre do impulsador. O termostato pode ser testado separadamente: em água quente a 87 graus, ele deve abrir completamente. Peça o diagnóstico escrito antes de autorizar o serviço."
  - nome: "Execute a substituição como conjunto e reponha o fluido correto"
    texto: "A substituição recomendada inclui bomba d'água nova (de preferência original VW ou de marca reconhecida no mercado), termostato novo e descarga completa do fluido antigo. Após a instalação, o sistema deve ser preenchido com fluido G12 na proporção correta (50% fluido e 50% água destilada) e purgar o ar com o motor ligado e a tampa do reservatório aberta. Bolhas de ar no sistema de arrefecimento impedem a circulação correta e podem gerar superaquecimento mesmo com a bomba nova funcionando. Confirme a ausência de bolhas antes de fechar o sistema."
fontes:
  - { titulo: "Bomba d'água do motor EA211: relatos e análise técnica (AutoCarUp)", url: "https://autocarup.com.br/5-principais-problemas-motor-tsi-da-vw-up-polo-t-cross-virtus-nivus-jetta-golf/" }
  - { titulo: "Problemas do Volkswagen Virtus relatados por proprietários (Mobiauto)", url: "https://www.mobiauto.com.br/revista/vw-polo-e-virtus-os-principais-problemas-segundo-os-donos/569" }
afiliados:
  - produto: "Bomba d'água VW Virtus 1.0 TSI EA211"
    nota: "Peça essencial para resolver o superaquecimento. Prefira versão com rotor metálico para maior durabilidade em relação à original de plástico."
    busca: "bomba dagua volkswagen virtus 1.0 tsi ea211"
    programa: amazon
    cta: "Ver bomba d'água no site"
  - produto: "Fluido de arrefecimento G12 concentrado"
    nota: "Fluido rosa/lilás da norma G12 ou G12+, compatível com o sistema de arrefecimento do motor EA211. Necessário na troca da bomba d'água."
    busca: "fluido arrefecimento g12 concentrado volkswagen"
    programa: amazon
    cta: "Ver fluido G12 no site"
  - produto: "Termostato motor EA211 VW"
    nota: "Recomendado trocar junto com a bomba d'água para garantir eficiência completa do sistema de arrefecimento e evitar nova abertura."
    busca: "termostato ea211 volkswagen polo virtus"
    programa: amazon
...
<aside class="telltale danger" role="note"><span aria-hidden="true">⛔</span><p><strong>Pare imediatamente.</strong> Se o ponteiro de temperatura entrar na zona vermelha ou a luz de temperatura acender, desligue o motor, acione o pisca-alerta e encoste em local seguro. Continuar rodando por mais alguns minutos pode resultar em dano irreversível ao bloco ou à cabeça.</p></aside>
...
<aside class="telltale warning" role="note"><span aria-hidden="true">⚠️</span><p><strong>Emulsão no óleo é sinal grave.</strong> Se a vareta de óleo mostrar uma pasta branca ou bege cremosa, o fluido de arrefecimento já contaminou o lubrificante. Não ligue o motor novamente antes de diagnóstico completo: rodar com óleo contaminado funde mancais em segundos.</p></aside>
...
<aside class="telltale info" role="note"><span aria-hidden="true">ℹ️</span><p><strong>Verifique o fluido a cada revisão.</strong> O fluido G12 no EA211 deve ser trocado a cada 2 anos ou 30.000 km. Muitos proprietários nunca trocam porque não há aviso no painel. O fluido velho perde os inibidores de corrosão e começa a atacar os componentes internos do sistema.</p></aside>
...
<aside class="telltale ok" role="note"><span aria-hidden="true">✅</span><p><strong>Troque o fluido a cada 2 anos.</strong> A manutenção mais barata para evitar a falha da bomba d'água e do termostato é trocar o fluido G12 no intervalo correto. Fluido novo protege os componentes de plástico e metal do sistema e custa menos de R$ 120. A negligência com esse item é a principal causa de falha prematura no EA211.</p></aside>

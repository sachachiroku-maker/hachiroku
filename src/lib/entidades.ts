...
export const ENTIDADES: Entidade[] = [
  ...
  },
  {
    ...
    modelos: ['fiat/palio', 'fiat/argo', 'jeep/renegade', 'fiat/cronos', 'fiat/toro', 'fiat/doblo'],
  ...
  {
    slug: 'tce-13', tipo: 'motor', nome: 'Motor 1.3 TCe (Renault)',
    titulo: 'Motor 1.3 TCe turbo (Renault): carros, defeitos e manutenção',
    seoTitle: 'Motor 1.3 TCe: defeitos e cuidados',
    resumo: 'O motor 1.3 TCe é um quatro cilindros turbo com injeção direta desenvolvido em parceria entre a Aliança Renault-Nissan e a Mercedes-Benz. No Brasil equipa o Captur, o Duster e a picape Oroch, entregando torque em baixa rotação com consumo contido. Usa corrente de comando, o que dispensa troca periódica de correia de distribuição, mas torna a qualidade do óleo ainda mais crítica: corrente esticada por óleo degradado gera ruído metálico a frio e códigos de sincronismo. O consumo de óleo entre trocas é o ponto de atenção mais relatado por proprietários; o nível deve ser conferido a cada 1.000 km, e a troca do lubrificante especificado pela Renault deve ocorrer a cada 10.000 km ou 12 meses. A injeção direta também favorece o acúmulo de carbono nas válvulas de admissão em uso urbano severo, algo a inspecionar a partir de 60.000 km.',
    modelos: ['renault/captur', 'renault/duster', 'renault/oroch'],
    sameAs: 'https://en.wikipedia.org/wiki/Renault_H_engine',
  },
  {
    slug: 'ea111', tipo: 'motor', nome: 'Motor EA111 (VW)',
    titulo: 'Motor EA111 (VW 1.0 e 1.6 8v): carros, defeitos e manutenção',
    seoTitle: 'Motor EA111: defeitos e manutenção',
    resumo: 'O EA111 é a família de motores de quatro cilindros que equipou por décadas o Gol, o Fox e a Saveiro nas versões 1.0 e 1.6 8 válvulas. É um projeto robusto e de manutenção barata, com peças abundantes no mercado de reposição. O comportamento mais conhecido é o barulho de tuchos hidráulicos na partida a frio: alguns segundos de tique-taque até o óleo pressurizar são tolerados, mas ruído persistente indica tucho desgastado ou óleo fora da especificação. Bobinas de ignição individuais e corpo de borboleta sujo respondem pela maior parte das falhas de marcha lenta irregular. A correia dentada exige troca a cada 60.000 km com tensionador e bomba d\'água. Óleo 5W-40 ou 5W-30 conforme o manual, trocado a cada 10.000 km ou 12 meses, mantém tuchos e comando dentro da vida útil projetada.',
    modelos: ['volkswagen/gol', 'volkswagen/fox', 'volkswagen/saveiro'],
    sameAs: 'https://en.wikipedia.org/wiki/Volkswagen_EA111_engine',
  },
  {
    slug: 'fire', tipo: 'motor', nome: 'Motor Fiat Fire',
    titulo: 'Motor Fiat Fire (1.0 e 1.4): carros, defeitos e manutenção',
    seoTitle: 'Motor Fiat Fire: defeitos e manutenção',
    resumo: 'O Fire é um dos motores mais difundidos do Brasil: um quatro cilindros 8 válvulas nas versões 1.0 e 1.4 que equipou gerações de Uno, Palio, Mobi e Fiorino. A fama de robustez é merecida, desde que a manutenção básica seja respeitada. A correia dentada seca exige troca a cada 50.000 km a 60.000 km, sempre em kit com tensionador; o rompimento encontra válvulas e pistões e resulta em retífica. Velas e cabos são itens baratos cuja negligência causa falha de ignição e consumo alto — sintoma frequente em exemplares com mais de 100.000 km. Superaquecimento por válvula termostática travada ou eletroventilador inoperante é o defeito mais destrutivo da família e merece atenção imediata ao primeiro sinal do ponteiro subindo. Óleo semissintético 15W-40 ou o especificado no manual, a cada 7.500 km a 10.000 km.',
    modelos: ['fiat/uno', 'fiat/palio', 'fiat/mobi', 'fiat/fiorino'],
    sameAs: 'https://en.wikipedia.org/wiki/Fiat_Fire_engine',
  },
  {
    slug: 'kappa-gamma', tipo: 'motor', nome: 'Motores Kappa e Gamma (Hyundai)',
    titulo: 'Motores Hyundai Kappa 1.0 e Gamma 1.6: carros e defeitos',
    seoTitle: 'Motores Kappa e Gamma: defeitos',
    resumo: 'A dupla Kappa 1.0 (três cilindros, aspirado ou T-GDI turbo) e Gamma 1.6 (quatro cilindros) equipa o HB20, o HB20S e o Creta produzidos no Brasil. Ambos usam corrente de comando, dispensando troca periódica de correia de distribuição, mas dependendo de óleo em dia para preservar tensionadores. No Kappa T-GDI com injeção direta, o ponto de atenção é o sistema de alta pressão de combustível: bicos e bomba de alta sensíveis a combustível de má procedência, além do acúmulo de carbono nas válvulas de admissão típico de injeção direta. No Gamma 1.6, o comportamento é mais previsível, com velas e bobinas respondendo pela maior parte das falhas de ignição. Óleo conforme especificação Hyundai a cada 10.000 km ou 12 meses; em uso severo urbano, antecipar para 5.000 km protege corrente e turbo.',
    modelos: ['hyundai/hb20', 'hyundai/hb20s', 'hyundai/creta'],
    sameAs: 'https://en.wikipedia.org/wiki/Hyundai_Kappa_engine',
  },
  {
    slug: 'honda-15', tipo: 'motor', nome: 'Motor Honda 1.5 (i-VTEC e turbo)',
    titulo: 'Motor Honda 1.5 i-VTEC e 1.5 turbo: carros e defeitos',
    seoTitle: 'Motor Honda 1.5: defeitos e cuidados',
  ...
  // ---------- TECNOLOGIAS ----------
  {
    slug: 'cambio-dupla-embreagem', tipo: 'tecnologia', nome: 'Câmbio de dupla embreagem (DCT/DSG)',
    titulo: 'Câmbio de dupla embreagem (DCT e DSG): trancos, fluido e cuidados',
    seoTitle: 'Câmbio DCT/DSG: trancos e cuidados',
    resumo: 'O câmbio de dupla embreagem usa duas embreagens que pré-engatam a marcha seguinte, entregando trocas mais rápidas que um automático convencional. No Brasil está no GWM Haval H6 (7DCT) e no Tiguan Allspace (DSG de 7 marchas), entre outros. Solavancos em manobra e arrancada em baixa velocidade são característica da arquitetura, acentuados por fluido degradado ou calibração desatualizada do módulo mecatrônico. Em unidades de embreagem banhada a óleo, a troca do fluido específico a cada 60.000 km é obrigatória, mesmo quando o fabricante o descreve como de longa duração; fluido velho superaquece as embreagens e antecipa o desgaste da mecatrônica, reparo que passa facilmente de cinco dígitos. Atualização de software na concessionária resolve boa parte das reclamações de tranco. Uso intenso em anda-e-para acelera todo o ciclo de desgaste.',
    modelos: ['gwm/haval-h6', 'volkswagen/tiguan-allspace'],
    sameAs: 'https://en.wikipedia.org/wiki/Dual-clutch_transmission',
  },
  {
    ...
    modelos: ['chevrolet/onix', 'chevrolet/tracker', 'chevrolet/montana', 'ford/ka'],
  },
  {
  ...
  },
  {
    ...
    modelos: ['toyota/corolla', 'toyota/yaris', 'honda/city', 'honda/hr-v', 'honda/civic', 'honda/fit', 'honda/wr-v', 'nissan/kicks', 'renault/duster', 'renault/captur', 'renault/logan', 'mitsubishi/outlander'],
  },
];
